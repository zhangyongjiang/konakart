...
set echo on
INSERT INTO kk_config (kk_config_id, kk_config_key, kk_config_value, date_added) VALUES (NEXTVAL FOR kk_config_seq, 'HISTORY', '7.0.0.0 U', current timestamp);
UPDATE kk_config SET kk_config_value='7.0.0.0 DB2', date_added=current timestamp WHERE kk_config_key='VERSION';
...
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, store_id) SELECT nextval for configuration_seq, 'Import files path','IMPORT_FILES_PATH','C:/Program Files/KonaKart/data/','The import data files location',29,50,current timestamp, store_id FROM configuration WHERE configuration_key = 'STORE_COUNTRY';
