...
-- Created: Wed Aug 27 11:44:24 BST 2014
-- -----------------------------------------------------------
-- 
...
INSERT INTO address_book (address_book_id, customers_id, entry_gender, entry_company, entry_firstname, entry_lastname, entry_street_address, entry_suburb, entry_postcode, entry_city, entry_state, entry_country_id) VALUES (nextval for address_book_seq, -1, 'm', 'ACME Inc.', 'TARGET_STOREID', 'Admin', 'TARGET_STOREID Admin Street', 'Suburb', 'PostcodeX', 'City', '', 1);
...
INSERT INTO customers (customers_id, customers_gender, customers_firstname, customers_lastname,customers_dob, customers_email_address, customers_default_address_id, customers_telephone, customers_fax, customers_password, customers_newsletter, customers_type) VALUES (nextval for customers_seq, 'm', 'TARGET_STOREID', 'Admin', to_date('1977-01-01 00:00:00', 'YYYY-MM-DD HH24:MI:SS'), 'TARGET_STOREID-admin@konakart.com', -1, '019081', '', 'f5147fc3f6eb46e234c01db939bdb581:08', '0', 1);

INSERT INTO customers_info select customers_id , current timestamp, 0, current timestamp, current timestamp, 0, 'XXXX' from customers WHERE customers_email_address = 'TARGET_STOREID-admin@konakart.com';
