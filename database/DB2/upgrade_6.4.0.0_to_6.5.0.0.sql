...
set echo on
INSERT INTO kk_config (kk_config_id, kk_config_key, kk_config_value, date_added) VALUES (NEXTVAL FOR kk_config_seq, 'HISTORY', '6.5.0.0 U', current timestamp);
UPDATE kk_config SET kk_config_value='6.5.0.0 DB2', date_added=current timestamp WHERE kk_config_key='VERSION';
