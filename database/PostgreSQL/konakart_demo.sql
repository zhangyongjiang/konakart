...
-- 
-- -----------------------------------------------------------
-- KonaKart v7.3.0.1 demo database script for PostgreSQL
...
CREATE TABLE customers_basket_attrs (
  customers_basket_attributes_id SERIAL,
  customers_id INTEGER NOT NULL,
  products_id VARCHAR(255) NOT NULL,
...
CREATE TABLE orders_status_history (
   orders_status_history_id SERIAL,
   orders_id INTEGER NOT NULL,
...
CREATE TABLE orders_products_attributes (
  orders_products_attributes_id SERIAL,
  orders_id INTEGER NOT NULL,
...
CREATE TABLE orders_products_download (
  orders_products_download_id SERIAL,
...
CREATE TABLE prod_opt_vals_to_prod_opt (
  prod_opt_vals_to_prod_opt_id SERIAL,
  products_options_id INTEGER NOT NULL,
...
INSERT INTO address_book VALUES (DEFAULT, 1, 'm', 'ACME Inc.', 'John', 'Doe', '1 Way Street', '', '12345', 'NeverNever', '', 223, 12);

-- 1 - Default, 2 - USA, 3 - Spain, 4 - Singapore, 5 - Germany
INSERT INTO address_format VALUES (DEFAULT, '$firstname $lastname$cr$streets$cr$city, $postcode$cr$statecomma$country','$city / $country');
INSERT INTO address_format VALUES (DEFAULT, '$firstname $lastname$cr$streets$cr$city, $state    $postcode$cr$country','$city, $state / $country');
INSERT INTO address_format VALUES (DEFAULT, '$firstname $lastname$cr$streets$cr$city$cr$postcode - $statecomma$country','$state / $country');
INSERT INTO address_format VALUES (DEFAULT, '$firstname $lastname$cr$streets$cr$city ($postcode)$cr$country', '$postcode / $country');
INSERT INTO address_format VALUES (DEFAULT, '$firstname $lastname$cr$streets$cr$postcode $city$cr$country','$city / $country');

INSERT INTO categories VALUES (DEFAULT, 'no-image.png', '0', '1', now(), null);
INSERT INTO categories VALUES (DEFAULT, 'no-image.png', '0', '2', now(), null);
INSERT INTO categories VALUES (DEFAULT, 'no-image.png', '0', '3', now(), null);
INSERT INTO categories VALUES (DEFAULT, 'no-image.png', '1', '0', now(), null);
INSERT INTO categories VALUES (DEFAULT, 'no-image.png', '1', '0', now(), null);
INSERT INTO categories VALUES (DEFAULT, 'no-image.png', '1', '0', now(), null);
INSERT INTO categories VALUES (DEFAULT, 'no-image.png', '1', '0', now(), null);
INSERT INTO categories VALUES (DEFAULT, 'no-image.png', '1', '0', now(), null);
INSERT INTO categories VALUES (DEFAULT, 'no-image.png', '1', '0', now(), null);
INSERT INTO categories VALUES (DEFAULT, 'no-image.png', '3', '0', now(), null);
INSERT INTO categories VALUES (DEFAULT, 'no-image.png', '3', '0', now(), null);
INSERT INTO categories VALUES (DEFAULT, 'no-image.png', '3', '0', now(), null);
INSERT INTO categories VALUES (DEFAULT, 'no-image.png', '3', '0', now(), null);
INSERT INTO categories VALUES (DEFAULT, 'no-image.png', '3', '0', now(), null);
...
INSERT INTO categories VALUES (DEFAULT, 'no-image.png', '1', '0', now(), null);
INSERT INTO categories VALUES (DEFAULT, 'no-image.png', '1', '0', now(), null);
INSERT INTO categories VALUES (DEFAULT, 'no-image.png', '2', '0', now(), null);
INSERT INTO categories VALUES (DEFAULT, 'no-image.png', '2', '0', now(), null);
INSERT INTO categories VALUES (DEFAULT, 'no-image.png', '2', '0', now(), null);
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Sort Order', 'MODULE_ORDER_TOTAL_TAX_SORT_ORDER', '39', 'Sort order of display.', '6', '2', now());
...
INSERT INTO configuration_group VALUES (DEFAULT, 'My Store', 'General information about my store', '1', '1');
INSERT INTO configuration_group VALUES (DEFAULT, 'Minimum Values', 'The minimum values for functions / data', '2', '1');
INSERT INTO configuration_group VALUES (DEFAULT, 'Maximum Values', 'The maximum values for functions / data', '3', '1');
INSERT INTO configuration_group VALUES (DEFAULT, 'Images', 'Image parameters', '4', '1');
INSERT INTO configuration_group VALUES (DEFAULT, 'Customer Details', 'Customer account configuration', '5', '1');
INSERT INTO configuration_group VALUES (DEFAULT, 'Module Options', 'Hidden from configuration', '6', '0');
INSERT INTO configuration_group VALUES (DEFAULT, 'Shipping/Packaging', 'Shipping options available at my store', '7', '1');
--INSERT INTO configuration_group VALUES ('8', 'Product Listing', 'Product Listing    configuration options', '8', '1');
INSERT INTO configuration_group VALUES (DEFAULT, 'Stock', 'Stock configuration options', '9', '1');
--INSERT INTO configuration_group VALUES ('10', 'Logging', 'Logging configuration options', '10', '1');
INSERT INTO configuration_group VALUES (DEFAULT, 'Cache', 'Caching configuration options', '11', '1');
INSERT INTO configuration_group VALUES (DEFAULT, 'E-Mail Options', 'General setting for E-Mail transport and HTML E-Mails', '12', '1');
--INSERT INTO configuration_group VALUES ('13', 'Download', 'Downloadable products options', '13', '1');
--INSERT INTO configuration_group VALUES ('14', 'GZip Compression', 'GZip compression options', '14', '1');
--INSERT INTO configuration_group VALUES ('15', 'Sessions', 'Session options', '15', '1');

INSERT INTO countries VALUES (DEFAULT,'Afghanistan','AF','AFG','1');
INSERT INTO countries VALUES (DEFAULT,'Albania','AL','ALB','1');
INSERT INTO countries VALUES (DEFAULT,'Algeria','DZ','DZA','1');
INSERT INTO countries VALUES (DEFAULT,'American Samoa','AS','ASM','1');
INSERT INTO countries VALUES (DEFAULT,'Andorra','AD','AND','1');
INSERT INTO countries VALUES (DEFAULT,'Angola','AO','AGO','1');
INSERT INTO countries VALUES (DEFAULT,'Anguilla','AI','AIA','1');
INSERT INTO countries VALUES (DEFAULT,'Antarctica','AQ','ATA','1');
INSERT INTO countries VALUES (DEFAULT,'Antigua and Barbuda','AG','ATG','1');
INSERT INTO countries VALUES (DEFAULT,'Argentina','AR','ARG','1');
INSERT INTO countries VALUES (DEFAULT,'Armenia','AM','ARM','1');
INSERT INTO countries VALUES (DEFAULT,'Aruba','AW','ABW','1');
INSERT INTO countries VALUES (DEFAULT,'Australia','AU','AUS','1');
INSERT INTO countries VALUES (DEFAULT,'Austria','AT','AUT','5');
INSERT INTO countries VALUES (DEFAULT,'Azerbaijan','AZ','AZE','1');
INSERT INTO countries VALUES (DEFAULT,'Bahamas','BS','BHS','1');
INSERT INTO countries VALUES (DEFAULT,'Bahrain','BH','BHR','1');
INSERT INTO countries VALUES (DEFAULT,'Bangladesh','BD','BGD','1');
INSERT INTO countries VALUES (DEFAULT,'Barbados','BB','BRB','1');
INSERT INTO countries VALUES (DEFAULT,'Belarus','BY','BLR','1');
INSERT INTO countries VALUES (DEFAULT,'Belgium','BE','BEL','1');
INSERT INTO countries VALUES (DEFAULT,'Belize','BZ','BLZ','1');
INSERT INTO countries VALUES (DEFAULT,'Benin','BJ','BEN','1');
INSERT INTO countries VALUES (DEFAULT,'Bermuda','BM','BMU','1');
INSERT INTO countries VALUES (DEFAULT,'Bhutan','BT','BTN','1');
INSERT INTO countries VALUES (DEFAULT,'Bolivia','BO','BOL','1');
INSERT INTO countries VALUES (DEFAULT,'Bosnia and Herzegowina','BA','BIH','1');
INSERT INTO countries VALUES (DEFAULT,'Botswana','BW','BWA','1');
INSERT INTO countries VALUES (DEFAULT,'Bouvet Island','BV','BVT','1');
INSERT INTO countries VALUES (DEFAULT,'Brazil','BR','BRA','1');
INSERT INTO countries VALUES (DEFAULT,'British Indian Ocean Territory','IO','IOT','1');
INSERT INTO countries VALUES (DEFAULT,'Brunei Darussalam','BN','BRN','1');
INSERT INTO countries VALUES (DEFAULT,'Bulgaria','BG','BGR','1');
INSERT INTO countries VALUES (DEFAULT,'Burkina Faso','BF','BFA','1');
INSERT INTO countries VALUES (DEFAULT,'Burundi','BI','BDI','1');
INSERT INTO countries VALUES (DEFAULT,'Cambodia','KH','KHM','1');
INSERT INTO countries VALUES (DEFAULT,'Cameroon','CM','CMR','1');
INSERT INTO countries VALUES (DEFAULT,'Canada','CA','CAN','1');
INSERT INTO countries VALUES (DEFAULT,'Cape Verde','CV','CPV','1');
INSERT INTO countries VALUES (DEFAULT,'Cayman Islands','KY','CYM','1');
INSERT INTO countries VALUES (DEFAULT,'Central African Republic','CF','CAF','1');
INSERT INTO countries VALUES (DEFAULT,'Chad','TD','TCD','1');
INSERT INTO countries VALUES (DEFAULT,'Chile','CL','CHL','1');
INSERT INTO countries VALUES (DEFAULT,'China','CN','CHN','1');
INSERT INTO countries VALUES (DEFAULT,'Christmas Island','CX','CXR','1');
INSERT INTO countries VALUES (DEFAULT,'Cocos (Keeling) Islands','CC','CCK','1');
INSERT INTO countries VALUES (DEFAULT,'Colombia','CO','COL','1');
INSERT INTO countries VALUES (DEFAULT,'Comoros','KM','COM','1');
INSERT INTO countries VALUES (DEFAULT,'Congo','CG','COG','1');
INSERT INTO countries VALUES (DEFAULT,'Cook Islands','CK','COK','1');
INSERT INTO countries VALUES (DEFAULT,'Costa Rica','CR','CRI','1');
INSERT INTO countries VALUES (DEFAULT,'Cote D''Ivoire','CI','CIV','1');
INSERT INTO countries VALUES (DEFAULT,'Croatia','HR','HRV','1');
INSERT INTO countries VALUES (DEFAULT,'Cuba','CU','CUB','1');
INSERT INTO countries VALUES (DEFAULT,'Cyprus','CY','CYP','1');
INSERT INTO countries VALUES (DEFAULT,'Czech Republic','CZ','CZE','1');
INSERT INTO countries VALUES (DEFAULT,'Denmark','DK','DNK','1');
INSERT INTO countries VALUES (DEFAULT,'Djibouti','DJ','DJI','1');
INSERT INTO countries VALUES (DEFAULT,'Dominica','DM','DMA','1');
INSERT INTO countries VALUES (DEFAULT,'Dominican Republic','DO','DOM','1');
INSERT INTO countries VALUES (DEFAULT,'East Timor','TP','TMP','1');
INSERT INTO countries VALUES (DEFAULT,'Ecuador','EC','ECU','1');
INSERT INTO countries VALUES (DEFAULT,'Egypt','EG','EGY','1');
INSERT INTO countries VALUES (DEFAULT,'El Salvador','SV','SLV','1');
INSERT INTO countries VALUES (DEFAULT,'Equatorial Guinea','GQ','GNQ','1');
INSERT INTO countries VALUES (DEFAULT,'Eritrea','ER','ERI','1');
INSERT INTO countries VALUES (DEFAULT,'Estonia','EE','EST','1');
INSERT INTO countries VALUES (DEFAULT,'Ethiopia','ET','ETH','1');
INSERT INTO countries VALUES (DEFAULT,'Falkland Islands (Malvinas)','FK','FLK','1');
INSERT INTO countries VALUES (DEFAULT,'Faroe Islands','FO','FRO','1');
INSERT INTO countries VALUES (DEFAULT,'Fiji','FJ','FJI','1');
INSERT INTO countries VALUES (DEFAULT,'Finland','FI','FIN','1');
INSERT INTO countries VALUES (DEFAULT,'France','FR','FRA','1');
INSERT INTO countries VALUES (DEFAULT,'France, Metropolitan','FX','FXX','1');
INSERT INTO countries VALUES (DEFAULT,'French Guiana','GF','GUF','1');
INSERT INTO countries VALUES (DEFAULT,'French Polynesia','PF','PYF','1');
INSERT INTO countries VALUES (DEFAULT,'French Southern Territories','TF','ATF','1');
INSERT INTO countries VALUES (DEFAULT,'Gabon','GA','GAB','1');
INSERT INTO countries VALUES (DEFAULT,'Gambia','GM','GMB','1');
INSERT INTO countries VALUES (DEFAULT,'Georgia','GE','GEO','1');
INSERT INTO countries VALUES (DEFAULT,'Germany','DE','DEU','5');
INSERT INTO countries VALUES (DEFAULT,'Ghana','GH','GHA','1');
INSERT INTO countries VALUES (DEFAULT,'Gibraltar','GI','GIB','1');
INSERT INTO countries VALUES (DEFAULT,'Greece','GR','GRC','1');
INSERT INTO countries VALUES (DEFAULT,'Greenland','GL','GRL','1');
INSERT INTO countries VALUES (DEFAULT,'Grenada','GD','GRD','1');
INSERT INTO countries VALUES (DEFAULT,'Guadeloupe','GP','GLP','1');
INSERT INTO countries VALUES (DEFAULT,'Guam','GU','GUM','1');
INSERT INTO countries VALUES (DEFAULT,'Guatemala','GT','GTM','1');
INSERT INTO countries VALUES (DEFAULT,'Guinea','GN','GIN','1');
INSERT INTO countries VALUES (DEFAULT,'Guinea-bissau','GW','GNB','1');
INSERT INTO countries VALUES (DEFAULT,'Guyana','GY','GUY','1');
INSERT INTO countries VALUES (DEFAULT,'Haiti','HT','HTI','1');
INSERT INTO countries VALUES (DEFAULT,'Heard and Mc Donald Islands','HM','HMD','1');
INSERT INTO countries VALUES (DEFAULT,'Honduras','HN','HND','1');
INSERT INTO countries VALUES (DEFAULT,'Hong Kong','HK','HKG','1');
INSERT INTO countries VALUES (DEFAULT,'Hungary','HU','HUN','1');
INSERT INTO countries VALUES (DEFAULT,'Iceland','IS','ISL','1');
INSERT INTO countries VALUES (DEFAULT,'India','IN','IND','1');
INSERT INTO countries VALUES (DEFAULT,'Indonesia','ID','IDN','1');
INSERT INTO countries VALUES (DEFAULT,'Iran (Islamic Republic of)','IR','IRN','1');
INSERT INTO countries VALUES (DEFAULT,'Iraq','IQ','IRQ','1');
INSERT INTO countries VALUES (DEFAULT,'Ireland','IE','IRL','1');
INSERT INTO countries VALUES (DEFAULT,'Israel','IL','ISR','1');
INSERT INTO countries VALUES (DEFAULT,'Italy','IT','ITA','1');
INSERT INTO countries VALUES (DEFAULT,'Jamaica','JM','JAM','1');
INSERT INTO countries VALUES (DEFAULT,'Japan','JP','JPN','1');
INSERT INTO countries VALUES (DEFAULT,'Jordan','JO','JOR','1');
INSERT INTO countries VALUES (DEFAULT,'Kazakhstan','KZ','KAZ','1');
INSERT INTO countries VALUES (DEFAULT,'Kenya','KE','KEN','1');
INSERT INTO countries VALUES (DEFAULT,'Kiribati','KI','KIR','1');
INSERT INTO countries VALUES (DEFAULT,'Korea, Democratic People''s Republic of','KP','PRK','1');
INSERT INTO countries VALUES (DEFAULT,'Korea, Republic of','KR','KOR','1');
INSERT INTO countries VALUES (DEFAULT,'Kuwait','KW','KWT','1');
INSERT INTO countries VALUES (DEFAULT,'Kyrgyzstan','KG','KGZ','1');
INSERT INTO countries VALUES (DEFAULT,'Lao People''s Democratic Republic','LA','LAO','1');
INSERT INTO countries VALUES (DEFAULT,'Latvia','LV','LVA','1');
INSERT INTO countries VALUES (DEFAULT,'Lebanon','LB','LBN','1');
INSERT INTO countries VALUES (DEFAULT,'Lesotho','LS','LSO','1');
INSERT INTO countries VALUES (DEFAULT,'Liberia','LR','LBR','1');
INSERT INTO countries VALUES (DEFAULT,'Libyan Arab Jamahiriya','LY','LBY','1');
INSERT INTO countries VALUES (DEFAULT,'Liechtenstein','LI','LIE','1');
INSERT INTO countries VALUES (DEFAULT,'Lithuania','LT','LTU','1');
INSERT INTO countries VALUES (DEFAULT,'Luxembourg','LU','LUX','1');
INSERT INTO countries VALUES (DEFAULT,'Macau','MO','MAC','1');
INSERT INTO countries VALUES (DEFAULT,'Macedonia, The Former Yugoslav Republic of','MK','MKD','1');
INSERT INTO countries VALUES (DEFAULT,'Madagascar','MG','MDG','1');
INSERT INTO countries VALUES (DEFAULT,'Malawi','MW','MWI','1');
INSERT INTO countries VALUES (DEFAULT,'Malaysia','MY','MYS','1');
INSERT INTO countries VALUES (DEFAULT,'Maldives','MV','MDV','1');
INSERT INTO countries VALUES (DEFAULT,'Mali','ML','MLI','1');
INSERT INTO countries VALUES (DEFAULT,'Malta','MT','MLT','1');
INSERT INTO countries VALUES (DEFAULT,'Marshall Islands','MH','MHL','1');
INSERT INTO countries VALUES (DEFAULT,'Martinique','MQ','MTQ','1');
INSERT INTO countries VALUES (DEFAULT,'Mauritania','MR','MRT','1');
INSERT INTO countries VALUES (DEFAULT,'Mauritius','MU','MUS','1');
INSERT INTO countries VALUES (DEFAULT,'Mayotte','YT','MYT','1');
INSERT INTO countries VALUES (DEFAULT,'Mexico','MX','MEX','1');
INSERT INTO countries VALUES (DEFAULT,'Micronesia, Federated States of','FM','FSM','1');
INSERT INTO countries VALUES (DEFAULT,'Moldova, Republic of','MD','MDA','1');
INSERT INTO countries VALUES (DEFAULT,'Monaco','MC','MCO','1');
INSERT INTO countries VALUES (DEFAULT,'Mongolia','MN','MNG','1');
INSERT INTO countries VALUES (DEFAULT,'Montserrat','MS','MSR','1');
INSERT INTO countries VALUES (DEFAULT,'Morocco','MA','MAR','1');
INSERT INTO countries VALUES (DEFAULT,'Mozambique','MZ','MOZ','1');
INSERT INTO countries VALUES (DEFAULT,'Myanmar','MM','MMR','1');
INSERT INTO countries VALUES (DEFAULT,'Namibia','NA','NAM','1');
INSERT INTO countries VALUES (DEFAULT,'Nauru','NR','NRU','1');
INSERT INTO countries VALUES (DEFAULT,'Nepal','NP','NPL','1');
INSERT INTO countries VALUES (DEFAULT,'Netherlands','NL','NLD','1');
INSERT INTO countries VALUES (DEFAULT,'Netherlands Antilles','AN','ANT','1');
INSERT INTO countries VALUES (DEFAULT,'New Caledonia','NC','NCL','1');
INSERT INTO countries VALUES (DEFAULT,'New Zealand','NZ','NZL','1');
INSERT INTO countries VALUES (DEFAULT,'Nicaragua','NI','NIC','1');
INSERT INTO countries VALUES (DEFAULT,'Niger','NE','NER','1');
INSERT INTO countries VALUES (DEFAULT,'Nigeria','NG','NGA','1');
INSERT INTO countries VALUES (DEFAULT,'Niue','NU','NIU','1');
INSERT INTO countries VALUES (DEFAULT,'Norfolk Island','NF','NFK','1');
INSERT INTO countries VALUES (DEFAULT,'Northern Mariana Islands','MP','MNP','1');
INSERT INTO countries VALUES (DEFAULT,'Norway','NO','NOR','1');
INSERT INTO countries VALUES (DEFAULT,'Oman','OM','OMN','1');
INSERT INTO countries VALUES (DEFAULT,'Pakistan','PK','PAK','1');
INSERT INTO countries VALUES (DEFAULT,'Palau','PW','PLW','1');
INSERT INTO countries VALUES (DEFAULT,'Panama','PA','PAN','1');
INSERT INTO countries VALUES (DEFAULT,'Papua New Guinea','PG','PNG','1');
INSERT INTO countries VALUES (DEFAULT,'Paraguay','PY','PRY','1');
INSERT INTO countries VALUES (DEFAULT,'Peru','PE','PER','1');
INSERT INTO countries VALUES (DEFAULT,'Philippines','PH','PHL','1');
INSERT INTO countries VALUES (DEFAULT,'Pitcairn','PN','PCN','1');
INSERT INTO countries VALUES (DEFAULT,'Poland','PL','POL','1');
INSERT INTO countries VALUES (DEFAULT,'Portugal','PT','PRT','1');
INSERT INTO countries VALUES (DEFAULT,'Puerto Rico','PR','PRI','1');
INSERT INTO countries VALUES (DEFAULT,'Qatar','QA','QAT','1');
INSERT INTO countries VALUES (DEFAULT,'Reunion','RE','REU','1');
INSERT INTO countries VALUES (DEFAULT,'Romania','RO','ROM','1');
INSERT INTO countries VALUES (DEFAULT,'Russian Federation','RU','RUS','1');
INSERT INTO countries VALUES (DEFAULT,'Rwanda','RW','RWA','1');
INSERT INTO countries VALUES (DEFAULT,'Saint Kitts and Nevis','KN','KNA','1');
INSERT INTO countries VALUES (DEFAULT,'Saint Lucia','LC','LCA','1');
INSERT INTO countries VALUES (DEFAULT,'Saint Vincent and the Grenadines','VC','VCT','1');
INSERT INTO countries VALUES (DEFAULT,'Samoa','WS','WSM','1');
INSERT INTO countries VALUES (DEFAULT,'San Marino','SM','SMR','1');
INSERT INTO countries VALUES (DEFAULT,'Sao Tome and Principe','ST','STP','1');
INSERT INTO countries VALUES (DEFAULT,'Saudi Arabia','SA','SAU','1');
INSERT INTO countries VALUES (DEFAULT,'Senegal','SN','SEN','1');
INSERT INTO countries VALUES (DEFAULT,'Seychelles','SC','SYC','1');
INSERT INTO countries VALUES (DEFAULT,'Sierra Leone','SL','SLE','1');
INSERT INTO countries VALUES (DEFAULT,'Singapore','SG','SGP', '4');
INSERT INTO countries VALUES (DEFAULT,'Slovakia (Slovak Republic)','SK','SVK','1');
INSERT INTO countries VALUES (DEFAULT,'Slovenia','SI','SVN','1');
INSERT INTO countries VALUES (DEFAULT,'Solomon Islands','SB','SLB','1');
INSERT INTO countries VALUES (DEFAULT,'Somalia','SO','SOM','1');
INSERT INTO countries VALUES (DEFAULT,'South Africa','ZA','ZAF','1');
INSERT INTO countries VALUES (DEFAULT,'South Georgia and the South Sandwich Islands','GS','SGS','1');
INSERT INTO countries VALUES (DEFAULT,'Spain','ES','ESP','3');
INSERT INTO countries VALUES (DEFAULT,'Sri Lanka','LK','LKA','1');
INSERT INTO countries VALUES (DEFAULT,'St. Helena','SH','SHN','1');
INSERT INTO countries VALUES (DEFAULT,'St. Pierre and Miquelon','PM','SPM','1');
INSERT INTO countries VALUES (DEFAULT,'Sudan','SD','SDN','1');
INSERT INTO countries VALUES (DEFAULT,'Suriname','SR','SUR','1');
INSERT INTO countries VALUES (DEFAULT,'Svalbard and Jan Mayen Islands','SJ','SJM','1');
INSERT INTO countries VALUES (DEFAULT,'Swaziland','SZ','SWZ','1');
INSERT INTO countries VALUES (DEFAULT,'Sweden','SE','SWE','1');
INSERT INTO countries VALUES (DEFAULT,'Switzerland','CH','CHE','1');
INSERT INTO countries VALUES (DEFAULT,'Syrian Arab Republic','SY','SYR','1');
INSERT INTO countries VALUES (DEFAULT,'Taiwan','TW','TWN','1');
INSERT INTO countries VALUES (DEFAULT,'Tajikistan','TJ','TJK','1');
INSERT INTO countries VALUES (DEFAULT,'Tanzania, United Republic of','TZ','TZA','1');
INSERT INTO countries VALUES (DEFAULT,'Thailand','TH','THA','1');
INSERT INTO countries VALUES (DEFAULT,'Togo','TG','TGO','1');
INSERT INTO countries VALUES (DEFAULT,'Tokelau','TK','TKL','1');
INSERT INTO countries VALUES (DEFAULT,'Tonga','TO','TON','1');
INSERT INTO countries VALUES (DEFAULT,'Trinidad and Tobago','TT','TTO','1');
INSERT INTO countries VALUES (DEFAULT,'Tunisia','TN','TUN','1');
INSERT INTO countries VALUES (DEFAULT,'Turkey','TR','TUR','1');
INSERT INTO countries VALUES (DEFAULT,'Turkmenistan','TM','TKM','1');
INSERT INTO countries VALUES (DEFAULT,'Turks and Caicos Islands','TC','TCA','1');
INSERT INTO countries VALUES (DEFAULT,'Tuvalu','TV','TUV','1');
INSERT INTO countries VALUES (DEFAULT,'Uganda','UG','UGA','1');
INSERT INTO countries VALUES (DEFAULT,'Ukraine','UA','UKR','1');
INSERT INTO countries VALUES (DEFAULT,'United Arab Emirates','AE','ARE','1');
INSERT INTO countries VALUES (DEFAULT,'United Kingdom','GB','GBR','1');
INSERT INTO countries VALUES (DEFAULT,'United States','US','USA', '2');
INSERT INTO countries VALUES (DEFAULT,'United States Minor Outlying Islands','UM','UMI','1');
INSERT INTO countries VALUES (DEFAULT,'Uruguay','UY','URY','1');
INSERT INTO countries VALUES (DEFAULT,'Uzbekistan','UZ','UZB','1');
INSERT INTO countries VALUES (DEFAULT,'Vanuatu','VU','VUT','1');
INSERT INTO countries VALUES (DEFAULT,'Vatican City State (Holy See)','VA','VAT','1');
INSERT INTO countries VALUES (DEFAULT,'Venezuela','VE','VEN','1');
INSERT INTO countries VALUES (DEFAULT,'Viet Nam','VN','VNM','1');
INSERT INTO countries VALUES (DEFAULT,'Virgin Islands (British)','VG','VGB','1');
INSERT INTO countries VALUES (DEFAULT,'Virgin Islands (U.S.)','VI','VIR','1');
INSERT INTO countries VALUES (DEFAULT,'Wallis and Futuna Islands','WF','WLF','1');
INSERT INTO countries VALUES (DEFAULT,'Western Sahara','EH','ESH','1');
INSERT INTO countries VALUES (DEFAULT,'Yemen','YE','YEM','1');
INSERT INTO countries VALUES (DEFAULT,'Yugoslavia','YU','YUG','1');
INSERT INTO countries VALUES (DEFAULT,'Zaire','ZR','ZAR','1');
INSERT INTO countries VALUES (DEFAULT,'Zambia','ZM','ZMB','1');
INSERT INTO countries VALUES (DEFAULT,'Zimbabwe','ZW','ZWE','1');

INSERT INTO currencies VALUES (DEFAULT,'US Dollar','USD','$','','.',',','2','1.0000', now());
INSERT INTO currencies VALUES (DEFAULT,'Euro','EUR','','EUR','.',',','2','1.4000', now());

-- John Doe User "root@localhost.com" Password: "password"
INSERT INTO customers VALUES (DEFAULT, 'm', 'John', 'doe', '2001-01-01 00:00:00', 'root@localhost', '1', '12345', '', 'd95e8fa7f20a009372eb3477473fcd34:1c', '0');

INSERT INTO customers_info VALUES (1, now(), 0, now(), now(), 0);

INSERT INTO languages VALUES (DEFAULT,'English','en','icon.gif','english',1);
INSERT INTO languages VALUES (DEFAULT,'Deutsch','de','icon.gif','german',2);
INSERT INTO languages VALUES (DEFAULT,'Español','es','icon.gif','espanol',3);

INSERT INTO manufacturers VALUES (DEFAULT,'Matrox','manufacturer_matrox.gif', now(), null);
INSERT INTO manufacturers VALUES (DEFAULT,'Microsoft','manufacturer_microsoft.gif', now(), null);
INSERT INTO manufacturers VALUES (DEFAULT,'Warner','manufacturer_warner.gif', now(), null);
INSERT INTO manufacturers VALUES (DEFAULT,'Fox','manufacturer_fox.gif', now(), null);
INSERT INTO manufacturers VALUES (DEFAULT,'Logitech','manufacturer_logitech.gif', now(), null);
INSERT INTO manufacturers VALUES (DEFAULT,'Canon','manufacturer_canon.gif', now(), null);
INSERT INTO manufacturers VALUES (DEFAULT,'Sierra','manufacturer_sierra.gif', now(), null);
INSERT INTO manufacturers VALUES (DEFAULT,'GT Interactive','manufacturer_gt_interactive.gif', now(), null);
INSERT INTO manufacturers VALUES (DEFAULT,'Hewlett Packard','manufacturer_hewlett_packard.gif', now(), null);
...
INSERT INTO products VALUES (DEFAULT,32,'MG200MMS','matrox/mg200mms.gif',299.99, now(),null,now(),23.00,1,1,1,0);
INSERT INTO products VALUES (DEFAULT,32,'MG400-32MB','matrox/mg400-32mb.gif',499.99, now(),null,now(),23.00,1,1,1,0);
INSERT INTO products VALUES (DEFAULT,2,'MSIMPRO','microsoft/msimpro.gif',49.99, now(),null,now(),7.00,1,1,3,0);
INSERT INTO products VALUES (DEFAULT,13,'DVD-RPMK','dvd/replacement_killers.gif',42.00, now(),null,now(),23.00,1,1,2,0);
INSERT INTO products VALUES (DEFAULT,17,'DVD-BLDRNDC','dvd/blade_runner.gif',35.99, now(),null,now(),7.00,1,1,3,0);
INSERT INTO products VALUES (DEFAULT,10,'DVD-MATR','dvd/the_matrix.gif',39.99, now(),null,now(),7.00,1,1,3,0);
INSERT INTO products VALUES (DEFAULT,10,'DVD-YGEM','dvd/youve_got_mail.gif',34.99, now(),null,now(),7.00,1,1,3,0);
INSERT INTO products VALUES (DEFAULT,10,'DVD-ABUG','dvd/a_bugs_life.gif',35.99, now(),null,now(),7.00,1,1,3,0);
INSERT INTO products VALUES (DEFAULT,10,'DVD-UNSG','dvd/under_siege.gif',29.99, now(),null,now(),7.00,1,1,3,0);
INSERT INTO products VALUES (DEFAULT,10,'DVD-UNSG2','dvd/under_siege2.gif',29.99, now(),null,now(),7.00,1,1,3,0);
INSERT INTO products VALUES (DEFAULT,10,'DVD-FDBL','dvd/fire_down_below.gif',29.99, now(),null,now(),7.00,1,1,3,0);
INSERT INTO products VALUES (DEFAULT,10,'DVD-DHWV','dvd/die_hard_3.gif',39.99, now(),null,now(),7.00,1,1,4,0);
INSERT INTO products VALUES (DEFAULT,10,'DVD-LTWP','dvd/lethal_weapon.gif',34.99, now(),null,now(),7.00,1,1,3,0);
INSERT INTO products VALUES (DEFAULT,10,'DVD-REDC','dvd/red_corner.gif',32.00, now(),null,now(),7.00,1,1,3,0);
INSERT INTO products VALUES (DEFAULT,10,'DVD-FRAN','dvd/frantic.gif',35.00, now(),null,now(),7.00,1,1,3,0);
INSERT INTO products VALUES (DEFAULT,10,'DVD-CUFI','dvd/courage_under_fire.gif',38.99, now(),null,now(),7.00,1,1,4,0);
INSERT INTO products VALUES (DEFAULT,10,'DVD-SPEED','dvd/speed.gif',39.99, now(),null,now(),7.00,1,1,4,0);
INSERT INTO products VALUES (DEFAULT,10,'DVD-SPEED2','dvd/speed_2.gif',42.00, now(),null,now(),7.00,1,1,4,0);
INSERT INTO products VALUES (DEFAULT,10,'DVD-TSAB','dvd/theres_something_about_mary.gif',49.99, now(),null,now(),7.00,1,1,4,0);
INSERT INTO products VALUES (DEFAULT,10,'DVD-BELOVED','dvd/beloved.gif',54.99, now(),null,now(),7.00,1,1,3,0);
INSERT INTO products VALUES (DEFAULT,16,'PC-SWAT3','sierra/swat_3.gif',79.99, now(),null,now(),7.00,1,1,7,0);
INSERT INTO products VALUES (DEFAULT,13,'PC-UNTM','gt_interactive/unreal_tournament.gif',89.99, now(),null,now(),7.00,1,1,8,0);
INSERT INTO products VALUES (DEFAULT,16,'PC-TWOF','gt_interactive/wheel_of_time.gif',99.99, now(),null,now(),10.00,1,1,8,0);
INSERT INTO products VALUES (DEFAULT,17,'PC-DISC','gt_interactive/disciples.gif',90.00, now(),null,now(),8.00,1,1,8,0);
INSERT INTO products VALUES (DEFAULT,16,'MSINTKB','microsoft/intkeyboardps2.gif',69.99, now(),null,now(),8.00,1,1,2,0);
INSERT INTO products VALUES (DEFAULT,10,'MSIMEXP','microsoft/imexplorer.gif',64.95, now(),null,now(),8.00,1,1,2,0);
INSERT INTO products VALUES (DEFAULT,8,'HPLJ1100XI','hewlett_packard/lj1100xi.gif',499.99, now(),null,now(),45.00,1,1,9,0);

INSERT INTO products_description VALUES (DEFAULT,1,'Matrox G200 MMS',E'Reinforcing its position as a multi-monitor trailblazer, Matrox Graphics Inc. has once again developed the most flexible and highly advanced solution in the industry. Introducing the new Matrox G200 Multi-Monitor Series; the first graphics card ever to support up to four DVI digital flat panel displays on a single 8&quot; PCI board.<br><br>With continuing demand for digital flat panels in the financial workplace, the Matrox G200 MMS is the ultimate in flexible solutions. The Matrox G200 MMS also supports the new digital video interface (DVI) created by the Digital Display Working Group (DDWG) designed to ease the adoption of digital flat panels. Other configurations include composite video capture ability and onboard TV tuner, making the Matrox G200 MMS the complete solution for business needs.<br><br>Based on the award-winning MGA-G200 graphics chip, the Matrox G200 Multi-Monitor Series provides superior 2D/3D graphics acceleration to meet the demanding needs of business applications such as real-time stock quotes (Versus), live video feeds (Reuters & Bloombergs), multiple windows applications, word processing, spreadsheets and CAD.',E'www.matrox.com/mga/products/g200_mms/home.cfm',0);
INSERT INTO products_description VALUES (DEFAULT,1,'Matrox G400 32MB',E'<b>Dramatically Different High Performance Graphics</b><br><br>Introducing the Millennium G400 Series - a dramatically different, high performance graphics experience. Armed with the industry''s fastest graphics chip, the Millennium G400 Series takes explosive acceleration two steps further by adding unprecedented image quality, along with the most versatile display options for all your 3D, 2D and DVD applications. As the most powerful and innovative tools in your PC''s arsenal, the Millennium G400 Series will not only change the way you see graphics, but will revolutionize the way you use your computer.<br><br><b>Key features:</b><ul><li>New Matrox G400 256-bit DualBus graphics chip</li><li>Explosive 3D, 2D and DVD performance</li><li>DualHead Display</li><li>Superior DVD and TV output</li><li>3D Environment-Mapped Bump Mapping</li><li>Vibrant Color Quality rendering </li><li>UltraSharp DAC of up to 360 MHz</li><li>3D Rendering Array Processor</li><li>Support for 16 or 32 MB of memory</li></ul>',E'www.matrox.com/mga/products/mill_g400/home.htm',0);
INSERT INTO products_description VALUES (DEFAULT,1,'Microsoft IntelliMouse Pro',E'Every element of IntelliMouse Pro - from its unique arched shape to the texture of the rubber grip around its base - is the product of extensive customer and ergonomic research. Microsoft''s popular wheel control, which now allows zooming and universal scrolling functions, gives IntelliMouse Pro outstanding comfort and efficiency.',E'www.microsoft.com/hardware/mouse/intellimouse.asp',0);
INSERT INTO products_description VALUES (DEFAULT,1,'The Replacement Killers',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br>Languages: English, Deutsch.<br>Subtitles: English, Deutsch, Spanish.<br>Audio: Dolby Surround 5.1.<br>Picture Format: 16:9 Wide-Screen.<br>Length: (approx) 80 minutes.<br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'www.replacement-killers.com',0);
INSERT INTO products_description VALUES (DEFAULT,1,'Blade Runner - Director''s Cut',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br>Languages: English, Deutsch.<br>Subtitles: English, Deutsch, Spanish.<br>Audio: Dolby Surround 5.1.<br>Picture Format: 16:9 Wide-Screen.<br>Length: (approx) 112 minutes.<br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'www.bladerunner.com',0);
INSERT INTO products_description VALUES (DEFAULT,1,'The Matrix',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch.<br><br>Audio: Dolby Surround.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 131 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Making Of.',E'www.thematrix.com',0);
INSERT INTO products_description VALUES (DEFAULT,1,'You''ve Got Mail',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch, Spanish.<br><br>Subtitles: English, Deutsch, Spanish, French, Nordic, Polish.<br><br>Audio: Dolby Digital 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 115 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'www.youvegotmail.com',0);
INSERT INTO products_description VALUES (DEFAULT,1,'A Bug''s Life',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Digital 5.1 / Dobly Surround Stereo.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 91 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'www.abugslife.com',0);
INSERT INTO products_description VALUES (DEFAULT,1,'Under Siege',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 98 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description VALUES (DEFAULT,1,'Under Siege 2 - Dark Territory',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 98 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description VALUES (DEFAULT,1,'Fire Down Below',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 100 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description VALUES (DEFAULT,1,'Die Hard With A Vengeance',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 122 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description VALUES (DEFAULT,1,'Lethal Weapon',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 100 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description VALUES (DEFAULT,1,'Red Corner',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 117 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description VALUES (DEFAULT,1,'Frantic',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 115 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description VALUES (DEFAULT,1,'Courage Under Fire',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 112 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description VALUES (DEFAULT,1,'Speed',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 112 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description VALUES (DEFAULT,1,'Speed 2: Cruise Control',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 120 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description VALUES (DEFAULT,1,'There''s Something About Mary',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 114 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description VALUES (DEFAULT,1,'Beloved',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 164 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description VALUES (DEFAULT,1,'SWAT 3: Close Quarters Battle',E'<b>Windows 95/98</b><br><br>211 in progress with shots fired. Officer down. Armed suspects with hostages. Respond Code 3! Los Angles, 2005, In the next seven days, representatives from every nation around the world will converge on Las Angles to witness the signing of the United Nations Nuclear Abolishment Treaty. The protection of these dignitaries falls on the shoulders of one organization, LAPD SWAT. As part of this elite tactical organization, you and your team have the weapons and all the training necessary to protect, to serve, and \"When needed\" to use deadly force to keep the peace. It takes more than weapons to make it through each mission. Your arsenal includes C2 charges, flashbangs, tactical grenades. opti-Wand mini-video cameras, and other devices critical to meeting your objectives and keeping your men free of injury. Uncompromised Duty, Honor and Valor!',E'www.swat3.com',0);
INSERT INTO products_description VALUES (DEFAULT,1,'Unreal Tournament',E'From the creators of the best-selling Unreal, comes Unreal Tournament. A new kind of single player experience. A ruthless multiplayer revolution.<br><br>This stand-alone game showcases completely new team-based gameplay, groundbreaking multi-faceted single player action or dynamic multi-player mayhem. It''s a fight to the finish for the title of Unreal Grand Master in the gladiatorial arena. A single player experience like no other! Guide your team of ''bots'' (virtual teamates) against the hardest criminals in the galaxy for the ultimate title - the Unreal Grand Master.',E'www.unrealtournament.net',0);
INSERT INTO products_description VALUES (DEFAULT,1,'The Wheel Of Time',E'The world in which The Wheel of Time takes place is lifted directly out of Jordan''s pages; it''s huge and consists of many different environments. How you navigate the world will depend largely on which game - single player or multipayer - you''re playing. The single player experience, with a few exceptions, will see Elayna traversing the world mainly by foot (with a couple notable exceptions). In the multiplayer experience, your character will have more access to travel via Ter''angreal, Portal Stones, and the Ways. However you move around, though, you''ll quickly discover that means of locomotion can easily become the least of the your worries...<br><br>During your travels, you quickly discover that four locations are crucial to your success in the game. Not surprisingly, these locations are the homes of The Wheel of Time''s main characters. Some of these places are ripped directly from the pages of Jordan''s books, made flesh with Legend''s unparalleled pixel-pushing ways. Other places are specific to the game, conceived and executed with the intent of expanding this game world even further. Either way, they provide a backdrop for some of the most intense first person action and strategy you''ll have this year.',E'www.wheeloftime.com',0);
INSERT INTO products_description VALUES (DEFAULT,1,'Disciples: Sacred Lands',E'A new age is dawning...<br><br>Enter the realm of the Sacred Lands, where the dawn of a New Age has set in motion the most momentous of wars. As the prophecies long foretold, four races now clash with swords and sorcery in a desperate bid to control the destiny of their gods. Take on the quest as a champion of the Empire, the Mountain Clans, the Legions of the Damned, or the Undead Hordes and test your faith in battles of brute force, spellbinding magic and acts of guile. Slay demons, vanquish giants and combat merciless forces of the dead and undead. But to ensure the salvation of your god, the hero within must evolve.<br><br>The day of reckoning has come... and only the chosen will survive.',E'',0);
INSERT INTO products_description VALUES (DEFAULT,1,'Microsoft Internet Keyboard PS/2',E'The Internet Keyboard has 10 Hot Keys on a comfortable standard keyboard design that also includes a detachable palm rest. The Hot Keys allow you to browse the web, or check e-mail directly from your keyboard. The IntelliType Pro software also allows you to customize your hot keys - make the Internet Keyboard work the way you want it to!',E'',0);
INSERT INTO products_description VALUES (DEFAULT,1,'Microsoft IntelliMouse Explorer',E'Microsoft introduces its most advanced mouse, the IntelliMouse Explorer! IntelliMouse Explorer features a sleek design, an industrial-silver finish, a glowing red underside and taillight, creating a style and look unlike any other mouse. IntelliMouse Explorer combines the accuracy and reliability of Microsoft IntelliEye optical tracking technology, the convenience of two new customizable function buttons, the efficiency of the scrolling wheel and the comfort of expert ergonomic design. All these great features make this the best mouse for the PC!',E'www.microsoft.com/hardware/mouse/explorer.asp',0);
INSERT INTO products_description VALUES (DEFAULT,1,'Hewlett Packard LaserJet 1100Xi',E'HP has always set the pace in laser printing technology. The new generation HP LaserJet 1100 series sets another impressive pace, delivering a stunning 8 pages per minute print speed. The 600 dpi print resolution with HP''s Resolution Enhancement technology (REt) makes every document more professional.<br><br>Enhanced print speed and laser quality results are just the beginning. With 2MB standard memory, HP LaserJet 1100xi users will be able to print increasingly complex pages. Memory can be increased to 18MB to tackle even more complex documents with ease. The HP LaserJet 1100xi supports key operating systems including Windows 3.1, 3.11, 95, 98, NT 4.0, OS/2 and DOS. Network compatibility available via the optional HP JetDirect External Print Servers.<br><br>HP LaserJet 1100xi also features The Document Builder for the Web Era from Trellix Corp. (featuring software to create Web documents).',E'www.pandi.hp.com/pandi-db/prodinfo.main?product=laserjet1100',0);
INSERT INTO products_description VALUES (1,2,'Matrox G200 MMS',E'<b>Unterstützung für zwei bzw. vier analoge oder digitale Monitore</b><br><br>Die Matrox G200 Multi-Monitor-Serie führt die bewährte Matrox Tradition im Multi-Monitor- Bereich fort und bietet flexible und fortschrittliche Lösungen.Matrox stellt als erstes Unternehmen einen vierfachen digitalen PanelLink® DVI Flachbildschirm Ausgang zur Verfügung. Mit den optional erhältlichen TV Tuner und Video-Capture Möglichkeiten stellt die Matrox G200 MMS eine alles umfassende Mehrschirm-Lösung dar.<br><br><b>Leistungsmerkmale:</b><br><ul><br><li>Preisgekrönter Matrox G200 128-Bit Grafikchip</li><br><li>Schneller 8 MB SGRAM-Speicher pro Kanal</li><br><li>Integrierter, leistungsstarker 250 MHz RAMDAC</li><br><li>Unterstützung für bis zu 16 Bildschirme über 4 Quad-Karten (unter Win NT,ab Treiber 4.40)</li><br><li>Unterstützung von 9 Monitoren unter Win 98</li><br><li>2 bzw. 4 analoge oder digitale Ausgabekanäle pro PCI-Karte</li><br><li>Desktop-Darstellung von 1800 x 1440 oder 1920 x 1200 pro Chip</li><br><li>Anschlußmöglichkeit an einen 15-poligen VGA-Monitor oder an einen 30-poligen digitalen DVI-Flachbildschirm plus integriertem Composite-Video-Eingang (bei der TV-Version)</li><br><li>PCI Grafikkarte, kurze Baulänge</li><br><li>Treiberunterstützung: Windows® 2000, Windows NT® und Windows® 98</li><br><li>Anwendungsbereiche: Börsenumgebung mit zeitgleich großem Visualisierungsbedarf, Videoüberwachung, Video-Conferencing</li><br></ul>',E'www.matrox.com/mga/deutsch/products/g200_mms/home.cfm',0);
INSERT INTO products_description VALUES (2,2,'Matrox G400 32 MB',E'<b>Neu! Matrox G400 &quot;all inclusive&quot; und vieles mehr...</b><br><br>Die neue Millennium G400-Serie - Hochleistungsgrafik mit dem sensationellen Unterschied. Ausgestattet mit dem neu eingeführten Matrox G400 Grafikchip, bietet die Millennium G400-Serie eine überragende Beschleunigung inklusive bisher nie dagewesener Bildqualitat und enorm flexibler Darstellungsoptionen bei allen Ihren 3D-, 2D- und DVD-Anwendungen.<br><br><ul><br><li>DualHead Display und TV-Ausgang</li><br><li>Environment Mapped Bump Mapping</li><br><li>Matrox G400 256-Bit DualBus</li><br><li>3D Rendering Array Prozessor</li><br><li>Vibrant Color Quality² (VCQ²)</li><br><li>UltraSharp DAC</li><br></ul><br><i>&quot;Bleibt abschließend festzustellen, daß die Matrox Millennium G400 Max als Allroundkarte für den Highend-PC derzeit unerreicht ist. Das ergibt den Testsieg und unsere wärmste Empfehlung.&quot;</i><br><br><b>GameStar 8/99 (S.184)</b>',E'www.matrox.com/mga/deutsch/products/mill_g400/home.cfm',0);
INSERT INTO products_description VALUES (3,2,'Microsoft IntelliMouse Pro',E'Die IntelliMouse Pro hat mit der IntelliRad-Technologie einen neuen Standard gesetzt. Anwenderfreundliche Handhabung und produktiveres Arbeiten am PC zeichnen die IntelliMouse aus. Die gewölbte Oberseite paßt sich natürlich in die Handfläche ein, die geschwungene Form erleichtert das Bedienen der Maus. Sie ist sowohl für Rechts- wie auch für Linkshänder geeignet. Mit dem Rad der IntelliMouse kann der Anwender einfach und komfortabel durch Dokumente navigieren.<br><br><b>Eigenschaften:</b><br><ul><br><li><b>ANSCHLUSS:</b> PS/2</li><br><li><b>FARBE:</b> weiß</li><br><li><b>TECHNIK:</b> Mauskugel</li><br><li><b>TASTEN:</b> 3 (incl. Scrollrad)</li><br><li><b>SCROLLRAD:</b> Ja</li><br></ul>',E'',0);
INSERT INTO products_description VALUES (4,2,'Die Ersatzkiller',E'Originaltitel: &quot;The Replacement Killers&quot;<br><br>Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Sprachen: English, Deutsch.<br><br>Untertitel: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Bildformat: 16:9 Wide-Screen.<br><br>Dauer: (approx) 80 minutes.<br><br>Außerdem: Interaktive Menus, Kapitelauswahl, Untertitel.<br><br>(USA 1998). Til Schweiger schießt auf Hongkong-Star Chow Yun-Fat (&quot;Anna und der König&quot;) ­ ein Fehler ...',E'www.replacement-killers.com',0);
INSERT INTO products_description VALUES (5,2,'Blade Runner - Director''s Cut',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Sprachen: English, Deutsch.<br><br>Untertitel: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Bildformat: 16:9 Wide-Screen.<br><br>Dauer: (approx) 112 minutes.<br><br>Außerdem: Interaktive Menus, Kapitelauswahl, Untertitel.<br><br><b>Sci-Fi-Klassiker, USA 1983, 112 Min.</b><br><br>Los Angeles ist im Jahr 2019 ein Hexenkessel. Dauerregen und Smog tauchen den überbevölkerten Moloch in ewige Dämmerung. Polizeigleiter schwirren durch die Luft und überwachen das grelle Ethnogemisch, das sich am Fuße 400stöckiger Stahlbeton-Pyramiden tummelt. Der abgehalfterte Ex-Cop und \"Blade Runner\" Rick Deckard ist Spezialist für die Beseitigung von Replikanten, künstlichen Menschen, geschaffen für harte Arbeit auf fremden Planeten. Nur ihm kann es gelingen, vier flüchtige, hochintelligente \"Nexus 6\"-Spezialmodelle zu stellen. Die sind mit ihrem starken und brandgefährlichen Anführer Batty auf der Suche nach ihrem Schöpfer. Er soll ihnen eine längere Lebenszeit schenken. Das muß Rick Deckard verhindern.  Als sich der eiskalte Jäger in Rachel, die Sekretärin seines Auftraggebers, verliebt, gerät sein Weltbild jedoch ins Wanken. Er entdeckt, daß sie - vielleicht wie er selbst - ein Replikant ist ...<br><br>Die Konfrontation des Menschen mit \"Realität\" und \"Virtualität\" und das verstrickte Spiel mit getürkten Erinnerungen zieht sich als roter Faden durch das Werk von Autor Philip K. Dick (\"Die totale Erinnerung\"). Sein Roman \"Träumen Roboter von elektrischen Schafen?\" liefert die Vorlage für diesen doppelbödigen Thriller, der den Zuschauer mit faszinierenden<br>Zukunftsvisionen und der gigantischen Kulisse des Großstadtmolochs gefangen nimmt.',E'www.bladerunner.com',0);
INSERT INTO products_description VALUES (6,2,'Matrix',E'Originaltitel: &quot;The Matrix&quot;<br><br>Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Sprachen: English, Deutsch.<br><br>Untertitel: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Bildformat: 16:9 Wide-Screen.<br><br>Dauer: (approx) 136 minuten.<br><br>Außerdem: Interaktive Menus, Kapitelauswahl, Untertitel.<br><br>(USA 1999) Der Geniestreich der Wachowski-Brüder. In dieser technisch perfekten Utopie kämpft Hacker Keanu Reeves gegen die Diktatur der Maschinen...',E'www.whatisthematrix.com',0);
INSERT INTO products_description VALUES (7,2,'e-m@il für Dich',E'Original: &quot;You''ve got mail&quot;<br><br>Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Sprachen: English, Deutsch.<br><br>Untertitel: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Bildformat: 16:9 Wide-Screen.<br><br>Dauer: (approx) 112 minutes.<br><br>Außerdem: Interaktive Menus, Kapitelauswahl, Untertitel.<br><br>(USA 1998) von Nora Ephron (&qout;Schlaflos in Seattle&quot;). Meg Ryan und Tom Hanks knüpfen per E-Mail zarte Bande. Dass sie sich schon kennen, ahnen sie nicht ...',E'www.youvegotmail.com',0);
INSERT INTO products_description VALUES (8,2,'Das Große Krabbeln',E'Originaltitel: &quot;A Bug''s Life&quot;<br><br>Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Sprachen: English, Deutsch.<br><br>Untertitel: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Bildformat: 16:9 Wide-Screen.<br><br>Dauer: (approx) 96 minuten.<br><br>Außerdem: Interaktive Menus, Kapitelauswahl, Untertitel.<br><br>(USA 1998). Ameise Flik zettelt einen Aufstand gegen gefräßige Grashüpfer an ... Eine fantastische Computeranimation des \"Toy Story\"-Teams. ',E'www.abugslife.com',0);
INSERT INTO products_description VALUES (9,2,'Alarmstufe: Rot',E'Originaltitel: &quot;Under Siege&quot;<br><br>Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Sprachen: English, Deutsch.<br><br>Untertitel: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Bildformat: 16:9 Wide-Screen.<br><br>Dauer: (approx) 96 minuten.<br><br>Außerdem: Interaktive Menus, Kapitelauswahl, Untertitel.<br><br><b>Actionthriller. Smutje Steven Seagal versalzt Schurke Tommy Lee Jones die Suppe</b><br><br>Katastrophe ahoi: Kurz vor Ausmusterung der \"U.S.S. Missouri\" kapert die High-tech-Bande von Ex-CIA-Agent Strannix (Tommy Lee Jones) das Schlachtschiff. Strannix will die Nuklearraketen des Kreuzers klauen und verscherbeln. Mit Hilfe des irren Ersten Offiziers Krill (lustig: Gary Busey) killen die Gangster den Käpt’n und sperren seine Crew unter Deck. Blöd, dass sie dabei Schiffskoch Rybak (Steven Seagal) vergessen. Der Ex-Elitekämpfer knipst einen Schurken nach dem anderen aus. Eine Verbündete findet er in Stripperin Jordan (Ex-\"Baywatch\"-Biene Erika Eleniak). Die sollte eigentlich aus Käpt’ns Geburtstagstorte hüpfen ... Klar: Seagal ist kein Edelmime. Dafür ist Regisseur Andrew Davis (\"Auf der Flucht\") ein Könner: Er würzt die Action-Orgie mit Ironie und nutzt die imposante Schiffskulisse voll aus. Für Effekte und Ton gab es 1993 Oscar-Nominierungen. ',E'',0);
INSERT INTO products_description VALUES (10,2,'Alarmstufe: Rot 2',E'Originaltitel: &quot;Under Siege 2: Dark Territory&quot;<br><br>Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Sprachen: English, Deutsch.<br><br>Untertitel: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Bildformat: 16:9 Wide-Screen.<br><br>Dauer: (approx) 96 minuten.<br><br>Außerdem: Interaktive Menus, Kapitelauswahl, Untertitel.<br><br>(USA ’95). Von einem gekaperten Zug aus übernimmt Computerspezi Dane die Kontrolle über einen Kampfsatelliten und erpresst das Pentagon. Aber auch Ex-Offizier Ryback (Steven Seagal) ist im Zug ...<br>',E'',0);
INSERT INTO products_description VALUES (11,2,'Fire Down Below',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Sprachen: English, Deutsch.<br><br>Untertitel: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Bildformat: 16:9 Wide-Screen.<br><br>Dauer: (approx) 96 minuten.<br><br>Außerdem: Interaktive Menus, Kapitelauswahl, Untertitel.<br><br>Ein mysteriöser Mordfall führt den Bundesmarschall Jack Taggert in eine Kleinstadt im US-Staat Kentucky. Doch bei seinen Ermittlungen stößt er auf eine Mauer des Schweigens. Angst beherrscht die Stadt, und alle Spuren führen zu dem undurchsichtigen Minen-Tycoon Orin Hanner. Offenbar werden in der friedlichen Berglandschaft gigantische Mengen Giftmülls verschoben, mit unkalkulierbaren Risiken. Um eine Katastrophe zu verhindern, räumt Taggert gnadenlos auf ...',E'',0);
INSERT INTO products_description VALUES (12,2,'Stirb Langsam - Jetzt Erst Recht',E'Originaltitel: &quot;Die Hard With A Vengeance&quot;<br><br>Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Sprachen: English, Deutsch.<br><br>Untertitel: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Bildformat: 16:9 Wide-Screen.<br><br>Dauer: (approx) 96 minuten.<br><br>Außerdem: Interaktive Menus, Kapitelauswahl, Untertitel.<br><br>So explosiv, so spannend, so rasant wie nie zuvor: Bruce Willis als Detectiv John McClane in einem Action-Thriller der Superlative! Das ist heute nicht McClanes Tag. Seine Frau hat ihn verlassen, sein Boß hat ihn vom Dienst suspendiert und irgendein Verrückter hat ihn gerade zum Gegenspieler in einem teuflischen Spiel erkoren - und der Einsatz ist New York selbst. Ein Kaufhaus ist explodiert, doch das ist nur der Auftakt. Der geniale Superverbrecher Simon droht, die ganze Stadt Stück für Stück in die Luft zu sprengen, wenn McClane und sein Partner wider Willen seine explosiven\" Rätsel nicht lösen. Eine mörderische Hetzjagd quer durch New York beginnt - bis McClane merkt, daß der Bombenterror eigentlich nur ein brillantes Ablenkungsmanöver ist...!<br><i>\"Perfekt gemacht und stark besetzt. Das Action-Highlight des Jahres!\"</i> <b>(Bild)</b>',E'',0);
INSERT INTO products_description VALUES (13,2,'Zwei stahlharte Profis',E'Originaltitel: &quot;Lethal Weapon&quot;<br><br>Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Sprachen: English, Deutsch.<br><br>Untertitel: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Bildformat: 16:9 Wide-Screen.<br><br>Dauer: (approx) 96 minuten.<br><br>Außerdem: Interaktive Menus, Kapitelauswahl, Untertitel.<br><br>Sie sind beide Cops in L.A.. Sie haben beide in Vietnam für eine Spezialeinheit gekämpft. Und sie hassen es beide, mit einem Partner arbeiten zu müssen. Aber sie sind Partner: Martin Riggs, der Mann mit dem Todeswunsch, für wen auch immer. Und Roger Murtaugh, der besonnene Polizist. Gemeinsam enttarnen sie einen gigantischen Heroinschmuggel, hinter dem sich eine Gruppe ehemaliger CIA-Söldner verbirgt. Eine Killerbande gegen zwei Profis ...',E'',0);
INSERT INTO products_description VALUES (14,2,'Labyrinth ohne Ausweg',E'Originaltitel: &quot;Red Corner&quot;<br><br>Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Sprachen: English, Deutsch.<br><br>Untertitel: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Bildformat: 16:9 Wide-Screen.<br><br>Dauer: (approx) 96 minuten.<br><br>Außerdem: Interaktive Menus, Kapitelauswahl, Untertitel.<br><br>Dem Amerikaner Jack Moore wird in China der bestialische Mord an einem Fotomodel angehängt. Brutale Gefängnisschergen versuchen, ihn durch Folter zu einem Geständnis zu zwingen. Vor Gericht fordert die Anklage die Todesstrafe - Moore''s Schicksal scheint besiegelt. Durch einen Zufall gelingt es ihm, aus der Haft zu fliehen, doch aus der feindseligen chinesischen Hauptstadt gibt es praktisch kein Entkommen ...',E'',0);
INSERT INTO products_description VALUES (15,2,'Frantic',E'Originaltitel: &quot;Frantic&quot;<br><br>Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Sprachen: English, Deutsch.<br><br>Untertitel: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Bildformat: 16:9 Wide-Screen.<br><br>Dauer: (approx) 96 minuten.<br><br>Außerdem: Interaktive Menus, Kapitelauswahl, Untertitel.<br><br>Ein romantischer Urlaub in Paris, der sich in einen Alptraum verwandelt. Ein Mann auf der verzweifelten Suche nach seiner entführten Frau. Ein düster-bedrohliches Paris, in dem nur ein Mensch Licht in die tödliche Affäre bringen kann.',E'',0);
INSERT INTO products_description VALUES (16,2,'Mut Zur Wahrheit',E'Originaltitel: &quot;Courage Under Fire&quot;<br><br>Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Sprachen: English, Deutsch.<br><br>Untertitel: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Bildformat: 16:9 Wide-Screen.<br><br>Dauer: (approx) 96 minuten.<br><br>Außerdem: Interaktive Menus, Kapitelauswahl, Untertitel.<br><br>Lieutenant Colonel Nathaniel Serling (Denzel Washington) lässt während einer Schlacht im Golfkrieg versehentlich auf einen US-Panzer schießen, dessen Mannschaft dabei ums Leben kommt. Ein Jahr nach diesem Vorfall wird Serling, der mittlerweile nach Washington D.C. versetzt wurde, die Aufgabe übertragen, sich um einen Kandidaten zu kümmern, der während des Krieges starb und dem der höchste militärische Orden zuteil werden soll. Allerdings sind sowohl der Fall und als auch der betreffende Soldat ein politisch heißes Eisen -- Captain Karen Walden (Meg Ryan) ist Amerikas erster weiblicher Soldat, der im Kampf getötet wurde.<br><br>Serling findet schnell heraus, dass es im Fall des im felsigen Gebiet von Kuwait abgestürzten Rettungshubschraubers Diskrepanzen gibt. In Flashbacks werden von unterschiedlichen Personen verschiedene Versionen von Waldens Taktik, die Soldaten zu retten und den Absturz zu überleben, dargestellt (à la Kurosawas Rashomon). Genau wie in Glory erweist sich Regisseur Edward Zwicks Zusammenstellung von bekannten und unbekannten Schauspielern als die richtige Mischung. Waldens Crew ist besonders überzeugend. Matt Damon als der Sanitäter kommt gut als der leichtfertige Typ rüber, als er Washington seine Geschichte erzählt. Im Kampf ist er ein mit Fehlern behafteter, humorvoller Soldat.<br><br>Die erstaunlichste Arbeit in Mut zur Wahrheit leistet Lou Diamond Phillips (als der Schütze der Gruppe), dessen Karriere sich auf dem Weg in die direkt für den Videomarkt produzierten Filme befand. Und dann ist da noch Ryan. Sie hat sich in dramatischen Filmen in der Vergangenheit gut behauptet (Eine fast perfekte Liebe, Ein blutiges Erbe), es aber nie geschafft, ihrem Image zu entfliehen, das sie in die Ecke der romantischen Komödie steckte. Mit gefärbtem Haar, einem leichten Akzent und der von ihr geforderten Darstellungskunst hat sie endlich einen langlebigen dramatischen Film.',E'',0);
INSERT INTO products_description VALUES (17,2,'Speed',E'Originaltitel: &quot;Speed&quot;<br><br>Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Sprachen: English, Deutsch.<br><br>Untertitel: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Bildformat: 16:9 Wide-Screen.<br><br>Dauer: (approx) 96 minuten.<br><br>Außerdem: Interaktive Menus, Kapitelauswahl, Untertitel.<br><br>Er ist ein Cop aus der Anti-Terror-Einheit von Los Angeles. Und so ist der Alarm für Jack Traven nichts Ungewöhnliches: Ein Terrorist will drei Millionen Dollar erpressen, oder die zufälligen Geiseln in einem Aufzug fallen 35 Stockwerke in die Tiefe. Doch Jack schafft das Unmögliche - die Geiseln werden gerettet und der Terrorist stirbt an seiner eigenen Bombe. Scheinbar. Denn schon wenig später steht Jack (Keanu Reeves) dem Bombenexperten Payne erneut gegenüber. Diesmal hat sich der Erpresser eine ganz perfide Mordwaffe ausgedacht: Er plaziert eine Bombe in einem öffentlichen Bus. Der Mechanismus der Sprengladung schaltet sich automatisch ein, sobald der Bus schneller als 50 Meilen in der Stunde fährt und detoniert sofort, sobald die Geschwindigkeit sinkt. Plötzlich wird für eine Handvoll ahnungsloser Durchschnittsbürger der Weg zur Arbeit zum Höllentrip - und nur Jack hat ihr Leben in der Hand. Als der Busfahrer verletzt wird, übernimmt Fahrgast Annie (Sandra Bullock) das Steuer. Doch wohin mit einem Bus, der nicht bremsen kann in der Stadt der Staus? Doch es kommt noch schlimmer: Payne (Dennis Hopper) will jetzt nicht nur seine drei Millionen Dollar. Er will Jack. Um jeden Preis.',E'',0);
INSERT INTO products_description VALUES (18,2,'Speed 2: Cruise Control',E'Originaltitel: &quot;Speed 2 - Cruise Control&quot;<br><br>Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Sprachen: English, Deutsch.<br><br>Untertitel: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Bildformat: 16:9 Wide-Screen.<br><br>Dauer: (approx) 96 minuten.<br><br>Außerdem: Interaktive Menus, Kapitelauswahl, Untertitel.<br><br>Halten Sie ihre Schwimmwesten bereit, denn die actiongeladene Fortsetzung von Speed begibt sich auf Hochseekurs. Erleben Sie Sandra Bullock erneut in ihrer Star-Rolle als Annie Porter. Die Karibik-Kreuzfahrt mit ihrem Freund Alex entwickelt sich unaufhaltsam zur rasenden Todesfahrt, als ein wahnsinniger Computer-Spezialist den Luxusliner in seine Gewalt bringt und auf einen mörderischen Zerstörungskurs programmiert. Eine hochexplosive Reise, bei der kein geringerer als Action-Spezialist Jan De Bont das Ruder in die Hand nimmt. Speed 2: Cruise Controll läßt ihre Adrenalin-Wellen in rasender Geschwindigkeit ganz nach oben schnellen.',E'',0);
INSERT INTO products_description VALUES (19,2,'Verrückt nach Mary',E'Originaltitel: &quot;There''s Something About Mary&quot;<br><br>Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Sprachen: English, Deutsch.<br><br>Untertitel: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Bildformat: 16:9 Wide-Screen.<br><br>Dauer: (approx) 96 minuten.<br><br>Außerdem: Interaktive Menus, Kapitelauswahl, Untertitel.<br><br>13 Jahre nachdem Teds Rendezvous mit seiner angebeteten Mary in einem peinlichen Fiasko endete, träumt er immer noch von ihr und engagiert den windigen Privatdetektiv Healy um sie aufzuspüren. Der findet Mary in Florida und verliebt sich auf den ersten Blick in die atemberaubende Traumfrau. Um Ted als Nebenbuhler auszuschalten, tischt er ihm dicke Lügen über Mary auf. Ted läßt sich jedoch nicht abschrecken, eilt nach Miami und versucht nun alles, um Healy die Balztour zu vermasseln. Doch nicht nur Healy ist verrückt nach Mary und Ted bekommt es mit einer ganzen Legion liebeskranker Konkurrenten zu tun ...',E'',0);
INSERT INTO products_description VALUES (20,2,'Menschenkind',E'Originaltitel: &quot;Beloved&quot;<br><br>Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Sprachen: English, Deutsch.<br><br>Untertitel: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Bildformat: 16:9 Wide-Screen.<br><br>Dauer: (approx) 96 minuten.<br><br>Außerdem: Interaktive Menus, Kapitelauswahl, Untertitel.<br><br>Dieser vielschichtige Film ist eine Arbeit, die Regisseur Jonathan Demme und dem amerikanischen Talkshow-Star Oprah Winfrey sehr am Herzen lag. Der Film deckt im Verlauf seiner dreistündigen Spielzeit viele Bereiche ab. Menschenkind ist teils Sklavenepos, teils Mutter-Tochter-Drama und teils Geistergeschichte.<br><br>Der Film fordert vom Publikum höchste Aufmerksamkeit, angefangen bei seiner dramatischen und etwas verwirrenden Eingangssequenz, in der die Bewohner eines Hauses von einem niederträchtigen übersinnlichen Angriff heimgesucht werden. Aber Demme und seine talentierte Besetzung bereiten denen, die dabei bleiben ein unvergessliches Erlebnis. Der Film folgt den Spuren von Sethe (in ihren mittleren Jahren von Oprah Winfrey dargestellt), einer ehemaligen Sklavin, die sich scheinbar ein friedliches und produktives Leben in Ohio aufgebaut hat. Aber durch den erschreckenden und sparsamen Einsatz von Rückblenden deckt Demme, genau wie das literarische Meisterwerk von Toni Morrison, auf dem der Film basiert, langsam die Schrecken von Sethes früherem Leben auf und das schreckliche Ereignis, dass dazu führte, dass Sethes Haus von Geistern heimgesucht wird.<br><br>Während die Gräuel der Sklaverei und das blutige Ereignis in Sethes Familie unleugbar tief beeindrucken, ist die Qualität des Film auch in kleineren, genauso befriedigenden Details sichtbar. Die geistlich beeinflusste Musik von Rachel Portman ist gleichzeitig befreiend und bedrückend, und der Einblick in die afro-amerikanische Gemeinschaft nach der Sklaverei -- am Beispiel eines Familienausflugs zu einem Jahrmarkt, oder dem gospelsingenden Nähkränzchen -- machen diesen Film zu einem speziellen Vergnügen sowohl für den Geist als auch für das Herz. Die Schauspieler, besonders Kimberley Elise als Sethes kämpfende Tochter und Thandie Newton als der mysteriöse Titelcharakter, sind sehr rührend. Achten Sie auch auf Danny Glover (Lethal Weapon) als Paul D.',E'',0);
INSERT INTO products_description VALUES (21,2,'SWAT 3: Elite Edition',E'<b>KEINE KOMPROMISSE!</b><br><i>Kämpfen Sie Seite an Seite mit Ihren LAPD SWAT-Kameraden gegen das organisierte Verbrechen!</i><br><br>Eine der realistischsten 3D-Taktiksimulationen der letzten Zeit jetzt mit Multiplayer-Modus, 5 neuen Missionen und jede Menge nützliche Tools!<br><br>Los Angeles, 2005. In wenigen Tagen steht die Unterzeichnung des Abkommens der Vereinten Nationen zur Atom-Ächtung durch Vertreter aller Nationen der Welt an. Radikale terroristische Vereinigungen machen sich in der ganzen Stadt breit. Verantwortlich für die Sicherheit der Delegierten zeichnet sich eine Eliteeinheit der LAPD: das SWAT-Team. Das Schicksal der Stadt liegt in Ihren Händen.<br><br><b>Neue Features:</b><br><ul><br><li>Multiplayer-Modus (Co op-Modus, Deathmatch in den bekannten Variationen)</li><br><li>5 neue Missionen an original Örtlichkeiten Las (U-Bahn, Whitman Airport, etc.)</li><br><li>neue Charakter</li><br><li>neue Skins</li><br><li>neue Waffen</li><br><li>neue Sounds</li><br><li>verbesserte KI</li><br><li>Tools-Package</li><br><li>Scenario-Editor</li><br><li>Level-Editor</li><br></ul><br>Die dritte Folge der Bestseller-Reihe im Bereich der 3D-Echtzeit-Simulationen präsentiert sich mit einer neuen Spielengine mit extrem ausgeprägtem Realismusgrad. Der Spieler übernimmt das Kommando über eine der besten Polizei-Spezialeinheiten oder einer der übelsten Terroristen-Gangs der Welt. Er durchläuft - als \"Guter\" oder \"Böser\" - eine der härtesten und elitärsten Kampfausbildungen, in der er lernt, mit jeder Art von Krisensituationen umzugehen. Bei diesem Action-Abenteuer geht es um das Leben prominenter Vertreter der Vereinten Nationen und bei 16 Missionen an Originalschauplätzen in LA gibt die \"lebensechte\" KI den Protagonisten jeder Seite so einige harte Nüsse zu knacken.',E'www.swat3.com',0);
INSERT INTO products_description VALUES (22,2,'Unreal Tournament',E'2341: Die Gewalt ist eine Lebensweise, die sich ihren Weg durch die dunklen Risse der Gesellschaft bahnt. Sie bedroht die Macht und den Einfluss der regierenden Firmen, die schnellstens ein Mittel finden müssen, die tobenden Massen zu besänftigen - ein profitables Mittel ... Gladiatorenkämpfe sind die Lösung. Sie sollen den Durst der Menschen nach Blut stillen und sind die perfekte Gelegenheit, die Aufständischen, Kriminellen und Aliens zu beseitigen, die die Firmenelite bedrohen.<br><br>Das Turnier war geboren - ein Kampf auf Leben und Tod. Galaxisweit live und in Farbe! Kämpfen Sie für Freiheit, Ruhm und Ehre. Sie müssen stark, schnell und geschickt sein ... oder Sie bleiben auf der Strecke.<br><br>Kämpfen Sie allein oder kommandieren Sie ein Team gegen Armeen unbarmherziger Krieger, die alle nur ein Ziel vor Augen haben: Die Arenen lebend zu verlassen und sich dem Grand Champion zu stellen ... um ihn dann zu bezwingen!<br><br><b>Features:</b><br><ul><br><li>Auf dem PC mehrfach als Spiel des Jahres ausgezeichnet!</li><br><li>Mehr als 50 faszinierende Level - verlassene Raumstationen, gotische Kathedralen und graffitibedeckte Großstädte.</li><br><li>Vier actionreiche Spielmodi - Deathmatch, Capture the Flag, Assault und Domination werden Ihren Adrenalinpegel in die Höhe schnellen lassen.</li><br><li>Dramatische Mehrspieler-Kämpfe mit 2, 3 und 4 Spielern, auch über das Netzwerk</li><br><li>Gnadenlos aggressive Computergegner verlangen Ihnen das Äußerste ab.</li><br><li>Neuartiges Benutzerinterface und verbesserte Steuerung - auch mit USB-Maus und -Tastatur spielbar.</li><br></ul><br>Der Nachfolger des Actionhits \"Unreal\" verspricht ein leichtes, intuitives Interface, um auch Einsteigern schnellen Zugang zu den Duellen gegen die Bots zu ermöglichen. Mit diesen KI-Kriegern kann man auch Teams bilden und im umfangreichen Multiplayermodus ohne Onlinekosten in den Kampf ziehen. 35 komplett neue Arenen und das erweiterte Waffenangebot bilden dazu den würdigen Rahmen.',E'www.unrealtournament.net',0);
INSERT INTO products_description VALUES (23,2,'The Wheel Of Time',E'<b><i>\"Wheel Of Time\"(Das Rad der Zeit)</i></b> basiert auf den Fantasy-Romanen von Kultautor Robert Jordan und stellt einen einzigartigen Mix aus Strategie-, Action- und Rollenspielelementen dar. Obwohl die Welt von \"Wheel of Time\" eng an die literarische Vorlage der Romane angelehnt ist, erzählt das Spiel keine lineare Geschichte. Die Story entwickelt sich abhängig von den Aktionen der Spieler, die jeweils die Rollen der Hauptcharaktere aus dem Roman übernehmen. Jede Figur hat den Oberbefehl über eine große Gefolgschaft, militärische Einheiten und Ländereien. Die Spieler können ihre eigenen Festungen konstruieren, individuell ausbauen, von dort aus das umliegende Land erforschen, magische Gegenstände sammeln oder die gegnerischen Zitadellen erstürmen. Selbstverständlich kann man sich auch über LAN oder Internet gegenseitig Truppen auf den Hals hetzen und die Festungen seiner Mitspieler in Schutt und Asche legen. Dreh- und Anlegepunkt von \"Wheel of Time\" ist der Kampf um die finstere Macht \"The Dark One\", die vor langer Zeit die Menschheit beinahe ins Verderben stürzte und nur mit Hilfe gewaltiger magischer Energie verbannt werden konnte. \"The Amyrlin Seat\" und \"The Children of the Night\" kämpfen nur gegen \"The Forsaken\" und \"The Hound\" um den Besitz des Schlüssels zu \"Shayol Ghul\" - dem magischen Siegel, mit dessen Hilfe \"The Dark One\" seinerzeit gebannt werden konnte.<br><br><b>Features:</b> <br><ul><br><li>Ego-Shooter mit Strategie-Elementen</li><br><li>Spielumgebung in Echtzeit-3D</li><br><li>Konstruktion aud Ausbau der eigenen Festung</li><br><li>Einsatz von über 100 Artefakten und Zaubersprüchen</li><br><li>Single- und Multiplayermodus</li><br></ul><br>Im Mittelpunkt steht der Kampf gegen eine finstere Macht namens The Dark One. Deren Schergen müssen mit dem Einsatz von über 100 Artefakten und Zaubereien wie Blitzschlag oder Teleportation aus dem Weg geräumt werden. Die opulente 3D-Grafik verbindet Strategie- und Rollenspielelemente. <br><br><b>Voraussetzungen</b><br>mind. P200, 32MB RAM, 4x CD-Rom, Win95/98, DirectX 5.0 komp.Grafikkarte und Soundkarte. ',E'www.wheeloftime.com',0);
INSERT INTO products_description VALUES (24,2,'Disciples: Sacred Land',E'Rundenbasierende Fantasy/RTS-Strategie mit gutem Design (vor allem die Levels, 4 versch. Rassen, tolle Einheiten), fantastischer Atmosphäre und exzellentem Soundtrack. Grafisch leider auf das Niveau von 1990.',E'www.strategyfirst.com/disciples/welcome.html',0);
INSERT INTO products_description VALUES (25,2,'Microsoft Internet Tastatur PS/2',E'<i>Microsoft Internet Keyboard,Windows-Tastatur mit 10 zusätzl. Tasten,2 selbst programmierbar, abnehmbareHandgelenkauflage. Treiber im Lieferumfang.</i><br><br>Ein-Klick-Zugriff auf das Internet und vieles mehr! Das Internet Keyboard verfügt über 10 zusätzliche Abkürzungstasten auf einer benutzerfreundlichen Standardtastatur, die darüber hinaus eine abnehmbare Handballenauflage aufweist. Über die Abkürzungstasten können Sie durch das Internet surfen oder direkt von der Tastatur aus auf E-Mails zugreifen. Die IntelliType Pro-Software ermöglicht außerdem das individuelle Belegen der Tasten.',E'',0);
INSERT INTO products_description VALUES (26,2,'Microsof IntelliMouse Explorer',E'Die IntelliMouse Explorer überzeugt durch ihr modernes Design mit silberfarbenem Gehäuse, sowie rot schimmernder Unter- und Rückseite. Die neuartige IntelliEye-Technologie sorgt für eine noch nie dagewesene Präzision, da statt der beweglichen Teile (zum Abtasten der Bewegungsänderungen an der Unterseite der Maus) ein optischer Sensor die Bewegungen der Maus erfaßt. Das Herzstück der Microsoft IntelliEye-Technologie ist ein kleiner Chip, der einen optischen Sensor und einen digitalen Signalprozessor (DSP) enthält.<br><br>Da auf bewegliche Teile, die Staub, Schmutz und Fett aufnehmen können, verzichtet wurde, muß die IntelliMouse Explorer nicht mehr gereinigt werden. Darüber hinaus arbeitet die IntelliMouse Explorer auf nahezu jeder Arbeitsoberfläche, so daß kein Mauspad mehr erforderlich ist. Mit dem Rad und zwei neuen zusätzlichen Maustasten ermöglicht sie effizientes und komfortables Arbeiten am PC.<br><br><b>Eigenschaften:</b><br><ul><br><li><b>ANSCHLUSS:</b> USB (PS/2-Adapter enthalten)</li><br><li><b>FARBE:</b> metallic-grau</li><br><li><b>TECHNIK:</b> Optisch (Akt.: ca. 1500 Bilder/s)</li><br><li><b>TASTEN:</b> 5 (incl. Scrollrad)</li><br><li><b>SCROLLRAD:</b> Ja</li><br></ul><br><i><b>BEMERKUNG:</b><br>Keine Reinigung bewegter Teile mehr notwendig, da statt der Mauskugel ein Fotoempfänger benutzt wird.</i>',E'',0);
INSERT INTO products_description VALUES (27,2,'Hewlett-Packard LaserJet 1100Xi',E'<b>HP LaserJet für mehr Produktivität und Flexibilität am Arbeitsplatz</b><br><br>Der HP LaserJet 1100Xi Drucker verbindet exzellente Laserdruckqualität mit hoher Geschwindigkeit für mehr Effizienz.<br><br><b>Zielkunden</b><br><ul><li>Einzelanwender, die Wert auf professionelle Ausdrucke in Laserqualität legen und schnelle Ergebnisse auch bei komplexen Dokumenten erwarten.</li><br><li>Der HP LaserJet 1100 sorgt mit gestochen scharfen Texten und Grafiken für ein professionelles Erscheinungsbild Ihrer Arbeit und Ihres Unternehmens. Selbst bei komplexen Dokumenten liefert er schnelle Ergebnisse. Andere Medien - wie z.B. Transparentfolien und Briefumschläge, etc. - lassen sich problemlos bedrucken. Somit ist der HP LaserJet 1100 ein Multifunktionstalent im Büroalltag.</li><br></ul><br><b>Eigenschaften</b><br><ul><br><li><b>Druckqualität</b> Schwarzweiß: 600 x 600 dpi</li><br><li><b>Monatliche Druckleistung</b> Bis zu 7000 Seiten</li><br><li><b>Speicher</b> 2 MB Standardspeicher, erweiterbar auf 18 MB</li><br><li><b>Schnittstelle/gemeinsame Nutzung</b> Parallel, IEEE 1284-kompatibel</li><br><li><b>Softwarekompatibilität</b> DOS/Win 3.1x/9x/NT 4.0</li><br><li><b>Papierzuführung</b> 125-Blatt-Papierzuführung</li><br><li><b>Druckmedien</b> Normalpapier, Briefumschläge, Transparentfolien, kartoniertes Papier, Postkarten und Etiketten</li><br><li><b>Netzwerkfähig</b> Über HP JetDirect PrintServer</li><br><li><b>Lieferumfang</b> HP LaserJet 1100Xi Drucker (Lieferumfang: Drucker, Tonerkassette, 2 m Parallelkabel, Netzkabel, Kurzbedienungsanleitung, Benutzerhandbuch, CD-ROM, 3,5\"-Disketten mit Windows® 3.1x, 9x, NT 4.0 Treibern und DOS-Dienstprogrammen)</li><br><li><b>Gewährleistung</b> Ein Jahr</li><br></ul><br>',E'www.hp.com',0);
INSERT INTO products_description VALUES (1,3,'Matrox G200 MMS',E'Reinforcing its position as a multi-monitor trailblazer, Matrox Graphics Inc. has once again developed the most flexible and highly advanced solution in the industry. Introducing the new Matrox G200 Multi-Monitor Series; the first graphics card ever to support up to four DVI digital flat panel displays on a single 8&quot; PCI board.<br><br>With continuing demand for digital flat panels in the financial workplace, the Matrox G200 MMS is the ultimate in flexible solutions. The Matrox G200 MMS also supports the new digital video interface (DVI) created by the Digital Display Working Group (DDWG) designed to ease the adoption of digital flat panels. Other configurations include composite video capture ability and onboard TV tuner, making the Matrox G200 MMS the complete solution for business needs.<br><br>Based on the award-winning MGA-G200 graphics chip, the Matrox G200 Multi-Monitor Series provides superior 2D/3D graphics acceleration to meet the demanding needs of business applications such as real-time stock quotes (Versus), live video feeds (Reuters & Bloombergs), multiple windows applications, word processing, spreadsheets and CAD.',E'www.matrox.com/mga/products/g200_mms/home.cfm',0);
INSERT INTO products_description VALUES (2,3,'Matrox G400 32MB',E'<b>Dramatically Different High Performance Graphics</b><br><br>Introducing the Millennium G400 Series - a dramatically different, high performance graphics experience. Armed with the industry''s fastest graphics chip, the Millennium G400 Series takes explosive acceleration two steps further by adding unprecedented image quality, along with the most versatile display options for all your 3D, 2D and DVD applications. As the most powerful and innovative tools in your PC''s arsenal, the Millennium G400 Series will not only change the way you see graphics, but will revolutionize the way you use your computer.<br><br><b>Key features:</b><ul><li>New Matrox G400 256-bit DualBus graphics chip</li><li>Explosive 3D, 2D and DVD performance</li><li>DualHead Display</li><li>Superior DVD and TV output</li><li>3D Environment-Mapped Bump Mapping</li><li>Vibrant Color Quality rendering </li><li>UltraSharp DAC of up to 360 MHz</li><li>3D Rendering Array Processor</li><li>Support for 16 or 32 MB of memory</li></ul>',E'www.matrox.com/mga/products/mill_g400/home.htm',0);
INSERT INTO products_description VALUES (3,3,'Microsoft IntelliMouse Pro',E'Every element of IntelliMouse Pro - from its unique arched shape to the texture of the rubber grip around its base - is the product of extensive customer and ergonomic research. Microsoft''s popular wheel control, which now allows zooming and universal scrolling functions, gives IntelliMouse Pro outstanding comfort and efficiency.',E'www.microsoft.com/hardware/mouse/intellimouse.asp',0);
INSERT INTO products_description VALUES (4,3,'The Replacement Killers',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br>Languages: English, Deutsch.<br>Subtitles: English, Deutsch, Spanish.<br>Audio: Dolby Surround 5.1.<br>Picture Format: 16:9 Wide-Screen.<br>Length: (approx) 80 minutes.<br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'www.replacement-killers.com',0);
INSERT INTO products_description VALUES (5,3,'Blade Runner - Director''s Cut',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br>Languages: English, Deutsch.<br>Subtitles: English, Deutsch, Spanish.<br>Audio: Dolby Surround 5.1.<br>Picture Format: 16:9 Wide-Screen.<br>Length: (approx) 112 minutes.<br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'www.bladerunner.com',0);
INSERT INTO products_description VALUES (6,3,'The Matrix',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch.<br><br>Audio: Dolby Surround.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 131 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Making Of.',E'www.thematrix.com',0);
INSERT INTO products_description VALUES (7,3,'You''ve Got Mail',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch, Spanish.<br><br>Subtitles: English, Deutsch, Spanish, French, Nordic, Polish.<br><br>Audio: Dolby Digital 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 115 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'www.youvegotmail.com',0);
INSERT INTO products_description VALUES (8,3,'A Bug''s Life',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Digital 5.1 / Dobly Surround Stereo.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 91 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'www.abugslife.com',0);
INSERT INTO products_description VALUES (9,3,'Under Siege',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 98 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description VALUES (10,3,'Under Siege 2 - Dark Territory',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 98 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description VALUES (11,3,'Fire Down Below',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 100 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description VALUES (12,3,'Die Hard With A Vengeance',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 122 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description VALUES (13,3,'Lethal Weapon',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 100 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description VALUES (14,3,'Red Corner',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 117 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description VALUES (15,3,'Frantic',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 115 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description VALUES (16,3,'Courage Under Fire',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 112 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description VALUES (17,3,'Speed',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 112 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description VALUES (18,3,'Speed 2: Cruise Control',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 120 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description VALUES (19,3,'There''s Something About Mary',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 114 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description VALUES (20,3,'Beloved',E'Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 164 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description VALUES (21,3,'SWAT 3: Close Quarters Battle',E'<b>Windows 95/98</b><br><br>211 in progress with shots fired. Officer down. Armed suspects with hostages. Respond Code 3! Los Angles, 2005, In the next seven days, representatives from every nation around the world will converge on Las Angles to witness the signing of the United Nations Nuclear Abolishment Treaty. The protection of these dignitaries falls on the shoulders of one organization, LAPD SWAT. As part of this elite tactical organization, you and your team have the weapons and all the training necessary to protect, to serve, and \"When needed\" to use deadly force to keep the peace. It takes more than weapons to make it through each mission. Your arsenal includes C2 charges, flashbangs, tactical grenades. opti-Wand mini-video cameras, and other devices critical to meeting your objectives and keeping your men free of injury. Uncompromised Duty, Honor and Valor!',E'www.swat3.com',0);
INSERT INTO products_description VALUES (22,3,'Unreal Tournament',E'From the creators of the best-selling Unreal, comes Unreal Tournament. A new kind of single player experience. A ruthless multiplayer revolution.<br><br>This stand-alone game showcases completely new team-based gameplay, groundbreaking multi-faceted single player action or dynamic multi-player mayhem. It''s a fight to the finish for the title of Unreal Grand Master in the gladiatorial arena. A single player experience like no other! Guide your team of ''bots'' (virtual teamates) against the hardest criminals in the galaxy for the ultimate title - the Unreal Grand Master.',E'www.unrealtournament.net',0);
INSERT INTO products_description VALUES (23,3,'The Wheel Of Time',E'The world in which The Wheel of Time takes place is lifted directly out of Jordan''s pages; it''s huge and consists of many different environments. How you navigate the world will depend largely on which game - single player or multipayer - you''re playing. The single player experience, with a few exceptions, will see Elayna traversing the world mainly by foot (with a couple notable exceptions). In the multiplayer experience, your character will have more access to travel via Ter''angreal, Portal Stones, and the Ways. However you move around, though, you''ll quickly discover that means of locomotion can easily become the least of the your worries...<br><br>During your travels, you quickly discover that four locations are crucial to your success in the game. Not surprisingly, these locations are the homes of The Wheel of Time''s main characters. Some of these places are ripped directly from the pages of Jordan''s books, made flesh with Legend''s unparalleled pixel-pushing ways. Other places are specific to the game, conceived and executed with the intent of expanding this game world even further. Either way, they provide a backdrop for some of the most intense first person action and strategy you''ll have this year.',E'www.wheeloftime.com',0);
INSERT INTO products_description VALUES (24,3,'Disciples: Sacred Lands',E'A new age is dawning...<br><br>Enter the realm of the Sacred Lands, where the dawn of a New Age has set in motion the most momentous of wars. As the prophecies long foretold, four races now clash with swords and sorcery in a desperate bid to control the destiny of their gods. Take on the quest as a champion of the Empire, the Mountain Clans, the Legions of the Damned, or the Undead Hordes and test your faith in battles of brute force, spellbinding magic and acts of guile. Slay demons, vanquish giants and combat merciless forces of the dead and undead. But to ensure the salvation of your god, the hero within must evolve.<br><br>The day of reckoning has come... and only the chosen will survive.',E'',0);
INSERT INTO products_description VALUES (25,3,'Microsoft Internet Keyboard PS/2',E'The Internet Keyboard has 10 Hot Keys on a comfortable standard keyboard design that also includes a detachable palm rest. The Hot Keys allow you to browse the web, or check e-mail directly from your keyboard. The IntelliType Pro software also allows you to customize your hot keys - make the Internet Keyboard work the way you want it to!',E'',0);
...
INSERT INTO prod_opt_vals_to_prod_opt VALUES (DEFAULT,4,1);
INSERT INTO prod_opt_vals_to_prod_opt VALUES (DEFAULT,4,2);
INSERT INTO prod_opt_vals_to_prod_opt VALUES (DEFAULT,4,3);
INSERT INTO prod_opt_vals_to_prod_opt VALUES (DEFAULT,4,4);
INSERT INTO prod_opt_vals_to_prod_opt VALUES (DEFAULT,3,5);
INSERT INTO prod_opt_vals_to_prod_opt VALUES (DEFAULT,3,6);
INSERT INTO prod_opt_vals_to_prod_opt VALUES (DEFAULT,3,7);
INSERT INTO prod_opt_vals_to_prod_opt VALUES (DEFAULT,3,8);
INSERT INTO prod_opt_vals_to_prod_opt VALUES (DEFAULT,3,9);
...
INSERT INTO reviews VALUES ( DEFAULT,19,1,'John doe',5, now(),now(),0);

INSERT INTO reviews_description VALUES (1,1, 'this has to be one of the funniest movies released for 1999!');

INSERT INTO specials VALUES ( DEFAULT,3, 39.99, now(), now(), '2020-01-01', now(), 1);
INSERT INTO specials VALUES ( DEFAULT,5, 30.00, now(), now(), '2020-01-01', now(), 1);
INSERT INTO specials VALUES ( DEFAULT,6, 30.00, now(), now(), '2020-01-01', now(), 1);
INSERT INTO specials VALUES ( DEFAULT,16, 29.99, now(), now(), '2020-01-01', now(), 1);
...
INSERT INTO geo_zones VALUES (DEFAULT,'Florida','Florida local sales tax zone',now(),now());
INSERT INTO zones_to_geo_zones VALUES (DEFAULT,223,18,1,now(),now());
...
ALTER TABLE products ALTER COLUMN products_model TYPE VARCHAR(64);
...
INSERT INTO address_book (address_book_id, customers_id, entry_gender, entry_company, entry_firstname, entry_lastname, entry_street_address, entry_suburb, entry_postcode, entry_city, entry_state, entry_country_id, entry_zone_id) VALUES (DEFAULT,-1, 'm', 'ACME Inc.', 'Andy', 'Admin', '1 Way Street', '', 'PostCode1', 'NeverNever', '', 223, 12);
...
INSERT INTO address_book (address_book_id, customers_id, entry_gender, entry_company, entry_firstname, entry_lastname, entry_street_address, entry_suburb, entry_postcode, entry_city, entry_state, entry_country_id, entry_zone_id) VALUES (DEFAULT,-1, 'm', 'ACME Inc.', 'Caty', 'Catalog', '2 Way Street', '', 'PostCode2', 'NeverNever', '', 223, 12);
...
INSERT INTO address_book (address_book_id, customers_id, entry_gender, entry_company, entry_firstname, entry_lastname, entry_street_address, entry_suburb, entry_postcode, entry_city, entry_state, entry_country_id, entry_zone_id) VALUES (DEFAULT,-1, 'm', 'ACME Inc.', 'Olly', 'Order', '3 Way Street', '', 'PostCode3', 'NeverNever', '', 223, 12);
...
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_addressFormats','Address Formats', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_audit','Audit', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_auditConfig','AuditConfig', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_cache','Cache', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_categories','Categories', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_configFiles','Configuration Files', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_digitalDownloadConfig','Digital Downloads', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_countries','Countries', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_coupons','Coupons', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_couponsFromProm','Coupons For Promotions', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_currencies','Currencies', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_customerDetails','Customer Details', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_customerOrders','Customer Orders', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_customers','Customers', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_deleteSessions','Delete Expired Sessions', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_editCustomer','Edit Customer', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_editOrderPanel','Edit Order', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_editProduct','Edit Product', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_emailOptions','Email Options', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_geoZones','Geo-Zones', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_httpHttps','HTTP / HTTPS', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_images','Images', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_insertCustomer','Insert Customer', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_ipnhistory','Payment Gateway Callbacks', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_ipnhistoryFromOrders','Payment Status For Order', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_languages','Languages', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_logging','Logging', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_roleToPanels','Maintain Roles', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_manufacturers','Manufacturers', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_maximumValues','Maximum Values', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_minimumValues','Minimum Values', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_userToRoles','Map Users to Roles', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_orders','Orders', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_orderStatuses','Order Statuses', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_orderTotalModules','Order Total', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_paymentModules','Payment', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_prodsFromCat','Products for Categories', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_prodsFromManu','Products for Manufacturer', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_productOptions','Product Options', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_products','Products', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_promotions','Promotions', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_promRules','Promotion Rules', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_refreshCache','Refresh Config Cache', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_reports','Reports', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_reportsConfig','Reports Configuration', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_returns','Product Returns', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_returnsFromOrders','Product Returns For Order', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_rss','Latest News', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_shippingModules','Shipping', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_shippingPacking','Shipping / Packing', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_status','Status', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_stockAndOrders','Stock and Orders', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_storeConfiguration','My Store', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_subZones','Sub-Zones', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_taxAreaMapping','Tax Area Mapping', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_taxAreas','Tax Areas', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_taxAreaToZoneMapping','Tax Area to Zone Mapping', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_taxClasses','Tax Classes', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_taxRates','Tax Rates', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_zones','Zones', now());
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_changePassword','Change Password', now());

-- Roles
DELETE FROM kk_role;
INSERT INTO kk_role (role_id, name, description, date_added) VALUES (DEFAULT,  'Super User','Permission to do everything to all stores', now());
INSERT INTO kk_role (role_id, name, description, date_added) VALUES (DEFAULT,  'Catalog Maintenance','Permission to maintain the catalog of products', now());
INSERT INTO kk_role (role_id, name, description, date_added) VALUES (DEFAULT,  'Order Maintenance','Permission to maintain the orders', now());
INSERT INTO kk_role (role_id, name, description, date_added) VALUES (DEFAULT,  'Customer Maintenance','Permission to maintain the customers', now());
INSERT INTO kk_role (role_id, name, description, date_added) VALUES (DEFAULT,  'Store Administrator','Permission to maintain a single store', now());
...
INSERT INTO configuration_group VALUES (DEFAULT, 'Logging', 'Logging configuration options', '20', '1');
...
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT, 'insertDigitalDownload','', now());
...
ALTER TABLE orders ALTER COLUMN customers_country TYPE VARCHAR(64);
ALTER TABLE orders ALTER COLUMN billing_country TYPE VARCHAR(64);
ALTER TABLE orders ALTER COLUMN delivery_country TYPE VARCHAR(64);

-- Extend the size of the products_model column to match products table
ALTER TABLE orders_products ALTER COLUMN products_model TYPE VARCHAR(64);
...
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_custGroups','Customer Groups', now());
...
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_adminAppConfig','Configure Admin App', now());
...
INSERT INTO products (products_id, products_quantity, products_model, products_image, products_price, products_date_added, products_last_modified, products_date_available, products_weight, products_status, products_tax_class_id, manufacturers_id, products_ordered, products_type) VALUES (DEFAULT,0,'MSMOUSEKBBUNDLE','microsoft/bundle.gif',121.45, now(),null,now(),16.00,1,1,2,0,4);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (DEFAULT,1,'Bundle Saver',E'Buy the Microsoft IntelliMouse Explorer and the Internet Keyboard together\, to save  10% on the individual prices and to receive free shipping !',E'www.microsoft.com/hardware/',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (28,2,'Bundle Saver',E'Buy the Microsoft IntelliMouse Explorer and the Internet Keyboard together\, to save  10% on the individual prices and to receive free shipping !',E'www.microsoft.com/hardware/',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (28,3,'Bundle Saver',E'Buy the Microsoft IntelliMouse Explorer and the Internet Keyboard together\, to save  10% on the individual prices and to receive free shipping !',E'',0);
INSERT INTO products_to_categories VALUES (28,9);
INSERT INTO products_to_categories VALUES (28,8);
INSERT INTO products_to_products (products_to_products_id, id_from, id_to, relation_type, products_options, products_quantity) VALUES (DEFAULT,28,26,5,'3{8}',1);
INSERT INTO products_to_products (products_to_products_id, id_from, id_to, relation_type, products_options, products_quantity) VALUES (DEFAULT,28,25,5,'',1);
...
-- New API calls
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT, 'updateCachedConfigurations','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT, 'getKonakartPropertyValue','', now());
...
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_dataFeeds','Configure Data Feeds', now());
...
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_publishProducts','Publish Products', now());
...
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT, 'publishProducts','', now());
...
-- New Solr API calls
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT, 'addAllProductsToSearchEngine','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT, 'addProductToSearchEngine','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT, 'removeAllProductsFromSearchEngine','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT, 'removeProductFromSearchEngine','', now());
...
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_solr_search','Solr Search Engine Configuration', now());
...
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_solr_control','Solr Search Engine Control', now());
...
ALTER TABLE customers_basket_attrs ADD COLUMN store_id varchar(64);
CREATE INDEX idxcustomers_basket_attrs_store_id ON customers_basket_attrs (store_id);
...
ALTER TABLE products_attrs_download ADD COLUMN store_id varchar(64);
CREATE INDEX idxproducts_attrs_download_store_id ON products_attrs_download (store_id);
...
ALTER TABLE prod_opt_vals_to_prod_opt ADD COLUMN store_id varchar(64);
CREATE INDEX idxprod_opt_vals_to_prod_opt_store_id ON prod_opt_vals_to_prod_opt (store_id);
...
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_stores','Manage Multiple Stores', now());
...
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getWishLists','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'insertWishList','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'deleteWishList','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'insertWishListItem','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'deleteWishListItem','', now());

-- Tables for CustomerTags
DROP TABLE IF EXISTS kk_customer_tag;
CREATE TABLE kk_customer_tag (
   kk_customer_tag_id SERIAL,
   store_id VARCHAR(64),
   name VARCHAR(64) NOT NULL,
...
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'insertCustomerTag','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getCustomerTag','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'deleteCustomerTag','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'updateCustomerTag','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getCustomerTags','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'deleteCustomerTagForCustomer','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getCustomerTagForCustomer','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getCustomerTagForName','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getCustomerTagsForCustomer','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'insertCustomerTagForCustomer','', now());

-- Admin Engine Address API calls
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getAddressById','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getAddresses','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'insertAddress','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'updateAddress','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'deleteAddress','', now());

-- Add a new panel for managing customer tags
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_custTags','Customer Tags', now());
...
CREATE TABLE kk_expression_variable (
   kk_expression_variable_id SERIAL,
   kk_customer_tag_id INTEGER DEFAULT '0' NOT NULL,
...
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'insertExpression','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'updateExpression','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'deleteExpression','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getExpression','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getExpressions','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getExpressionVariable','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getExpressionVariablesForExpression','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getExpressionForName','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'insertExpressionVariables','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'updateExpressionVariable','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'deleteExpressionVariable','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'deleteExpressionVariablesForExpression','', now());

-- Add new panels for managing expressions
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_expressions','Expressions', now());
...
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_variablesFromExp','Expression Variables', now());
...
-----------------------------------------------------------------------------------------------------------------------------
-- Add Portuguese
INSERT INTO languages VALUES (DEFAULT,'Português','pt','icon.gif','portuguese',4, null);
...
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (1,4,'Matrox G200 MMS',E'(pt) Reinforcing its position as a multi-monitor trailblazer, Matrox Graphics Inc. has once again developed the most flexible and highly advanced solution in the industry. Introducing the new Matrox G200 Multi-Monitor Series; the first graphics card ever to support up to four DVI digital flat panel displays on a single 8&quot; PCI board.<br><br>With continuing demand for digital flat panels in the financial workplace, the Matrox G200 MMS is the ultimate in flexible solutions. The Matrox G200 MMS also supports the new digital video interface (DVI) created by the Digital Display Working Group (DDWG) designed to ease the adoption of digital flat panels. Other configurations include composite video capture ability and onboard TV tuner, making the Matrox G200 MMS the complete solution for business needs.<br><br>Based on the award-winning MGA-G200 graphics chip, the Matrox G200 Multi-Monitor Series provides superior 2D/3D graphics acceleration to meet the demanding needs of business applications such as real-time stock quotes (Versus), live video feeds (Reuters & Bloombergs), multiple windows applications, word processing, spreadsheets and CAD.',E'www.matrox.com/mga/products/g200_mms/home.cfm',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (2,4,'Matrox G400 32MB',E'(pt) <b>Dramatically Different High Performance Graphics</b><br><br>Introducing the Millennium G400 Series - a dramatically different, high performance graphics experience. Armed with the industry''s fastest graphics chip, the Millennium G400 Series takes explosive acceleration two steps further by adding unprecedented image quality, along with the most versatile display options for all your 3D, 2D and DVD applications. As the most powerful and innovative tools in your PC''s arsenal, the Millennium G400 Series will not only change the way you see graphics, but will revolutionize the way you use your computer.<br><br><b>Key features:</b><ul><li>New Matrox G400 256-bit DualBus graphics chip</li><li>Explosive 3D, 2D and DVD performance</li><li>DualHead Display</li><li>Superior DVD and TV output</li><li>3D Environment-Mapped Bump Mapping</li><li>Vibrant Color Quality rendering </li><li>UltraSharp DAC of up to 360 MHz</li><li>3D Rendering Array Processor</li><li>Support for 16 or 32 MB of memory</li></ul>',E'www.matrox.com/mga/products/mill_g400/home.htm',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (3,4,'Microsoft IntelliMouse Pro',E'(pt) Every element of IntelliMouse Pro - from its unique arched shape to the texture of the rubber grip around its base - is the product of extensive customer and ergonomic research. Microsoft''s popular wheel control, which now allows zooming and universal scrolling functions, gives IntelliMouse Pro outstanding comfort and efficiency.',E'www.microsoft.com/hardware/mouse/intellimouse.asp',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (4,4,'The Replacement Killers',E'(pt) Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br>Languages: English, Deutsch.<br>Subtitles: English, Deutsch, Spanish.<br>Audio: Dolby Surround 5.1.<br>Picture Format: 16:9 Wide-Screen.<br>Length: (approx) 80 minutes.<br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'www.replacement-killers.com',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (5,4,'Blade Runner - Director''s Cut',E'(pt) Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br>Languages: English, Deutsch.<br>Subtitles: English, Deutsch, Spanish.<br>Audio: Dolby Surround 5.1.<br>Picture Format: 16:9 Wide-Screen.<br>Length: (approx) 112 minutes.<br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'www.bladerunner.com',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (6,4,'The Matrix',E'(pt) Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch.<br><br>Audio: Dolby Surround.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 131 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Making Of.',E'www.thematrix.com',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (7,4,'You''ve Got Mail',E'(pt) Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch, Spanish.<br><br>Subtitles: English, Deutsch, Spanish, French, Nordic, Polish.<br><br>Audio: Dolby Digital 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 115 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'www.youvegotmail.com',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (8,4,'A Bug''s Life',E'(pt) Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Digital 5.1 / Dobly Surround Stereo.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 91 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'www.abugslife.com',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (9,4,'Under Siege',E'(pt) Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 98 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (10,4,'Under Siege 2 - Dark Territory',E'(pt) Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 98 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (11,4,'Fire Down Below',E'(pt) Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 100 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (12,4,'Die Hard With A Vengeance',E'(pt) Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 122 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (13,4,'Lethal Weapon',E'(pt) Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 100 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (14,4,'Red Corner',E'(pt) Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 117 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (15,4,'Frantic',E'(pt) Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 115 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (16,4,'Courage Under Fire',E'(pt) Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 112 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (17,4,'Speed',E'(pt) Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 112 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (18,4,'Speed 2: Cruise Control',E'(pt) Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 120 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (19,4,'There''s Something About Mary',E'(pt) Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 114 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (20,4,'Beloved',E'(pt) Regional Code: 2 (Japan, Europe, Middle East, South Africa).<br><br>Languages: English, Deutsch.<br><br>Subtitles: English, Deutsch, Spanish.<br><br>Audio: Dolby Surround 5.1.<br><br>Picture Format: 16:9 Wide-Screen.<br><br>Length: (approx) 164 minutes.<br><br>Other: Interactive Menus, Chapter Selection, Subtitles (more languages).',E'',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (21,4,'SWAT 3: Close Quarters Battle',E'(pt) <b>Windows 95/98</b><br><br>211 in progress with shots fired. Officer down. Armed suspects with hostages. Respond Code 3! Los Angles, 2005, In the next seven days, representatives from every nation around the world will converge on Las Angles to witness the signing of the United Nations Nuclear Abolishment Treaty. The protection of these dignitaries falls on the shoulders of one organization, LAPD SWAT. As part of this elite tactical organization, you and your team have the weapons and all the training necessary to protect, to serve, and \"When needed\" to use deadly force to keep the peace. It takes more than weapons to make it through each mission. Your arsenal includes C2 charges, flashbangs, tactical grenades. opti-Wand mini-video cameras, and other devices critical to meeting your objectives and keeping your men free of injury. Uncompromised Duty, Honor and Valor!',E'www.swat3.com',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (22,4,'Unreal Tournament',E'(pt) From the creators of the best-selling Unreal, comes Unreal Tournament. A new kind of single player experience. A ruthless multiplayer revolution.<br><br>This stand-alone game showcases completely new team-based gameplay, groundbreaking multi-faceted single player action or dynamic multi-player mayhem. It''s a fight to the finish for the title of Unreal Grand Master in the gladiatorial arena. A single player experience like no other! Guide your team of ''bots'' (virtual teamates) against the hardest criminals in the galaxy for the ultimate title - the Unreal Grand Master.',E'www.unrealtournament.net',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (23,4,'The Wheel Of Time',E'(pt) The world in which The Wheel of Time takes place is lifted directly out of Jordan''s pages; it''s huge and consists of many different environments. How you navigate the world will depend largely on which game - single player or multipayer - you''re playing. The single player experience, with a few exceptions, will see Elayna traversing the world mainly by foot (with a couple notable exceptions). In the multiplayer experience, your character will have more access to travel via Ter''angreal, Portal Stones, and the Ways. However you move around, though, you''ll quickly discover that means of locomotion can easily become the least of the your worries...<br><br>During your travels, you quickly discover that four locations are crucial to your success in the game. Not surprisingly, these locations are the homes of The Wheel of Time''s main characters. Some of these places are ripped directly from the pages of Jordan''s books, made flesh with Legend''s unparalleled pixel-pushing ways. Other places are specific to the game, conceived and executed with the intent of expanding this game world even further. Either way, they provide a backdrop for some of the most intense first person action and strategy you''ll have this year.',E'www.wheeloftime.com',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (24,4,'Disciples: Sacred Lands',E'(pt) A new age is dawning...<br><br>Enter the realm of the Sacred Lands, where the dawn of a New Age has set in motion the most momentous of wars. As the prophecies long foretold, four races now clash with swords and sorcery in a desperate bid to control the destiny of their gods. Take on the quest as a champion of the Empire, the Mountain Clans, the Legions of the Damned, or the Undead Hordes and test your faith in battles of brute force, spellbinding magic and acts of guile. Slay demons, vanquish giants and combat merciless forces of the dead and undead. But to ensure the salvation of your god, the hero within must evolve.<br><br>The day of reckoning has come... and only the chosen will survive.',E'',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (25,4,'Microsoft Internet Keyboard PS/2',E'(pt) The Internet Keyboard has 10 Hot Keys on a comfortable standard keyboard design that also includes a detachable palm rest. The Hot Keys allow you to browse the web, or check e-mail directly from your keyboard. The IntelliType Pro software also allows you to customize your hot keys - make the Internet Keyboard work the way you want it to!',E'',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (26,4,'Microsoft IntelliMouse Explorer',E'(pt) Microsoft introduces its most advanced mouse, the IntelliMouse Explorer! IntelliMouse Explorer features a sleek design, an industrial-silver finish, a glowing red underside and taillight, creating a style and look unlike any other mouse. IntelliMouse Explorer combines the accuracy and reliability of Microsoft IntelliEye optical tracking technology, the convenience of two new customizable function buttons, the efficiency of the scrolling wheel and the comfort of expert ergonomic design. All these great features make this the best mouse for the PC!',E'www.microsoft.com/hardware/mouse/explorer.asp',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (27,4,'Hewlett Packard LaserJet 1100Xi',E'(pt) HP has always set the pace in laser printing technology. The new generation HP LaserJet 1100 series sets another impressive pace, delivering a stunning 8 pages per minute print speed. The 600 dpi print resolution with HP''s Resolution Enhancement technology (REt) makes every document more professional.<br><br>Enhanced print speed and laser quality results are just the beginning. With 2MB standard memory, HP LaserJet 1100xi users will be able to print increasingly complex pages. Memory can be increased to 18MB to tackle even more complex documents with ease. The HP LaserJet 1100xi supports key operating systems including Windows 3.1, 3.11, 95, 98, NT 4.0, OS/2 and DOS. Network compatibility available via the optional HP JetDirect External Print Servers.<br><br>HP LaserJet 1100xi also features The Document Builder for the Web Era from Trellix Corp. (featuring software to create Web documents).',E'www.pandi.hp.com/pandi-db/prodinfo.main?product=laserjet1100',0);

UPDATE products_description SET language_code = 'pt' WHERE language_id = 4;

INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (28,4,'Bundle Saver',E'Buy the Microsoft IntelliMouse Explorer and the Internet Keyboard together\, to save  10% on the individual prices and to receive free shipping !',E'',0);
...
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'addExpressionsToPromotion','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getExpressionsPerPromotion','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'removeExpressionsFromPromotion','', now());
...
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'evaluateExpression','', now());
...
CREATE INDEX idxproducts_attributes_products_id ON products_attributes (products_id);

-- New Digital Download table
DROP TABLE IF EXISTS kk_digital_download;
DROP TABLE IF EXISTS kk_digital_download_1;
CREATE TABLE kk_digital_download_1 (
  kk_digital_download_id SERIAL,
  store_id VARCHAR(64),
  products_id INTEGER DEFAULT '0' NOT NULL,
  customers_id INTEGER DEFAULT '0' NOT NULL,
...
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'addGiftCertificatesToPromotion','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getGiftCertificatesPerPromotion','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'removeGiftCertificatesFromPromotion','', now());
...
INSERT INTO products (products_id, products_quantity, products_model, products_image, products_price, products_date_added, products_last_modified, products_date_available, products_weight, products_status, products_tax_class_id, manufacturers_id, products_ordered, products_type) VALUES (DEFAULT,10000,'GIFTCERT','gifts/giftcert.jpg',10.00, now(),null,now(),0.1,1,1,10,0,5);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (DEFAULT,1,'Gift Certificate',E'The Perfect Gift ! <br><br>After checking out, your gift certificate will be available as a stylish pdf document that you can download from your account page. You may then send it as an eMail attachment or print it out and deliver a hard copy.<br>Each gift certificate contains a code that is redeemable online.',E'www.konakart.com',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (29,2,'Gift Certificate',E'The Perfect Gift ! <br><br>After checking out, your gift certificate will be available as a stylish pdf document that you can download from your account page. You may then send it as an eMail attachment or print it out and deliver a hard copy.<br>Each gift certificate contains a code that is redeemable online.',E'www.konakart.com',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (29,3,'Gift Certificate',E'The Perfect Gift ! <br><br>After checking out, your gift certificate will be available as a stylish pdf document that you can download from your account page. You may then send it as an eMail attachment or print it out and deliver a hard copy.<br>Each gift certificate contains a code that is redeemable online.',E'www.konakart.com',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (29,4,'Gift Certificate',E'The Perfect Gift ! <br><br>After checking out, your gift certificate will be available as a stylish pdf document that you can download from your account page. You may then send it as an eMail attachment or print it out and deliver a hard copy.<br>Each gift certificate contains a code that is redeemable online.',E'www.konakart.com',0);
...
INSERT INTO prod_opt_vals_to_prod_opt (prod_opt_vals_to_prod_opt_id, products_options_id, products_options_values_id) VALUES (DEFAULT, 5, 10);
INSERT INTO prod_opt_vals_to_prod_opt (prod_opt_vals_to_prod_opt_id, products_options_id, products_options_values_id) VALUES (DEFAULT, 5, 11);
INSERT INTO prod_opt_vals_to_prod_opt (prod_opt_vals_to_prod_opt_id, products_options_id, products_options_values_id) VALUES (DEFAULT, 5, 12);

DELETE FROM products_attributes WHERE options_id = 5;
INSERT INTO products_attributes (products_attributes_id, products_id, options_id, options_values_id, options_values_price, price_prefix) VALUES (DEFAULT,29,5,10,0.00,'+');
INSERT INTO products_attributes (products_attributes_id, products_id, options_id, options_values_id, options_values_price, price_prefix) VALUES (DEFAULT,29,5,11,15.00,'+');
INSERT INTO products_attributes (products_attributes_id, products_id, options_id, options_values_id, options_values_price, price_prefix) VALUES (DEFAULT,29,5,12,40.00,'+');
...
INSERT INTO categories (categories_id, categories_image, parent_id, sort_order, date_added, last_modified) VALUES (DEFAULT, 'no-image.png', 0, 4, now(), null);
...
INSERT INTO manufacturers (manufacturers_id, manufacturers_name, manufacturers_image, date_added, last_modified) VALUES (DEFAULT,'KonaKart','konakart_tree_logo_60x60.jpg', now(), null);
...
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'searchDigitalDownloads','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'importDigitalDownload','', now());
...
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT, 'kk_panel_reward_points','Reward Points Configuration', now());
...
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getRewardPoints','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'deletePoints','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'importDigitalDownload','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'pointsAvailable','', now());
...
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getPdf','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getFileContentsAsByteArray','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getLanguageIdForLocale','', now());
...
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'com.konakartadmin.bl.AdminOrderBatchMgr.createInvoicesBatch','', now());
...
CREATE INDEX idxcustomers_customers_email_address ON customers (customers_email_address);
...
ALTER TABLE products ADD COLUMN products_date_expiry TIMESTAMP;
...
ALTER TABLE address_format ALTER COLUMN address_format TYPE VARCHAR(255);
ALTER TABLE address_format ALTER COLUMN address_summary TYPE VARCHAR(255);

-- Make product image fields bigger
ALTER TABLE products ALTER COLUMN products_image TYPE VARCHAR(255);
ALTER TABLE products ALTER COLUMN products_image2 TYPE VARCHAR(255);
ALTER TABLE products ALTER COLUMN products_image3 TYPE VARCHAR(255);
ALTER TABLE products ALTER COLUMN products_image4 TYPE VARCHAR(255);
...
ALTER TABLE specials ADD COLUMN starts_date TIMESTAMP DEFAULT NULL;
...
CREATE TABLE kk_tier_price (
  ...
  use_percentage_discount INTEGER,
  custom1 VARCHAR(128),
  date_added TIMESTAMP NOT NULL,
  last_modified TIMESTAMP,
...
CREATE INDEX idxzones_zone_search ON zones (zone_search);

-- New API call for checking Data Integrity
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'checkDataIntegrity','', now());
...
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'exportOrder','', now());
...
-- getReviews API call
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getReviews','', now());
...
INSERT INTO kk_role_to_panel (role_id, panel_id, can_edit, can_insert, can_delete, date_added) SELECT 5, panel_id, 1,1,1, now() FROM kk_panel WHERE code = 'kk_panel_messages';
...
-- New Messages APIs
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'searchMsg','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getMsgValue','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'deleteMsg','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'insertMsg','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'updateMsg','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'importMsgs','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'exportMsgs','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getLanguageById','', now());

-- Add indexes on product table
CREATE INDEX idxproducts_manufacturers_id ON products (manufacturers_id);
...
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'addAddressesToProduct','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'removeAddressFromProduct','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getProductCountPerAddress','', now());

-- New Manufacturer API call
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getManufacturers','', now());

-- New Product Option API call
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getProductOptions','', now());
...
INSERT INTO kk_cust_attr (kk_cust_attr_id, name, msg_cat_key, attr_type, template, validation, set_function, date_added) VALUES (DEFAULT,'radio', 'label.size', 0, null, null, 'choice(''label.small'',''label.medium'',''label.large'')', now());
INSERT INTO kk_cust_attr (kk_cust_attr_id, name, msg_cat_key, attr_type, template, validation, set_function, date_added) VALUES (DEFAULT,'true-false', 'label.true.false', 4, null, 'true|false', null, now());
INSERT INTO kk_cust_attr (kk_cust_attr_id, name, msg_cat_key, attr_type, template, validation, set_function, date_added) VALUES (DEFAULT,'dropList', 'label.size', 0, null, null, 'option(s=label.small,m=label.medium,l=label.large)', now());
INSERT INTO kk_cust_attr (kk_cust_attr_id, name, msg_cat_key, attr_type, template, validation, set_function, date_added) VALUES (DEFAULT,'integer-1-to-10', null, 1, null, null, 'integer(1,10)', now());
INSERT INTO kk_cust_attr (kk_cust_attr_id, name, msg_cat_key, attr_type, template, validation, set_function, date_added) VALUES (DEFAULT,'any-int', null, 1, null, null, 'integer(null,null)', now());
INSERT INTO kk_cust_attr (kk_cust_attr_id, name, msg_cat_key, attr_type, template, validation, set_function, date_added) VALUES (DEFAULT,'decimal-1.5-to-2.3', null, 2, null, null, 'double(1.5,2.3)', now());
INSERT INTO kk_cust_attr (kk_cust_attr_id, name, msg_cat_key, attr_type, template, validation, set_function, date_added) VALUES (DEFAULT,'string-length-4', null, 0, null, null, 'string(4,4)', now());
INSERT INTO kk_cust_attr (kk_cust_attr_id, name, msg_cat_key, attr_type, template, validation, set_function, date_added) VALUES (DEFAULT,'date-dd/MM/yyyy', null, 3, 'dd/MM/yyyy', E'^(((0[1-9]|[12]\\d|3[01])\\/(0[13578]|1[02])\\/((1[6-9]|[2-9]\\d)\\d{2}))|((0[1-9]|[12]\\d|30)\\/(0[13456789]|1[012])\\/((1[6-9]|[2-9]\\d)\\d{2}))|((0[1-9]|1\\d|2[0-8])\\/02\\/((1[6-9]|[2-9]\\d)\\d{2}))|(29\\/02\\/((1[6-9]|[2-9]\\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))))$', null, now());
INSERT INTO kk_cust_attr (kk_cust_attr_id, name, msg_cat_key, attr_type, template, validation, set_function, custom1, custom2, custom3, date_added) VALUES (DEFAULT,'any-string-use-custom', null, 0, null, null, null, 'c1', 'c2', 'c3', now());
...
INSERT INTO kk_customer_tag (name, description, tag_type, max_ints, date_added) VALUES ('PROD_PAGE_SIZE', 'The page size for product lists', 1, 1, now());
DELETE FROM kk_customer_tag WHERE name ='ORDER_PAGE_SIZE';
INSERT INTO kk_customer_tag (name, description, tag_type, max_ints, date_added) VALUES ('ORDER_PAGE_SIZE', 'The page size for order lists', 1, 1, now());
DELETE FROM kk_customer_tag WHERE name ='REVIEW_PAGE_SIZE';
INSERT INTO kk_customer_tag (name, description, tag_type, max_ints, date_added) VALUES ('REVIEW_PAGE_SIZE', 'The page size for review lists', 1, 1, now());
...
ALTER TABLE products_description ALTER COLUMN products_name TYPE VARCHAR(255);
...
CREATE TABLE kk_catalog (
   ...
   description VARCHAR(255),
   use_cat_prices INTEGER,
   use_cat_quantities INTEGER,
...
ALTER TABLE categories_description ALTER COLUMN categories_name TYPE VARCHAR(255);

-----------------  v5.8.0.0

-- Extend the size of the products_name field
ALTER TABLE orders_products ALTER COLUMN products_name TYPE VARCHAR(255);
...
INSERT INTO kk_cust_attr (kk_cust_attr_id, name, msg_cat_key, attr_type, template, validation, set_function, date_added) VALUES (DEFAULT,'RichText', null, 0, null, null, 'RichText(8)', now());
...
ALTER TABLE customers_basket_attrs ADD COLUMN attr_type int DEFAULT '0' NOT NULL;
ALTER TABLE customers_basket_attrs ADD COLUMN attr_quantity int DEFAULT '0';
ALTER TABLE customers_basket_attrs ADD COLUMN customers_basket_id int DEFAULT '0' NOT NULL;
...
-- New Admin API call
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getConfigData','', now());
...
-- New Admin API call
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'updateOrder','', now());

-----------------  v6.3.0.0

-- New Admin API call - to get the version of the KonaKart Admin Engine
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getKonaKartAdminVersion','', now());
...
ALTER TABLE address_book ALTER COLUMN entry_city TYPE VARCHAR(64) ;
ALTER TABLE orders ALTER COLUMN customers_city TYPE VARCHAR(64) ;
ALTER TABLE orders ALTER COLUMN delivery_city TYPE VARCHAR(64) ;
ALTER TABLE orders ALTER COLUMN billing_city TYPE VARCHAR(64) ;
ALTER TABLE kk_wishlist ALTER COLUMN customers_city TYPE VARCHAR(64);
...
-- Admin API calls
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'editProductWithOptions','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'insertProductWithOptions','', now());
...
INSERT INTO products (products_id, products_model, products_image, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES (DEFAULT, 'LBP7680CX', 'canon/lbp7680cx.jpg', 309.99, 44.00, 1, 1, 6, 100, 0, now(), now());

INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (30, 1, 'Canon I-SENSYS LBP7680CX Printer',E'- Print Speed: Up to 20 ppm<br>- Max Resolution ( Colour ): 9600 dpi x 600 dpi<br>- Total Media Capacity: 300 sheets<br>- Interface: USB, Ethernet',E'http://www.canon.co.uk/For_Home/Product_Finder/Printers/Laser/',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (30, 2, 'Canon I-SENSYS LBP7680CX Drucker',E'- Drucker Speed: Up to 20 ppm<br>- Max Resolution ( Colour ): 9600 dpi x 600 dpi<br>- Total Media Capacity: 300 sheets<br>- Interface: USB, Ethernet',E'http://www.canon.co.uk/For_Home/Product_Finder/Printers/Laser/',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (30, 3, 'Canon I-SENSYS LBP7680CX Impresora',E'- Impresora Speed: Up to 20 ppm<br>- Max Resolution ( Colour ): 9600 dpi x 600 dpi<br>- Total Media Capacity: 300 sheets<br>- Interface: USB, Ethernet',E'http://www.canon.co.uk/For_Home/Product_Finder/Printers/Laser/',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (30, 4, 'Canon I-SENSYS LBP7680CX Impressora',E'- Impressora Speed: Up to 20 ppm<br>- Max Resolution ( Colour ): 9600 dpi x 600 dpi<br>- Total Media Capacity: 300 sheets<br>- Interface: USB, Ethernet',E'http://www.canon.co.uk/For_Home/Product_Finder/Printers/Laser/',0);
...
INSERT INTO products (products_id, products_model, products_image, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES (DEFAULT, 'LOGITECHIK', 'logitech/p800-0148872.jpg', 75.99, 6.00, 1, 1, 5, 100, 0, now(), now());

INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (31, 1, 'Logitech Illuminated Keyboard',E'- Ultra Thin: 9.3 mm profile and transparent frame<br>- Bright, laser-etched, backlighted keys<br>- Sleek, minimalist design<br>- One-touch multimedia controls',E'http://www.logitech.com/en-gb/keyboards',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (31, 2, '(DE) Logitech Illuminated Keyboard',E'- Ultra Thin: 9.3 mm profile and transparent frame<br>- Bright, laser-etched, backlighted keys<br>- Sleek, minimalist design<br>- One-touch multimedia controls',E'http://www.logitech.com/en-gb/keyboards',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (31, 3, '(ES) Logitech Illuminated Keyboard',E'- Ultra Thin: 9.3 mm profile and transparent frame<br>- Bright, laser-etched, backlighted keys<br>- Sleek, minimalist design<br>- One-touch multimedia controls',E'http://www.logitech.com/en-gb/keyboards',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (31, 4, '(PT) Logitech Illuminated Keyboard',E'- Ultra Thin: 9.3 mm profile and transparent frame<br>- Bright, laser-etched, backlighted keys<br>- Sleek, minimalist design<br>- One-touch multimedia controls',E'http://www.logitech.com/en-gb/keyboards',0);
...
INSERT INTO manufacturers (manufacturers_id, manufacturers_name, manufacturers_image, date_added, last_modified) VALUES (DEFAULT,'Lionsgate','manufacturer/lionsgate.jpg', now(), null);
...
INSERT INTO kk_cust_attr (kk_cust_attr_id, name, msg_cat_key, attr_type, template, validation, set_function, facet_number, date_added) VALUES (DEFAULT,'DVD Format', null, 0, null, null, 'option(facet.blu.ray=Blu-ray,facet.hd.dvd=HD-DVD)' ,1, now());
INSERT INTO kk_cust_attr (kk_cust_attr_id, name, msg_cat_key, attr_type, template, validation, set_function, facet_number, date_added) VALUES (DEFAULT,'Movie Ratings', null, 0, null, null, 'option(facet.mpaa.g=General Audience: G,facet.mpaa.pg=Parental Guidance: PG,facet.mpaa.pg.13=Parents Cautioned: PG-13,facet.mpaa.r=Restricted: R,facet.mpaa.nc.17=Adults Only: NC-17)',2, now());
...
INSERT INTO categories (categories_id, categories_image, parent_id, sort_order, date_added, last_modified) VALUES (DEFAULT, 'no-image.png', '0', '3', now(), null);
...
INSERT INTO categories (categories_id, categories_image, parent_id, sort_order, date_added, last_modified) VALUES (DEFAULT, 'no-image.png', 23, 5, now(), null);
...
INSERT INTO categories (categories_id, categories_image, parent_id, sort_order, date_added, last_modified) VALUES (DEFAULT, 'no-image.png', 23, 15, now(), null);
...
INSERT INTO categories (categories_id, categories_image, parent_id, sort_order, date_added, last_modified) VALUES (DEFAULT, 'no-image.png', 23, 10, now(), null);
...
INSERT INTO categories (categories_id, categories_image, parent_id, sort_order, date_added, last_modified) VALUES (DEFAULT, 'no-image.png', 24, 10, now(), null);
...
INSERT INTO categories (categories_id, categories_image, parent_id, sort_order, date_added, last_modified) VALUES (DEFAULT, 'no-image.png', 24, 5, now(), null);
...
INSERT INTO categories (categories_id, categories_image, parent_id, sort_order, date_added, last_modified) VALUES (DEFAULT, 'no-image.png', 24, 15, now(), null);
...
INSERT INTO manufacturers (manufacturers_id, manufacturers_name, manufacturers_image, date_added, last_modified) VALUES (DEFAULT,'DeLonghi','manufacturer/delonghi.jpg', now(), null);
...
INSERT INTO manufacturers (manufacturers_id, manufacturers_name, manufacturers_image, date_added, last_modified) VALUES (DEFAULT,'Amazon','manufacturer/amazon.jpg', now(), null);
...
INSERT INTO products (products_id, products_model, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES (DEFAULT, 'DLBCO410', 199.99, 3, 1, 1, 13, 100, 0, now(), now());

INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (34, 1, 'Kindle Fire HD', 'World''s most advanced 7" tablet<br>1280x800 HD display with polarizing filter and anti-glare technology for rich color and deep contrast from any viewing angle<br>Exclusive Dolby audio and dual-driver stereo speakers for immersive, virtual surround sound<br>World''s first tablet with dual-band, dual-antenna Wi-Fi for 40% faster downloads and streaming (compared to iPad 3)<br>High performance 1.2 Ghz dual-core processor with Imagination PowerVR 3D graphics core for fast and fluid performance',E'http://www.amazon.com/Kindle-Fire-HD/',0);
...
INSERT INTO manufacturers (manufacturers_id, manufacturers_name, manufacturers_image, date_added, last_modified) VALUES (DEFAULT,'Apple','manufacturer/apple.jpg', now(), null);
...
INSERT INTO products (products_id, products_model, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES (DEFAULT, 'CD74137', 19.99, 5, 1, 1, 15, 100, 0, now(), now());

INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (36, 1, 'Cadiz Clock', 'MSF Radio Controlled<br>Split Second Accuracy<br>Black Numbers With Black Hand<br>Excellent Design & Quality<br>Dimensions: 255mm / 10" Colour: Silver',E'http://www.acctim.com/',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (36, 2, 'Cadiz Clock', 'MSF Radio Controlled<br>Split Second Accuracy<br>Black Numbers With Black Hand<br>Excellent Design & Quality<br>Dimensions: 255mm / 10" Colour: Silver',E'http://www.acctim.com/',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (36, 3, 'Cadiz Clock', 'MSF Radio Controlled<br>Split Second Accuracy<br>Black Numbers With Black Hand<br>Excellent Design & Quality<br>Dimensions: 255mm / 10" Colour: Silver',E'http://www.acctim.com/',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (36, 4, 'Cadiz Clock', 'MSF Radio Controlled<br>Split Second Accuracy<br>Black Numbers With Black Hand<br>Excellent Design & Quality<br>Dimensions: 255mm / 10" Colour: Silver',E'http://www.acctim.com/',0);

INSERT INTO products_to_categories (products_id, categories_id) VALUES (36, 29);

-- New Milan 93 clock

INSERT INTO products (products_id, products_model, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES (DEFAULT, 'MI93', 12.99, 5, 1, 1, 15, 100, 0, now(), now());

INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (37, 1, 'Milan 93 Clock', 'Radio Controlled for split second accuracy, automatically sets to correct time<br>255mm Diameter<br>12/24 hour dial<br>Plastic case and lens<br>Dimensions H.W.L 255mm x 255mm x 37mm',E'http://www.acctim.com/',0);
...
INSERT INTO products (products_id, products_model, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES (DEFAULT, 'B000H1QSJY', 21.99, 5, 1, 1, 15, 100, 0, now(), now());

INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (38, 1, 'Acctim Metal Clock', 'Acctim wall clock<br>Radio controlled for split second accuracy<br>12/24 hour dial<br>Metal case<br>Diameter 300mm',E'http://www.acctim.com/',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (38, 2, 'Acctim Metal Clock', 'Acctim wall clock<br>Radio controlled for split second accuracy<br>12/24 hour dial<br>Metal case<br>Diameter 300mm',E'http://www.acctim.com/',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (38, 3, 'Acctim Metal Clock', 'Acctim wall clock<br>Radio controlled for split second accuracy<br>12/24 hour dial<br>Metal case<br>Diameter 300mm',E'http://www.acctim.com/',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (38, 4, 'Acctim Metal Clock', 'Acctim wall clock<br>Radio controlled for split second accuracy<br>12/24 hour dial<br>Metal case<br>Diameter 300mm',E'http://www.acctim.com/',0);

INSERT INTO products_to_categories (products_id, categories_id) VALUES (38, 29);

-- New Eddingtons Manufacturer

INSERT INTO manufacturers (manufacturers_id, manufacturers_name, manufacturers_image, date_added, last_modified) VALUES (DEFAULT,'Eddingtons','manufacturer/eddingtons.jpg', now(), null);
...
INSERT INTO manufacturers (manufacturers_id, manufacturers_name, manufacturers_image, date_added, last_modified) VALUES (DEFAULT,'Bosch','manufacturer/bosch.jpg', now(), null);
...
INSERT INTO products (products_id, products_model, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES (DEFAULT, 'B004GTMNXI', 159.99, 16, 1, 1, 17, 100, 0, now(), now());

INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (39, 1, 'Rotak 40 Ergoflex', 'Ergoflex System. Ergonomically shaped and adjustable handles for a better body posture and reduced muscle strain when mowing<br>1700W Powerdrive motor ensures a reliable cut, even in the most difficult conditions<br>Light weight for easy handling<br>Folding handles for compact storage<br>Innovative grass combs. Cut close to the edge of walls, flower beds and lawns',E'http://www.bosch.com/',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (39, 2, 'Rotak 40 Ergoflex', 'Ergoflex System. Ergonomically shaped and adjustable handles for a better body posture and reduced muscle strain when mowing<br>1700W Powerdrive motor ensures a reliable cut, even in the most difficult conditions<br>Light weight for easy handling<br>Folding handles for compact storage<br>Innovative grass combs. Cut close to the edge of walls, flower beds and lawns',E'http://www.bosch.com/',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (39, 3, 'Rotak 40 Ergoflex', 'Ergoflex System. Ergonomically shaped and adjustable handles for a better body posture and reduced muscle strain when mowing<br>1700W Powerdrive motor ensures a reliable cut, even in the most difficult conditions<br>Light weight for easy handling<br>Folding handles for compact storage<br>Innovative grass combs. Cut close to the edge of walls, flower beds and lawns',E'http://www.bosch.com/',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (39, 4, 'Rotak 40 Ergoflex', 'Ergoflex System. Ergonomically shaped and adjustable handles for a better body posture and reduced muscle strain when mowing<br>1700W Powerdrive motor ensures a reliable cut, even in the most difficult conditions<br>Light weight for easy handling<br>Folding handles for compact storage<br>Innovative grass combs. Cut close to the edge of walls, flower beds and lawns',E'http://www.bosch.com/',0);

INSERT INTO products_to_categories (products_id, categories_id) VALUES (39, 30);

-- New Rotak 32

INSERT INTO products (products_id, products_model, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES (DEFAULT, '0600885B71', 89.99, 7, 1, 1, 17, 100, 0, now(), now());

INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (40, 1, 'Rotak 32', 'Ergonomic handle design for easy manoeuvrability<br>Lightweight and compact for convenient carrying and problem-free manoeuvrability<br>Powerdrive motor ensures a reliable cut, even under difficult circumstances<br>Innovative grass combs. Cut close to the edge of walls, flower beds and lawns<br>31-litre grass box for greater capacity and reduced need for emptying',E'http://www.bosch.com/',0);
...
INSERT INTO manufacturers (manufacturers_id, manufacturers_name, manufacturers_image, date_added, last_modified) VALUES (DEFAULT,'Flymo','manufacturer/flymo.jpg', now(), null);
...
INSERT INTO products (products_id, products_model, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES (DEFAULT, 'CHEVRON34VC', 109.99, 7, 1, 1, 18, 100, 0, now(), now());

INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (41, 1, 'Flymo Chevron 34VC', 'The Chevron 34VC from Flymo is a lightweight, easy to use electric wheeled mower with a rear roller that will give your lawn that classic striped finish.<br>1400 watt motor<br>5 heights of cut (20 - 60mm)<br>40 litre collection box<br>12 metre mains cable<br>34cm metal cutting blade',E'http://www.flymo.com/int/products/lawn-mowers/chevron-34vc/',0);
...
INSERT INTO manufacturers (manufacturers_id, manufacturers_name, manufacturers_image, date_added, last_modified) VALUES (DEFAULT,'Brita','manufacturer/brita.jpg', now(), null);
...
INSERT INTO products (products_id, products_model, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES (DEFAULT, '219185', 15.19, 1, 1, 1, 19, 100, 0, now(), now());

INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (43, 1, 'Brita Marella XL Water Filter', 'Handy filling orifice in lid for easy filling<br>Electronic cartridge change display: BRITA MEMO<br>Dishwasher-safe up to 50°C (exception: lid)<br>XL version for larger demand, total volume: 3.5 L, filtered water: 2.0 L<br>Including 1x Maxtra cartridge',E'http://www.brita.com/',0);
...
INSERT INTO manufacturers (manufacturers_id, manufacturers_name, manufacturers_image, date_added, last_modified) VALUES (DEFAULT,'Brabantia','manufacturer/brabantia.jpg', now(), null);
...
INSERT INTO products (products_id, products_model, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES (DEFAULT, '424625', 149.49, 7, 1, 1, 20, 100, 0, now(), now());

INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (44, 1, 'Brabantia Touch Bin', 'Brabantia Soft-Touch closure - easy and light operation<br>Unique hinge design - lid opens silently<br>Matching Brabantia bin liners available with tie-tape (size L) - perfect fit and no ugly over wrap<br>Dimensions: height 75.5cm, diameter 37cm, capacity 45 litres<br>10 year guarantee',E'http://www.brabantia.com/',0);
...
INSERT INTO manufacturers (manufacturers_id, manufacturers_name, manufacturers_image, date_added, last_modified) VALUES (DEFAULT,'Samsung','manufacturer/samsung.jpg', now(), null);
...
INSERT INTO products (products_id, products_model, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES (DEFAULT, 'GALAXYSIII', 589.99, 2, 1, 1, 21, 100, 0, now(), now());

INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (45, 1, 'Galaxy S III', 'Designed for humans<br>Samsung GALAXY S III just gets us. Little things, like staying awake when you look at it and keeping track of loved ones. Designed for humans, it goes beyond smart and fulfills your needs by thinking as you think, acting as you act',E'http://www.samsung.com/uk/consumer/mobile-devices/smartphones/android/GT-I9300MBDBTU',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (45, 2, 'Galaxy S III', 'Designed for humans<br>Samsung GALAXY S III just gets us. Little things, like staying awake when you look at it and keeping track of loved ones. Designed for humans, it goes beyond smart and fulfills your needs by thinking as you think, acting as you act',E'http://www.samsung.com/uk/consumer/mobile-devices/smartphones/android/GT-I9300MBDBTU',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (45, 3, 'Galaxy S III', 'Designed for humans<br>Samsung GALAXY S III just gets us. Little things, like staying awake when you look at it and keeping track of loved ones. Designed for humans, it goes beyond smart and fulfills your needs by thinking as you think, acting as you act',E'http://www.samsung.com/uk/consumer/mobile-devices/smartphones/android/GT-I9300MBDBTU',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (45, 4, 'Galaxy S III', 'Designed for humans<br>Samsung GALAXY S III just gets us. Little things, like staying awake when you look at it and keeping track of loved ones. Designed for humans, it goes beyond smart and fulfills your needs by thinking as you think, acting as you act',E'http://www.samsung.com/uk/consumer/mobile-devices/smartphones/android/GT-I9300MBDBTU',0);

INSERT INTO products_to_categories (products_id, categories_id) VALUES (45, 27);

-- New Samsung Galaxy Ace Plus

INSERT INTO products (products_id, products_model, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES (DEFAULT, 'GT-S7500ABABTU', 289.99, 2, 1, 1, 21, 100, 0, now(), now());

INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (46, 1, 'Galaxy Ace Plus', 'A stylishly designed smartphone contained in a modern and minimalist casing with HVGA display<br>Complete with Samsung''s Social Hub, Music Hub and ChatON services<br>2Gb shared storage capacity for multimedia content and up to 1 Gb of direct storage for applications - more than any smartphone in its category',E'http://www.samsung.com/uk/consumer/mobile-devices/smartphones/android/GT-S7500ABABTU',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (46, 2, 'Galaxy Ace Plus', 'A stylishly designed smartphone contained in a modern and minimalist casing with HVGA display<br>Complete with Samsung''s Social Hub, Music Hub and ChatON services<br>2Gb shared storage capacity for multimedia content and up to 1 Gb of direct storage for applications - more than any smartphone in its category',E'http://www.samsung.com/uk/consumer/mobile-devices/smartphones/android/GT-S7500ABABTU',0);
...
INSERT INTO products (products_id, products_model, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES (DEFAULT, 'MD242B/A', 899.99, 3, 1, 1, 14, 100, 0, now(), now());

INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (47, 1, 'iPhone 4S', 'Dual-core A5 chip. All-new 8MP camera and optics. iOS 5 and iCloud. Retina 3.5-inch (diagonal) widescreen Multi-Touch display. Fingerprint-resistant oleophobic coating on front and back. It was the most amazing iPhone before the iPhone 5, but still great.',E'http://www.apple.com/iphone/iphone-4s/specs.html',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (47, 2, 'iPhone 4S', 'Dual-Core A5 Chip. Alle neuen 8MP Kamera und Optik. iOS 5 und iCloud. Retina 3,5-Zoll (Diagonale) im Breitbildformat Multi-Touch-Display. Fettabweisende Beschichtung auf Vorder-und Rückseite. Es war das schönste iPhone vor dem iPhone 5, aber immer noch groß.',E'http://www.apple.com/de/iphone/iphone-4s/specs.html',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (47, 3, 'iPhone 4S', 'Dual-core A5 chip. Todo nueva cámara de 8 megapíxeles y la óptica. iOS 5 y iCloud. Retina de 3,5 pulgadas (en diagonal) widescreen Multi-Touch. Resistente a huellas dactilares Cubierta oleófuga en la parte delantera y trasera. Fue el iPhone más asombroso antes de que el iPhone 5, pero sigue estando fenomenal.',E'http://www.apple.com/es/iphone/iphone-4s/specs.html',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (47, 4, 'iPhone 4S', 'Dual-core chip A5. Todos nova câmera de 8MP e óptica. iOS 5 e iCloud. Retina de 3,5 polegadas (diagonal) com tecnologia Multi-Touch widescreen. Fingerprint revestimento resistente oleophobic na frente e atrás. Foi o iPhone mais incrível antes de o iPhone 5, mas ainda grande.',E'http://www.apple.com/pt/iphone/iphone-4s/specs.html',0);

INSERT INTO products_to_categories (products_id, categories_id) VALUES (47, 27);

-- New Sony Manufacturer

INSERT INTO manufacturers (manufacturers_id, manufacturers_name, manufacturers_image, date_added, last_modified) VALUES (DEFAULT,'Sony','manufacturer/sony.jpg', now(), null);
...
INSERT INTO products (products_id, products_model, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES (DEFAULT, '5251B011AA', 439.99, 1, 1, 1, 6, 100, 0, now(), now());

INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (51, 1, 'Canon PowerShot SX40', 'Go far, get closer with 35x zoom<br><br>Get closer with the PowerShot SX40 HS. An ultra-wide 35x optical zoom, great low light results of the HS System, Full HD and high-speed shooting make this the travel powerhouse for those who want it all.<br>35x ultra wide-angle zoom with USM<br>Image Stabilizer (4.5-stop). Intelligent IS<br>HS System (12.1 MP) with DIGIC 5<br>Full HD, HDMI',E'http://www.canon.co.uk/For_Home/Product_Finder/Cameras/Digital_Camera/PowerShot/PowerShot_SX40_HS/',0);
...
INSERT INTO manufacturers (manufacturers_id, manufacturers_name, manufacturers_image, date_added, last_modified) VALUES (DEFAULT, 'Nikon', 'manufacturer/nikon.jpg', now(), null);
...
INSERT INTO products (products_id, products_model, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES (DEFAULT, 'L810', 279.99, 1, 1, 1, 23, 100, 0, now(), now());

INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (52, 1, 'Nikon COOLPIX L810', 'The Nikon COOLPIX L810 - Stabilised 26x zoom, compact and user-friendly<br><br>This compact camera lets curious photographers get up close from anywhere with the incredible Nikon COOLPIX NIKKOR 26x optical zoom lens (22.5mm – 585mm). Taking the perfect picture is made simple with Easy Auto mode which takes care of all the camera settings. For super-sharp shots it has Nikon''s clever anti-blur technology and a side zoom lever to help keep a steady hand.',E'http://www.nikonusa.com/en/Nikon-Products/Product/Compact-Digital-Cameras/26294/COOLPIX-L810.html',0);
...
INSERT INTO products (products_id, products_model, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES (DEFAULT, '25478', 849.99, 1, 1, 1, 23, 100, 0, now(), now());

INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (53, 1, 'Nikon D5100 SLR', 'The Nikon D5100 and its included AF-S 18-55mm VR lens offer a host of new photographic and video tools including a 16.2 MP DX-format CMOS sensor, 4 fps continuous shooting and breathtaking Full 1080p HD Movies with full time autofocus.',E'http://www.nikonusa.com/en/Nikon-Products/Product/Digital-SLR-Cameras/25478/D5100.html',0);
...
INSERT INTO manufacturers (manufacturers_id, manufacturers_name, manufacturers_image, date_added, last_modified) VALUES (DEFAULT,'Newgate','manufacturer/newgate.jpg', now(), null);
...
INSERT INTO products (products_id, products_model, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES (DEFAULT, 'MINISTRY', 83.99, 2, 1, 1, 24, 100, 0, now(), now());

INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (55, 1, 'Ministry Clock', 'Inspiration for this design came from the vintage enamel signage that was once found in stations and shops, but are now only found in flea markets.',E'http://www.newgateclocks.com/store/Wall-Clocks/min203ar.asp?sn=1',0);
...
INSERT INTO products (products_id, products_model, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES (DEFAULT, 'PLUTOG', 133.99, 2, 1, 1, 24, 100, 0, now(), now());

INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (56, 1, '60s Pluto Starburst Clock', 'You can have sun shine in your room 24/7 with our eye-catching Pluto Starburst Clock. It has been a few decades since the originals first made an appearance but our nostalgic Pluto is still going strong and as popular as ever!',E'http://www.newgateclocks.com/store/Wall-Clocks/plutog.asp?sn=2',0);
...
INSERT INTO products (products_id, products_model, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES (DEFAULT, 'PLUTOG', 79.99, 2, 1, 1, 24, 100, 0, now(), now());

INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (57, 1, 'Vision Clock', 'You can''t miss this clock when its in pride of place on the wall. Its striking bold acrylic numbers, chrome spokes and bold metal hands, make The Vision a vintage, retro, iconic and contemporary timepiece all rolled into one!',E'http://www.newgateclocks.com/store/Wall-Clocks/visionk.asp?sn=1',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (57, 2, 'Vision Clock', 'You can''t miss this clock when its in pride of place on the wall. Its striking bold acrylic numbers, chrome spokes and bold metal hands, make The Vision a vintage, retro, iconic and contemporary timepiece all rolled into one!',E'http://www.newgateclocks.com/store/Wall-Clocks/visionk.asp?sn=1',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (57, 3, 'Vision Clock', 'You can''t miss this clock when its in pride of place on the wall. Its striking bold acrylic numbers, chrome spokes and bold metal hands, make The Vision a vintage, retro, iconic and contemporary timepiece all rolled into one!',E'http://www.newgateclocks.com/store/Wall-Clocks/visionk.asp?sn=1',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (57, 4, 'Vision Clock', 'You can''t miss this clock when its in pride of place on the wall. Its striking bold acrylic numbers, chrome spokes and bold metal hands, make The Vision a vintage, retro, iconic and contemporary timepiece all rolled into one!',E'http://www.newgateclocks.com/store/Wall-Clocks/visionk.asp?sn=1',0);

INSERT INTO products_to_categories (products_id, categories_id) VALUES (57, 29);

-- New Office 2010 Software

INSERT INTO products (products_id, products_model, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES (DEFAULT, 'OFFHOMESTUD', 159.99, 6, 1, 1, 2, 100, 0, now(), now());

INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (58, 1, 'Office Home and Student 2010', 'With Microsoft Office Home and Student 2010, you and your kids can create great schoolwork and home projects from multi-page bibliographies to multimedia presentations. Capture ideas and set them apart with video-editing features and dynamic text effects. Then easily collaborate with classmates without being face-to-face thanks to new Web Apps tools. The results go well beyond expectations with a little inspiration, a lot of creativity and Office Home and Student 2010.',E'http://windows.microsoft.com/',0);
...
INSERT INTO products (products_id, products_model, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES (DEFAULT, 'IPADRET', 599.99, 2, 1, 1, 14, 100, 0, now(), now());
...
INSERT INTO products (products_id, products_model, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES (DEFAULT, 'GALTAB2', 549.99, 2, 1, 1, 21, 100, 0, now(), now());
...
INSERT INTO products (products_id, products_model, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES (DEFAULT, 'B000H1QSJY', 21.99, 5, 1, 1, 16, 100, 0, now(), now());

INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (62, 1, 'Weather Station Clock', 'Stylish clock featuring hygrometer (humidity) and thermometer dials and sweeping second hand. Aluminium rim. 30.5cm diameter. Retail box.',E'http://www.eddingtons.co.uk/',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (62, 2, 'Weather Station Clock', 'Stylish clock featuring hygrometer (humidity) and thermometer dials and sweeping second hand. Aluminium rim. 30.5cm diameter. Retail box.',E'http://www.eddingtons.co.uk/',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (62, 3, 'Weather Station Clock', 'Stylish clock featuring hygrometer (humidity) and thermometer dials and sweeping second hand. Aluminium rim. 30.5cm diameter. Retail box.',E'http://www.eddingtons.co.uk/',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (62, 4, 'Weather Station Clock', 'Stylish clock featuring hygrometer (humidity) and thermometer dials and sweeping second hand. Aluminium rim. 30.5cm diameter. Retail box.',E'http://www.eddingtons.co.uk/',0);

INSERT INTO products_to_categories (products_id, categories_id) VALUES (62, 29);

-- Add index to coupon table
CREATE INDEX idxcoupon_coupon_code ON coupon (coupon_code);
...
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'insertConfigData','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'updateConfigData','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'removeConfigData','', now());
...
-- Image APIs
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'scaleImage','', now());
...
ALTER TABLE products ALTER COLUMN products_weight TYPE DECIMAL(15,2);
ALTER TABLE products ALTER COLUMN products_weight SET DEFAULT 0.00;


-- New Activision Manufacturer

INSERT INTO manufacturers (manufacturers_id, manufacturers_name, manufacturers_image, date_added, last_modified) VALUES (DEFAULT,'Activision','manufacturer/activision.jpg', now(), null);
...
INSERT INTO products (products_id, products_model, products_price, products_weight, products_status, products_tax_class_id, manufacturers_id, products_quantity, products_ordered, products_date_added, products_date_available) VALUES (DEFAULT, 'BLACKOPS2', 39.99, 1, 1, 1, 25, 200, 0, now(), now());

INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (63, 1, 'Call Of Duty', 'Call Of Duty - Black Ops2 - Stunning but Violent',E'http://www.callofduty.com/blackops2',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (63, 2, 'Call Of Duty', 'Call Of Duty - Black Ops2 - Stunning but Violent',E'http://www.callofduty.com/blackops2',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (63, 3, 'Call Of Duty', 'Call Of Duty - Black Ops2 - Stunning but Violent',E'http://www.callofduty.com/blackops2',0);
INSERT INTO products_description (products_id, language_id, products_name, products_description, products_url, products_viewed) VALUES (63, 4, 'Call Of Duty', 'Call Of Duty - Black Ops2 - Stunning but Violent',E'http://www.callofduty.com/blackops2',0);
...
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  1, 2, 1, 'images/banners/computer-peripherals/logitech-keyboard.jpg', 'SelectProd.action?prodId=31' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  1, 2, 2, 'images/banners/computer-peripherals/hp-photosmart.jpg','SelectProd.action?prodId=27' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  1, 2, 3, 'images/banners/computer-peripherals/deals-of-the-week.jpg', '' );
--cat 2 Games
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  2, 2, 1, 'images/banners/games/black-ops-2.jpg', 'SelectProd.action?prodId=63' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  2, 2, 2, 'images/banners/games/swat3.jpg','SelectProd.action?prodId=21' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  2, 2, 3, 'images/banners/games/winter-deals.jpg', '' );
--cat 3 DVD Movies
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  3, 2, 1, 'images/banners/movies/dark-knight.jpg', 'SelectProd.action?prodId=20' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  3, 2, 2, 'images/banners/movies/harry-potter.jpg','SelectProd.action?prodId=11' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  3, 2, 3, 'images/banners/movies/movie-deals.jpg', '' );
--cat 23 Electronics
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  23, 2, 1, 'images/banners/electronics/kindle-fire-hd.jpg', 'SelectProd.action?prodId=34' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  23, 2, 2, 'images/banners/electronics/canon-powershot.jpg','SelectProd.action?prodId=49' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  23, 2, 3, 'images/banners/electronics/electronics-sale.jpg', '' );
--cat 24 Home and Garden
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  24, 2, 1, 'images/banners/home-and-garden/delonghi.jpg', 'SelectProd.action?prodId=33' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  24, 2, 2, 'images/banners/home-and-garden/rotak-40.jpg','SelectProd.action?prodId=39' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  24, 2, 3, 'images/banners/home-and-garden/gifts-for-the-home.jpg', '' );
...
-- Scheduler APIs
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getJobStatus','', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'runBatchJob','', now());
...
-- Admin APIs
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'insertProductCategory', '', now());

-- Extend the size of the order name fields
ALTER TABLE orders ALTER COLUMN customers_name TYPE VARCHAR(66);
ALTER TABLE orders ALTER COLUMN delivery_name TYPE VARCHAR(66);
ALTER TABLE orders ALTER COLUMN billing_name TYPE VARCHAR(66);

-- New Batch jobs
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'com.konakartadmin.bl.AdminCustomerBatchMgr.countCustomersBatch', '', now());

-- New config variables for mobile application
DELETE FROM configuration WHERE configuration_key = 'STORE_FRONT_SCRIPT_BASE_M';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, return_by_api, date_added) VALUES ('Mobile Store-Front script base','STORE_FRONT_SCRIPT_BASE_M','/konakart-m/script','Script base used in JSPs for mobile store-front application','4', '20', 1, now());
DELETE FROM configuration WHERE configuration_key = 'STORE_FRONT_STYLE_BASE_M';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, return_by_api, date_added) VALUES ('Mobile Store-Front style sheet base','STORE_FRONT_STYLE_BASE_M','/konakart-m/styles','Style sheet base used in JSPs for mobile store-front application','4', '21', 1, now());
...
-- New tailFile API
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'tailFile', '', now());
...
INSERT INTO configuration_group VALUES (DEFAULT, 'Reward Points', 'Reward Points Configuration', 26, 1, null);
INSERT INTO configuration_group VALUES (DEFAULT, 'PDF Configuration', 'PDF Configuration', 27, 1, null);
INSERT INTO configuration_group VALUES (DEFAULT, 'Velocity Templates', 'Velocity Templates Configuration', 28, 1, null);
INSERT INTO configuration_group VALUES (DEFAULT, 'Importer Config', 'Importer Configuration', 29, 1, null);
INSERT INTO configuration_group VALUES (DEFAULT, 'Sitemap', 'Sitemap Configuration', 30, 1, null);
...
-- New copyFile API
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'copyFile', '', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, return_by_api) VALUES ('Addr Format for Store Addr', 'ADMIN_APP_STORE_ADDR_FORMAT', '$street $street1 $suburb $city $state $country', 'How the address is formatted in the store address panel', '21', '1', now(), '0');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Storefront force login','APP_FORCE_LOOGIN','false','Set to true to force customers to login in order to be able to use the storefront application.','1', '38', 'choice(''true'', ''false'')', now(), '1');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Cache Products','CACHE_PRODUCTS','true','Set to true to Cache Products in memory.','11', '15', 'choice(''true'', ''false'')', now(), '1');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Cache Product Images','CACHE_PRODUCT_IMAGES','true','Set to true to Cache Product Image Names in memory.','11', '20', 'choice(''true'', ''false'')', now(), '1');
...
--1
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 1,(SELECT languages_id FROM languages WHERE code = 'en'),'Pending');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 1,(SELECT languages_id FROM languages WHERE code = 'de'),'Offen');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 1,(SELECT languages_id FROM languages WHERE code = 'es'),'Pendiente');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 1,(SELECT languages_id FROM languages WHERE code = 'pt'),'Pendente');
--2
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 2,(SELECT languages_id FROM languages WHERE code = 'en'),'Processing');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 2,(SELECT languages_id FROM languages WHERE code = 'de'),'In Bearbeitung');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 2,(SELECT languages_id FROM languages WHERE code = 'es'),'Proceso');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 2,(SELECT languages_id FROM languages WHERE code = 'pt'),'Processamento');
--3
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 3,(SELECT languages_id FROM languages WHERE code = 'en'),'Delivered');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 3,(SELECT languages_id FROM languages WHERE code = 'de'),'Versendet');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 3,(SELECT languages_id FROM languages WHERE code = 'es'),'Entregado');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 3,(SELECT languages_id FROM languages WHERE code = 'pt'),'Entregue');
--4
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 4,(SELECT languages_id FROM languages WHERE code = 'en'),'Waiting for Payment');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 4,(SELECT languages_id FROM languages WHERE code = 'de'),'Wartezahlung');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 4,(SELECT languages_id FROM languages WHERE code = 'es'),'Para pago que espera');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 4,(SELECT languages_id FROM languages WHERE code = 'pt'),'Ã espera de pagamento');
--5
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 5,(SELECT languages_id FROM languages WHERE code = 'en'),'Payment Received');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 5,(SELECT languages_id FROM languages WHERE code = 'de'),'Zahlung empfing');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 5,(SELECT languages_id FROM languages WHERE code = 'es'),'Pago recibido');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 5,(SELECT languages_id FROM languages WHERE code = 'pt'),'Pagamento Recebido');
--6
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 6,(SELECT languages_id FROM languages WHERE code = 'en'),'Payment Declined');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 6,(SELECT languages_id FROM languages WHERE code = 'de'),'Zahlung sank');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 6,(SELECT languages_id FROM languages WHERE code = 'es'),'Pago declinado');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 6,(SELECT languages_id FROM languages WHERE code = 'pt'),'Pagamento recusado');
--7
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 7,(SELECT languages_id FROM languages WHERE code = 'en'),'Partially Delivered');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 7,(SELECT languages_id FROM languages WHERE code = 'de'),'Teilweise geliefert');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 7,(SELECT languages_id FROM languages WHERE code = 'es'),'Entregado parcialmente');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 7,(SELECT languages_id FROM languages WHERE code = 'pt'),'Parcialmente Entregues');
--8
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 8,(SELECT languages_id FROM languages WHERE code = 'en'),'Cancelled');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 8,(SELECT languages_id FROM languages WHERE code = 'de'),'Abgesagt');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 8,(SELECT languages_id FROM languages WHERE code = 'es'),'Cancelado');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 8,(SELECT languages_id FROM languages WHERE code = 'pt'),'Cancelado');
--9
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 9,(SELECT languages_id FROM languages WHERE code = 'en'),'Refund Approved');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 9,(SELECT languages_id FROM languages WHERE code = 'de'),'Rückerstattung Genehmigt');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 9,(SELECT languages_id FROM languages WHERE code = 'es'),'Reembolso Aprobado');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 9,(SELECT languages_id FROM languages WHERE code = 'pt'),'Reembolso Aprovado');
--10
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 10,(SELECT languages_id FROM languages WHERE code = 'en'),'Refund Declined');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 10,(SELECT languages_id FROM languages WHERE code = 'de'),'Rückerstattung Abgelehnt');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 10,(SELECT languages_id FROM languages WHERE code = 'es'),'Reembolso Rehusó');
INSERT INTO orders_status (orders_status_pk, orders_status_id, language_id, orders_status_name) VALUES (DEFAULT, 10,(SELECT languages_id FROM languages WHERE code = 'pt'),'Reembolso Recusado');
...
INSERT INTO kk_config (kk_config_key, kk_config_value, date_added) VALUES ('HISTORY', '7.3.0.0 I', now());
INSERT INTO kk_config (kk_config_key, kk_config_value, date_added) VALUES ('VERSION', '7.3.0.0 PostgreSQL', now());
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Enable "Other" Gender', 'ENABLE_OTHER_GENDER', 'false', 'Enable "Other" gender in addition to Male and Female', '5', '1', 'choice(''true'', ''false'')', now(), '1');
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, return_by_api) VALUES ('Tax Id','ACCOUNT_TAX_ID','false','Display tax id in the customers account','5', '3', 'choice(''true'', ''false'')', now(), '1');
...
-- Add new API calls
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'removeProductFromCatalog', '', now());
INSERT INTO kk_api_call (api_call_id, name, description, date_added) VALUES (DEFAULT,'getRMACode', '', now());
...
--cat 1 Computer Peripherals
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  1, 2, 1, 'banners/computer-peripherals/logitech.png', 'SelectProd.action?prodId=31' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  1, 2, 4, 'banners/computer-peripherals/logitech-medium.png', 'SelectProd.action?prodId=31' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  1, 2, 7, 'banners/computer-peripherals/logitech-small.png', 'SelectProd.action?prodId=31' );

INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  1, 2, 2, 'banners/computer-peripherals/hp-photosmart.png','SelectProd.action?prodId=27' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  1, 2, 5, 'banners/computer-peripherals/hp-photosmart-medium.png','SelectProd.action?prodId=27' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  1, 2, 8, 'banners/computer-peripherals/hp-photosmart-small.png','SelectProd.action?prodId=27' );

INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  1, 2, 3, 'banners/computer-peripherals/deals-of-the-week.png', '' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  1, 2, 6, 'banners/computer-peripherals/deals-of-the-week-medium.png', '' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  1, 2, 9, 'banners/computer-peripherals/deals-of-the-week-small.png', '' );

--cat 2 Games
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  2, 2, 1, 'banners/games/black-ops-2.png', 'SelectProd.action?prodId=63' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  2, 2, 4, 'banners/games/black-ops-2-medium.png', 'SelectProd.action?prodId=63' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  2, 2, 7, 'banners/games/black-ops-2-small.png', 'SelectProd.action?prodId=63' );

INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  2, 2, 2, 'banners/games/swat-3.png','SelectProd.action?prodId=21' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  2, 2, 5, 'banners/games/swat-3-medium.png','SelectProd.action?prodId=21' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  2, 2, 8, 'banners/games/swat-3-small.png','SelectProd.action?prodId=21' );

INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  2, 2, 3, 'banners/games/winter-deals.png', '' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  2, 2, 6, 'banners/games/winter-deals-medium.png', '' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  2, 2, 9, 'banners/games/winter-deals-small.png', '' );

--cat 3 DVD Movies
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  3, 2, 1, 'banners/movies/dark-knight.png', 'SelectProd.action?prodId=20' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  3, 2, 4, 'banners/movies/dark-knight-medium.png', 'SelectProd.action?prodId=20' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  3, 2, 7, 'banners/movies/dark-knight-small.png', 'SelectProd.action?prodId=20' );

INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  3, 2, 2, 'banners/movies/harry-potter.png','SelectProd.action?prodId=11' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  3, 2, 5, 'banners/movies/harry-potter-medium.png','SelectProd.action?prodId=11' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  3, 2, 8, 'banners/movies/harry-potter-small.png','SelectProd.action?prodId=11' );

INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  3, 2, 3, 'banners/movies/movie-deals.png', '' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  3, 2, 6, 'banners/movies/movie-deals-medium.png', '' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  3, 2, 9, 'banners/movies/movie-deals-small.png', '' );

--cat 23 Electronics
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  23, 2, 1, 'banners/electronics/kindle-fire-hd.jpg', 'SelectProd.action?prodId=34' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  23, 2, 4, 'banners/electronics/kindle-fire-hd-medium.jpg', 'SelectProd.action?prodId=34' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  23, 2, 7, 'banners/electronics/kindle-fire-hd-small.jpg', 'SelectProd.action?prodId=34' );

INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  23, 2, 2, 'banners/electronics/xbox.png','' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  23, 2, 5, 'banners/electronics/xbox-medium.png','' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  23, 2, 8, 'banners/electronics/xbox-small.png','' );

INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  23, 2, 3, 'banners/electronics/electronics-sale.png', '' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  23, 2, 6, 'banners/electronics/electronics-sale-medium.png', '' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  23, 2, 9, 'banners/electronics/electronics-sale-small.png', '' );

--cat 24 Home and Garden
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  24, 2, 1, 'banners/home-and-garden/delonghi.png', 'SelectProd.action?prodId=33' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  24, 2, 4, 'banners/home-and-garden/delonghi-medium.png', 'SelectProd.action?prodId=33' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  24, 2, 7, 'banners/home-and-garden/delonghi-small.png', 'SelectProd.action?prodId=33' );

INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  24, 2, 2, 'banners/home-and-garden/rotak-40.png','SelectProd.action?prodId=39' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  24, 2, 5, 'banners/home-and-garden/rotak-40-medium.png','SelectProd.action?prodId=39' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  24, 2, 8, 'banners/home-and-garden/rotak-40-small.png','SelectProd.action?prodId=39' );

INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  24, 2, 3, 'banners/home-and-garden/gifts-for-the-home.png', '' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  24, 2, 6, 'banners/home-and-garden/gifts-for-the-home-medium.png', '' );
INSERT INTO kk_misc_item (kk_misc_item_id, kk_obj_id, kk_obj_type_id, kk_misc_item_type_id, item_value, custom1) VALUES (DEFAULT,  24, 2, 9, 'banners/home-and-garden/gifts-for-the-home-small.png', '' );
