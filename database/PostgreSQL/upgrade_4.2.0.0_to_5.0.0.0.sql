...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added, store_id) SELECT 'Set Order Status', 'MODULE_PAYMENT_COD_ORDER_STATUS_ID', '0', 'Set the status of orders made with this payment module to this value.', '6', '0', 'tep_get_order_status_name', 'tep_cfg_pull_down_order_statuses(', now(), store_id FROM configuration where configuration_key = 'STORE_COUNTRY';
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, store_id) SELECT 'Reward Point Transactions', 'MAX_DISPLAY_REWARD_POINTS', '20', 'Maximum number of reward point transactions to display', '3', '26', 'integer(0,null)', now(), store_id FROM configuration where configuration_key = 'STORE_COUNTRY';
...
INSERT INTO kk_role_to_panel (role_id, panel_id, can_edit, can_insert, can_delete, date_added, store_id) SELECT role_id, 92, 1, 1, 1, now(), store_id FROM kk_role_to_panel rtp, kk_panel p where rtp.panel_id=p.panel_id and p.code='kk_panel_promotions';
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, store_id) SELECT 'Use Rich Text Editor', 'RICH_TEXT_EDITOR', 'true', 'If true the Rich Text Editor is used for product descriptions, otherwise the Plain Text Editor is used', '9', '12', 'tep_cfg_select_option(array(''true'', ''false''), ', now(), store_id FROM configuration where configuration_key = 'STORE_COUNTRY';
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, store_id) SELECT '1st Day of the Week', '1ST_DAY_OF_WEEK', '0', 'Define the first day of the week for the calendars in the Admin App.', '21', '35', 'option(0=date.day.long.Sunday,1=date.day.long.Monday,2=date.day.long.Tuesday,3=date.day.long.Wednesday,4=date.day.long.Thursday,5=date.day.long.Friday,6=date.day.long.Saturday)', now(), store_id FROM configuration where configuration_key = 'STORE_COUNTRY';

-- Allow user to insert gift certificate code
DELETE FROM configuration where configuration_key = 'DISPLAY_GIFT_CERT_ENTRY';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, store_id) SELECT 'Display Gift Cert Entry Field', 'DISPLAY_GIFT_CERT_ENTRY', 'false', 'During checkout the customer will be allowed to enter a git certificate if set to true', '1', '22', 'choice(''true'', ''false'')', now(), store_id FROM configuration where configuration_key = 'STORE_COUNTRY';
...
-- PDF Config panel
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT,'kk_panel_pdfConfig', 'PDF Configuration', now());

-- Add Configure Reward Points to super admin role
INSERT INTO kk_role_to_panel (role_id, panel_id, can_edit, can_insert, can_delete, date_added, store_id) SELECT role_id, 93, 1, 1, 1, now(), store_id FROM kk_role_to_panel rtp, kk_panel p where rtp.panel_id=p.panel_id and p.code='kk_panel_reportsConfig';
...
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT,'kk_panel_templates', 'Template Configuration', now());

-- Add Configure Reward Points to super admin role
INSERT INTO kk_role_to_panel (role_id, panel_id, can_edit, can_insert, can_delete, date_added, store_id) SELECT role_id, 94, 1, 1, 1, now(), store_id FROM kk_role_to_panel rtp, kk_panel p where rtp.panel_id=p.panel_id and p.code='kk_panel_reportsConfig';
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, store_id) SELECT 'Automatically Enable Product', 'STOCK_ENABLE_PRODUCT', 'false', 'Automatically enable a product if quantity is set to a positive number', '9', '4', 'choice(''true'', ''false'')', now(), store_id FROM configuration where configuration_key = 'STORE_COUNTRY';
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added, store_id) SELECT 'Miscellaneous Config File', 'MODULE_PAYMENT_COD_MISC_CONFIG_FILE', 'C:/Temp/cod_misc.properties', 'Miscellaneous Configuration File (just an example - not actually used).', '6', '6', 'FileUpload', '', now(), store_id FROM configuration where configuration_key = 'STORE_COUNTRY';
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, store_id) SELECT 'Display Customer Ids', 'ADMIN_APP_CUSTOMERS_DISPLAY_ID', 'true', 'When this is set, the customer id is displayed in the edit customer panel', '21', '29', 'choice(''true'', ''false'')', now(), store_id FROM configuration where configuration_key = 'STORE_COUNTRY';
...
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT,'kk_panel_payment_schedule', 'Payment Schedule', now());

-- Add Configure Reward Points to super admin role
INSERT INTO kk_role_to_panel (role_id, panel_id, can_edit, can_insert, can_delete, date_added, store_id) SELECT role_id, 95, 1, 1, 1, now(), store_id FROM kk_role_to_panel rtp, kk_panel p where rtp.panel_id=p.panel_id and p.code='kk_panel_editProduct';

-- Subscription Panel
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT,'kk_panel_subscription', 'Subscription', now());

-- Add Configure Reward Points to super admin role
INSERT INTO kk_role_to_panel (role_id, panel_id, can_edit, can_insert, can_delete, date_added, store_id) SELECT role_id, 96, 1, 1, 1, now(), store_id FROM kk_role_to_panel rtp, kk_panel p where rtp.panel_id=p.panel_id and p.code='kk_panel_editOrderPanel';

-- Subscription From Orders Panel
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT,'kk_panel_subscriptionFromOrders', 'Subscription From Orders', now());

-- Add Configure Reward Points to super admin role
INSERT INTO kk_role_to_panel (role_id, panel_id, can_edit, can_insert, can_delete, date_added, store_id) SELECT role_id, 97, 1, 1, 1, now(), store_id FROM kk_role_to_panel rtp, kk_panel p where rtp.panel_id=p.panel_id and p.code='kk_panel_editOrderPanel';

-- Subscription from Customers Panel
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (DEFAULT,'kk_panel_subscriptionFromCustomers', 'Subscription From Customers', now());

-- Add Configure Reward Points to super admin role
INSERT INTO kk_role_to_panel (role_id, panel_id, can_edit, can_insert, can_delete, date_added, store_id) SELECT role_id, 98, 1, 1, 1, now(), store_id FROM kk_role_to_panel rtp, kk_panel p where rtp.panel_id=p.panel_id and p.code='kk_panel_editOrderPanel';
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, store_id) SELECT 'Display Subscriptions Button', 'ADMIN_APP_DISPLAY_SUBSCRIPTIONS_BUTTON', 'false', 'When this is set, a Subscriptions button is displayed in the Customers and Orders panels', '21', '30', 'choice(''true'', ''false'')', now(), store_id FROM configuration where configuration_key = 'STORE_COUNTRY';
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, store_id) SELECT 'Allow multiple basket entries', 'ALLOW_MULTIPLE_BASKET_ENTRIES', 'false', 'When set, allow the same product to be entered into the basket more than once without updating the quantity of the existing one', '9', '11', 'choice(''true'', ''false'')', now(), store_id FROM configuration where configuration_key = 'STORE_COUNTRY';
...
ALTER TABLE address_format ALTER COLUMN address_format TYPE VARCHAR(256);
ALTER TABLE address_format ALTER COLUMN address_summary TYPE VARCHAR(256);

-- Make product image fields bigger
ALTER TABLE products ALTER COLUMN products_image TYPE VARCHAR(256);
ALTER TABLE products ALTER COLUMN products_image2 TYPE VARCHAR(256);
ALTER TABLE products ALTER COLUMN products_image3 TYPE VARCHAR(256);
ALTER TABLE products ALTER COLUMN products_image4 TYPE VARCHAR(256);
