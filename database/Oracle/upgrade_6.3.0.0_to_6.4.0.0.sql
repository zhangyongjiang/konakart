...
set echo on
INSERT INTO kk_config (kk_config_id, kk_config_key, kk_config_value, date_added) VALUES (kk_config_seq.nextval, 'HISTORY', '6.4.0.0 U', sysdate);
UPDATE kk_config SET kk_config_value='6.4.0.0 Oracle', date_added=sysdate WHERE kk_config_key='VERSION';
