...
delete from address_format where store_id = 'TARGET_STOREID';
INSERT INTO address_format (address_format_id, address_format, address_summary, store_id) select address_format_seq.nextval, address_format, address_summary, 'TARGET_STOREID' from address_format where store_id='SOURCE_STOREID';

delete from geo_zones where store_id = 'TARGET_STOREID';
INSERT INTO geo_zones (geo_zone_id, geo_zone_name, geo_zone_description, last_modified, date_added, store_id) select geo_zones_seq.nextval, geo_zone_name, geo_zone_description, last_modified, date_added, 'TARGET_STOREID' from geo_zones where store_id='SOURCE_STOREID';

delete from countries where store_id = 'TARGET_STOREID';
INSERT INTO countries (countries_id, countries_name, countries_iso_code_2, countries_iso_code_3, address_format_id, store_id) VALUES (countries_seq.nextval,'United States', 'US', 'USA', -1, 'TARGET_STOREID');
...
Delete from address_book where store_id = 'TARGET_STOREID';
INSERT INTO address_book (address_book_id, customers_id, entry_gender, entry_company, entry_firstname, entry_lastname, entry_street_address, entry_suburb, entry_postcode, entry_city, entry_state, entry_country_id, store_id) VALUES (address_book_seq.nextval,-1, 'm', 'ACME Inc.', 'TARGET_STOREID-admin', 'Admin', 'TARGET_STOREID Admin Street', 'Suburb', 'PostcodeX', 'City', '', 1, 'TARGET_STOREID');
INSERT INTO address_book (address_book_id, customers_id, entry_gender, entry_company, entry_firstname, entry_lastname, entry_street_address, entry_suburb, entry_postcode, entry_city, entry_state, entry_country_id, store_id) VALUES (address_book_seq.nextval,-2, 'm', 'ACME Inc.', 'TARGET_STOREID-super', 'Super', 'TARGET_STOREID Super Street', 'Suburb', 'PostcodeX', 'City', '', 1, 'TARGET_STOREID');

Delete from customers where store_id = 'TARGET_STOREID';
INSERT INTO customers (customers_id, customers_gender, customers_firstname, customers_lastname,customers_dob, customers_email_address, customers_default_address_id, customers_telephone, customers_fax, customers_password, customers_newsletter, customers_type, store_id) VALUES (customers_seq.nextval, 'm', 'TARGET_STOREID-admin', 'Admin', to_date('1977/01/01', 'yyyy/mm/dd'), 'TARGET_STOREID-admin@konakart.com', -1, '019081', '', 'f5147fc3f6eb46e234c01db939bdb581:08', '0', 1, 'TARGET_STOREID');
INSERT INTO customers (customers_id, customers_gender, customers_firstname, customers_lastname,customers_dob, customers_email_address, customers_default_address_id, customers_telephone, customers_fax, customers_password, customers_newsletter, customers_type, store_id) VALUES (customers_seq.nextval, 'm', 'TARGET_STOREID-super', 'Super', to_date('1977/01/01', 'yyyy/mm/dd'), 'TARGET_STOREID-super@konakart.com', -2, '019081', '', 'f5147fc3f6eb46e234c01db939bdb581:08', '0', 1, 'TARGET_STOREID');

Delete from customers_info where store_id = 'TARGET_STOREID';
INSERT INTO customers_info select customers_id , sysdate, 0, sysdate, sysdate, 0, 'TARGET_STOREID' from customers where customers_email_address = 'TARGET_STOREID-admin@konakart.com' and store_id='TARGET_STOREID';
INSERT INTO customers_info select customers_id , sysdate, 0, sysdate, sysdate, 0, 'TARGET_STOREID' from customers where customers_email_address = 'TARGET_STOREID-super@konakart.com' and store_id='TARGET_STOREID';
