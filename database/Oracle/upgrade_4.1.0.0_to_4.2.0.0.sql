...
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, store_id) SELECT configuration_seq.nextval, 'Gift Registry Items', 'MAX_DISPLAY_GIFT_REGISTRY_ITEMS', '20', 'Maximum number of gift registry items to display', '3', '25', 'integer(0,null)', sysdate, store_id FROM configuration where configuration_key = 'STORE_COUNTRY';
...
DROP TABLE kk_customer_tag CASCADE CONSTRAINTS;
...
DROP TABLE kk_customers_to_tag CASCADE CONSTRAINTS;
...
INSERT INTO kk_role_to_panel (role_id, panel_id, can_edit, can_insert, can_delete, date_added, store_id) SELECT role_id, 89, 1, 1, 1, sysdate, store_id FROM kk_role_to_panel rtp, kk_panel p where rtp.panel_id=p.panel_id and p.code='kk_panel_editCustomer';

-- Email Integration Class
delete from configuration where configuration_key = 'EMAIL_INTEGRATION_CLASS';
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, store_id) SELECT configuration_seq.nextval, 'Email Integration Class', 'EMAIL_INTEGRATION_CLASS', 'com.konakart.bl.EmailIntegrationMgr', 'The Email Integration Implementation Class to enable you to change the toAddress of the mail', '12', '16', sysdate, store_id FROM configuration where configuration_key = 'STORE_COUNTRY';

-- Tables for Expressions
DROP TABLE kk_expression CASCADE CONSTRAINTS;
...
DROP TABLE kk_expression_variable CASCADE CONSTRAINTS;
...
INSERT INTO kk_role_to_panel (role_id, panel_id, can_edit, can_insert, can_delete, date_added, store_id) SELECT role_id, 90, 1, 1, 1, sysdate, store_id FROM kk_role_to_panel rtp, kk_panel p where rtp.panel_id=p.panel_id and p.code='kk_panel_promotions';
...
INSERT INTO kk_role_to_panel (role_id, panel_id, can_edit, can_insert, can_delete, date_added, store_id) SELECT role_id, 91, 1, 1, 1, sysdate, store_id FROM kk_role_to_panel rtp, kk_panel p where rtp.panel_id=p.panel_id and p.code='kk_panel_promotions';

-- Connect the promotion to expressions
DROP TABLE kk_promotion_to_expression CASCADE CONSTRAINTS;
...
INSERT INTO kk_customer_tag (kk_customer_tag_id, name, description, validation, tag_type, max_ints, date_added, store_id) SELECT kk_customer_tag_seq.nextval,'PRODUCTS_VIEWED', 'Recently viewed product id', '((:[0-9]*)*:|)', 2, 5, sysdate, store_id FROM countries where countries_iso_code_2 = 'US';
delete from kk_customer_tag where name ='CATEGORIES_VIEWED';
INSERT INTO kk_customer_tag (kk_customer_tag_id, name, description, validation, tag_type, max_ints, date_added, store_id) SELECT kk_customer_tag_seq.nextval,'CATEGORIES_VIEWED', 'Recently viewed category id', '((:[0-9]*)*:|)', 2, 5, sysdate, store_id FROM countries where countries_iso_code_2 = 'US';
delete from kk_customer_tag where name ='MANUFACTURERS_VIEWED';
INSERT INTO kk_customer_tag (kk_customer_tag_id, name, description, validation, tag_type, max_ints, date_added, store_id) SELECT kk_customer_tag_seq.nextval,'MANUFACTURERS_VIEWED', 'Recently viewed manufacturer id', '((:[0-9]*)*:|)', 2, 5, sysdate, store_id FROM countries where countries_iso_code_2 = 'US';
delete from kk_customer_tag where name ='PRODUCTS_IN_CART';
INSERT INTO kk_customer_tag (kk_customer_tag_id, name, description, validation, tag_type, max_ints, date_added, store_id) SELECT kk_customer_tag_seq.nextval,'PRODUCTS_IN_CART', 'Id of a product in the cart', '((:[0-9]*)*:|)', 2, 50, sysdate, store_id FROM countries where countries_iso_code_2 = 'US';
delete from kk_customer_tag where name ='PRODUCTS_IN_WISHLIST';
INSERT INTO kk_customer_tag (kk_customer_tag_id, name, description, validation, tag_type, max_ints, date_added, store_id) SELECT kk_customer_tag_seq.nextval,'PRODUCTS_IN_WISHLIST', 'Id of a product in the Wish List', '((:[0-9]*)*:|)', 2, 50, sysdate, store_id FROM countries where countries_iso_code_2 = 'US';
delete from kk_customer_tag where name ='SEARCH_STRING';
INSERT INTO kk_customer_tag (kk_customer_tag_id, name, description, tag_type, max_ints, date_added, store_id) SELECT kk_customer_tag_seq.nextval,'SEARCH_STRING', 'Product Search String', 0, 5, sysdate, store_id FROM countries where countries_iso_code_2 = 'US';
delete from kk_customer_tag where name ='COUNTRY_CODE';
INSERT INTO kk_customer_tag (kk_customer_tag_id, name, description, tag_type, max_ints, date_added, store_id) SELECT kk_customer_tag_seq.nextval,'COUNTRY_CODE', 'Country code of customer', 0, 5, sysdate, store_id FROM countries where countries_iso_code_2 = 'US';
delete from kk_customer_tag where name ='CART_TOTAL';
INSERT INTO kk_customer_tag (kk_customer_tag_id, name, description, tag_type, max_ints, date_added, store_id) SELECT kk_customer_tag_seq.nextval,'CART_TOTAL', 'Cart total', 3, 5, sysdate, store_id FROM countries where countries_iso_code_2 = 'US';
delete from kk_customer_tag where name ='WISHLIST_TOTAL';
INSERT INTO kk_customer_tag (kk_customer_tag_id, name, description, tag_type, max_ints, date_added, store_id) SELECT kk_customer_tag_seq.nextval,'WISHLIST_TOTAL', 'Wish List total', 3, 5, sysdate, store_id FROM countries where countries_iso_code_2 = 'US';
delete from kk_customer_tag where name ='BIRTH_DATE';
INSERT INTO kk_customer_tag (kk_customer_tag_id, name, description, tag_type, max_ints, date_added, store_id) SELECT kk_customer_tag_seq.nextval,'BIRTH_DATE', 'Date of Birth', 4, 5, sysdate, store_id FROM countries where countries_iso_code_2 = 'US';
delete from kk_customer_tag where name ='IS_MALE';
INSERT INTO kk_customer_tag (kk_customer_tag_id, name, description, validation, tag_type, max_ints, date_added, store_id) SELECT kk_customer_tag_seq.nextval,'IS_MALE', 'Customer is Male', 'true|false', 5, 5, sysdate, store_id FROM countries where countries_iso_code_2 = 'US';
...
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, store_id) SELECT configuration_seq.nextval, 'Enable Customer Tag functionality', 'ENABLE_CUSTOMER_TAGS', 'false', 'When set to true, the application sets customer tags. All tag functionality is disabled when false.', '5', '6', 'tep_cfg_select_option(array(''true'', ''false''), ', sysdate, store_id FROM configuration where configuration_key = 'STORE_COUNTRY';
...
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, store_id) SELECT configuration_seq.nextval, 'Enable Customer Cart Tag functionality', 'ENABLE_CUSTOMER_CART_TAGS', 'false', 'When set to true, the application sets customer cart tags', '5', '7', 'tep_cfg_select_option(array(''true'', ''false''), ', sysdate, store_id FROM configuration where configuration_key = 'STORE_COUNTRY';
...
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, store_id) SELECT configuration_seq.nextval, 'Enable Customer WishList Tag functionality', 'ENABLE_CUSTOMER_WISHLIST_TAGS', 'false', 'When set to true, the application sets customer wish list tags', '5', '8', 'tep_cfg_select_option(array(''true'', ''false''), ', sysdate, store_id FROM configuration where configuration_key = 'STORE_COUNTRY';
...
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, store_id) SELECT configuration_seq.nextval, 'Display Product Ids', 'ADMIN_APP_PRODUCTS_DISPLAY_ID', 'true', 'When this is set, the product id is displayed in the products panel', '21', '29', 'tep_cfg_select_option(array(''true'', ''false''), ', sysdate, store_id FROM configuration where configuration_key = 'STORE_COUNTRY';

delete from configuration where configuration_key = 'ADMIN_APP_MANUFACTURERS_DISPLAY_ID';
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, store_id) SELECT configuration_seq.nextval, 'Display Manufacturer Ids', 'ADMIN_APP_MANUFACTURERS_DISPLAY_ID', 'true', 'When this is set, the manufacturer id is displayed in the manufacturers panel', '21', '30', 'tep_cfg_select_option(array(''true'', ''false''), ', sysdate, store_id FROM configuration where configuration_key = 'STORE_COUNTRY';

delete from configuration where configuration_key = 'ADMIN_APP_CATEGORIES_DISPLAY_ID';
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, store_id) SELECT configuration_seq.nextval, 'Display Category Ids', 'ADMIN_APP_CATEGORIES_DISPLAY_ID', 'true', 'When this is set, the category id is displayed in the categories panel', '21', '31', 'tep_cfg_select_option(array(''true'', ''false''), ', sysdate, store_id FROM configuration where configuration_key = 'STORE_COUNTRY';
...
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, store_id) SELECT configuration_seq.nextval, 'Display Order Number', 'ADMIN_APP_ORDERS_DISPLAY_ORDER_NUM', '', 'When this is set, the order number is displayed in the orders panel rather than the order id', '21', '24', 'tep_cfg_select_option(array(''true'', ''false''), ', sysdate, store_id FROM kk_store where store_id not in (SELECT ks.store_id from configuration c2, kk_store ks where c2.configuration_key = 'ADMIN_APP_ORDERS_DISPLAY_ORDER_NUM' and ks.store_id = c2.store_id) and store_id != 'store1';

INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, store_id) SELECT configuration_seq.nextval, 'Allow Cust Group Change eMail', 'ADMIN_APP_ALLOW_GROUP_CHANGE_MAIL', 'true', 'When this is set, a popup window appears when the group of a customer is changed to allow you to send an eMail', '21', '28', 'tep_cfg_select_option(array(''true'', ''false''), ', sysdate, store_id FROM kk_store where store_id not in (SELECT ks.store_id from configuration c2, kk_store ks where c2.configuration_key = 'ADMIN_APP_ALLOW_GROUP_CHANGE_MAIL' and ks.store_id = c2.store_id) and store_id != 'store1';

INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, store_id) SELECT configuration_seq.nextval, 'Product Select Template', 'ADMIN_APP_PROD_SEL_TEMPLATE', '$name', 'Sets the template for which attributes to view when selecting a product ($name, $sku, $id, $model, $manufacturer, $custom1 ... $custom5', '21', '25', sysdate, store_id FROM kk_store where store_id not in (SELECT ks.store_id from configuration c2, kk_store ks where c2.configuration_key = 'ADMIN_APP_PROD_SEL_TEMPLATE' and ks.store_id = c2.store_id) and store_id != 'store1';

INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, store_id) SELECT configuration_seq.nextval, 'Product Select Default Num Prods', 'ADMIN_APP_PROD_SEL_NUM_PRODS', '0', 'Sets the default number of products displayed in the product select dialogs when opened', '21', '26', sysdate, store_id FROM kk_store where store_id not in (SELECT ks.store_id from configuration c2, kk_store ks where c2.configuration_key = 'ADMIN_APP_PROD_SEL_NUM_PRODS' and ks.store_id = c2.store_id) and store_id != 'store1';

INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, store_id) SELECT configuration_seq.nextval, 'Product Select Max Num Prods', 'ADMIN_APP_PROD_SEL_MAX_NUM_PRODS', '100', 'Sets the maximum number of products displayed in the product select dialogs after a search', '21', '27', sysdate, store_id FROM kk_store where store_id not in (SELECT ks.store_id from configuration c2, kk_store ks where c2.configuration_key = 'ADMIN_APP_PROD_SEL_MAX_NUM_PRODS' and ks.store_id = c2.store_id) and store_id != 'store1';

-- Product Price Table
DROP TABLE kk_product_prices CASCADE CONSTRAINTS;
...
DROP TABLE kk_digital_download_1 CASCADE CONSTRAINTS;
...
INSERT INTO kk_digital_download_1 (kk_digital_download_id, store_id, products_id, customers_id, max_downloads, times_downloaded,expiration_date, date_added, last_modified) SELECT kk_digital_download_1_SEQ.nextval, store_id, products_id, customers_id, max_downloads, times_downloaded,expiration_date, date_added, last_modified from kk_digital_download;
...
DROP TABLE kk_secret_key CASCADE CONSTRAINTS;
