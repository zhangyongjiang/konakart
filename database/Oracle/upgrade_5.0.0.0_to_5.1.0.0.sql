...
set echo on
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, store_id) SELECT configuration_seq.nextval, 'Allow using the basket price', 'ALLOW_BASKET_PRICE', 'false', 'Allows you to define the price in the basket object when adding a product to the basket', '18', '8', 'choice(''true'', ''false'')', sysdate, store_id FROM configuration where configuration_key = 'STORE_COUNTRY';
...
DROP TABLE kk_product_prices_tmp CASCADE CONSTRAINTS;
...
DROP TABLE kk_tier_price CASCADE CONSTRAINTS;
...
UPDATE configuration set configuration_value = 'C:/Program Files/KonaKart/database/Oracle/konakart_new_store_cs.sql' where configuration_key = 'KK_NEW_STORE_SQL_FILENAME' and configuration_value = 'C:/Program Files/KonaKart/database/MySQL/konakart_new_store_cs.sql';

-- Set the rule for calculating tax
DELETE FROM configuration where configuration_key = 'TAX_QUANTITY_RULE';
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, store_id) SELECT configuration_seq.nextval, 'Tax Quantity Rule', 'TAX_QUANTITY_RULE', '1', 'Tax calculated on total=1\nTax calculated per item and then rounded=2', '9', '13', 'integer(1,2), ', sysdate, store_id FROM configuration where configuration_key = 'STORE_COUNTRY';
...
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, store_id) SELECT configuration_seq.nextval, 'No of decimal places for currency', 'ADMIN_CURRENCY_DECIMAL_PLACES', '2', 'No of decimal places allowed for entering prices in the admin app', '1', '27', 'integer(0,9), ', sysdate, store_id FROM configuration where configuration_key = 'STORE_COUNTRY';
...
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, store_id) SELECT configuration_seq.nextval, 'Street Address 1', 'ACCOUNT_STREET_ADDRESS_1', 'false', 'Display 2nd street address in the customers account', '5', '4', 'choice(''true'', ''false'')', sysdate, store_id FROM configuration where configuration_key = 'STORE_COUNTRY';
...
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, store_id) SELECT configuration_seq.nextval, 'Street Address 1', 'ENTRY_STREET_ADDRESS1_MIN_LENGTH', '5', 'Minimum length of street address 1', '2', '5', 'integer(0,null)', sysdate, store_id FROM configuration where configuration_key = 'STORE_COUNTRY';
...
INSERT INTO configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, store_id) SELECT configuration_seq.nextval, 'Warn of Duplicate SKUs', 'ADMIN_APP_WARN_OF_DUPLICATE_SKUS', 'false', 'Issue warning in Admin App of duplicate SKUs', '21', '32', 'choice(''true'', ''false'')', sysdate, store_id FROM configuration where configuration_key = 'STORE_COUNTRY';
