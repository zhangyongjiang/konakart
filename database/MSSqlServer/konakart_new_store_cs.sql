...
INSERT INTO customers_info select customers_id , getdate(), 0, getdate(), getdate(), 0, 'XXXX' from customers WHERE customers_email_address = 'TARGET_STOREID-admin@konakart.com';
