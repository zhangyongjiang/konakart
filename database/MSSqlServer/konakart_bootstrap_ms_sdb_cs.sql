...
UPDATE configuration set configuration_value = 'C:/Program Files/KonaKart/database/MSSqlServer/konakart_new_store_cs.sql' where configuration_key = 'KK_NEW_STORE_SQL_FILENAME';
...
INSERT INTO customers_info select customers_id , getdate(), 0, getdate(), getdate(), 0, 'XXXX' from customers where customers_email_address = 'store2-admin@konakart.com';
