...
INSERT INTO kk_config (kk_config_key, kk_config_value, date_added) VALUES ('HISTORY', '7.0.0.0 U', getdate());
UPDATE kk_config SET kk_config_value='7.0.0.0 SQLServer', date_added=getdate() WHERE kk_config_key='VERSION';
