...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, store_id) SELECT 'Reward Point Transactions', 'MAX_DISPLAY_REWARD_POINTS', '20', 'Maximum number of reward point transactions to display', '3', '26', 'integer(0,null)', getdate(), store_id FROM configuration where configuration_key = 'STORE_COUNTRY';
...
INSERT INTO kk_role_to_panel (role_id, panel_id, can_edit, can_insert, can_delete, date_added, store_id) SELECT role_id, 92, 1, 1, 1, getdate(), store_id FROM kk_role_to_panel rtp, kk_panel p where rtp.panel_id=p.panel_id and p.code='kk_panel_promotions';
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, store_id) SELECT 'Use Rich Text Editor', 'RICH_TEXT_EDITOR', 'true', 'If true the Rich Text Editor is used for product descriptions, otherwise the Plain Text Editor is used', '9', '12', 'tep_cfg_select_option(array(''true'', ''false''), ', getdate(), store_id FROM configuration where configuration_key = 'STORE_COUNTRY';
...
-- Add Configure Reward Points to super admin role
INSERT INTO kk_role_to_panel (role_id, panel_id, can_edit, can_insert, can_delete, date_added, store_id) SELECT role_id, 93, 1, 1, 1, getdate(), store_id FROM kk_role_to_panel rtp, kk_panel p where rtp.panel_id=p.panel_id and p.code='kk_panel_reportsConfig';

-- PDF Configuration Parameters
DELETE FROM configuration where configuration_key = 'PDF_BASE_DIRECTORY';
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, store_id) SELECT 'PDF Directory', 'PDF_BASE_DIRECTORY', 'C:/Program Files/KonaKart/pdf', 'Defines the root directory for the location of the PDF documents that are created', '27', '5', getdate(), store_id FROM configuration where configuration_key = 'STORE_COUNTRY';
...
-- Add Configure Reward Points to super admin role
INSERT INTO kk_role_to_panel (role_id, panel_id, can_edit, can_insert, can_delete, date_added, store_id) SELECT role_id, 94, 1, 1, 1, getdate(), store_id FROM kk_role_to_panel rtp, kk_panel p where rtp.panel_id=p.panel_id and p.code='kk_panel_reportsConfig';
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, store_id) SELECT 'Automatically Enable Product', 'STOCK_ENABLE_PRODUCT', 'false', 'Automatically enable a product if quantity is set to a positive number', '9', '4', 'choice(''true'', ''false'')', getdate(), store_id FROM configuration where configuration_key = 'STORE_COUNTRY';
...
-- Add Configure Reward Points to super admin role
INSERT INTO kk_role_to_panel (role_id, panel_id, can_edit, can_insert, can_delete, date_added, store_id) SELECT role_id, 95, 1, 1, 1, getdate(), store_id FROM kk_role_to_panel rtp, kk_panel p where rtp.panel_id=p.panel_id and p.code='kk_panel_editProduct';

-- Subscription Panel
INSERT INTO kk_panel ( code, description, date_added) VALUES ('kk_panel_subscription', 'Subscription', getdate());

-- Add Configure Reward Points to super admin role
INSERT INTO kk_role_to_panel (role_id, panel_id, can_edit, can_insert, can_delete, date_added, store_id) SELECT role_id, 96, 1, 1, 1, getdate(), store_id FROM kk_role_to_panel rtp, kk_panel p where rtp.panel_id=p.panel_id and p.code='kk_panel_editOrderPanel';
...
-- Add Configure Reward Points to super admin role
INSERT INTO kk_role_to_panel (role_id, panel_id, can_edit, can_insert, can_delete, date_added, store_id) SELECT role_id, 97, 1, 1, 1, getdate(), store_id FROM kk_role_to_panel rtp, kk_panel p where rtp.panel_id=p.panel_id and p.code='kk_panel_editOrderPanel';
...
-- Add Configure Reward Points to super admin role
INSERT INTO kk_role_to_panel (role_id, panel_id, can_edit, can_insert, can_delete, date_added, store_id) SELECT role_id, 98, 1, 1, 1, getdate(), store_id FROM kk_role_to_panel rtp, kk_panel p where rtp.panel_id=p.panel_id and p.code='kk_panel_editOrderPanel';
...
INSERT INTO configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added, store_id) SELECT 'Display Subscriptions Button', 'ADMIN_APP_DISPLAY_SUBSCRIPTIONS_BUTTON', 'false', 'When this is set, a Subscriptions button is displayed in the Customers and Orders panels', '21', '30', 'choice(''true'', ''false'')', getdate(), store_id FROM configuration where configuration_key = 'STORE_COUNTRY';
...
ALTER TABLE address_format ALTER COLUMN address_format VARCHAR(256);
ALTER TABLE address_format ALTER COLUMN address_summary VARCHAR(256);

-- Make product image fields bigger
ALTER TABLE products ALTER COLUMN products_image VARCHAR(256);
ALTER TABLE products ALTER COLUMN products_image2 VARCHAR(256);
ALTER TABLE products ALTER COLUMN products_image3 VARCHAR(256);
ALTER TABLE products ALTER COLUMN products_image4 VARCHAR(256);
