#----------------------------------------------------------------
# KonaKart upgrade script from version 2.2.6.0 to version 3.0.1.0
#----------------------------------------------------------------
#
...
INSERT INTO kk_panel (panel_id, code, description, date_added) VALUES (81, 'kk_panel_solr_search','Solr Search Engine', now());
