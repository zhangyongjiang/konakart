#----------------------------------------------------------------
# KonaKart upgrade script from version 6.4.0.0 to version 6.5.0.0
#----------------------------------------------------------------
#
...
UPDATE kk_config SET kk_config_value='6.5.0.0 MySQL', date_added=now() WHERE kk_config_key='VERSION';
