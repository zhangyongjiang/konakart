#----------------------------------------------------------------
# KonaKart upgrade script from version 7.2.0.0 to version 7.3.0.0
#----------------------------------------------------------------
#
...
UPDATE kk_config SET kk_config_value='7.3.0.0 MySQL', date_added=now() WHERE kk_config_key='VERSION';
