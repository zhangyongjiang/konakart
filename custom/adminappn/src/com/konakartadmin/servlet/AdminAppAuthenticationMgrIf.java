...
/**
 * An implementation of this interface is called from the AdminAppLauncher servlet in order to allow
 * integration with an external authentication service.
 * 
 */
public interface AdminAppAuthenticationMgrIf
{
    /**
