...
public class Thomson extends OrderTotalModule
{
    ...
    public KKConfiguration[] getConfigs()
    {
        if (configs == null)
        {
            configs = new KKConfiguration[30];
        }
        ...
        /* title */"Display Thomson Reuters Tax",
        ...
        configs[i] = new KKConfiguration(
        /* title */"Tax Service Username",
        /* key */"MODULE_ORDER_TOTAL_THOMSON_USERNAME",
        /* value */"",
        /* description */"Tax Service Username (to acces the Thomson Reuters Tax Service using WSS Authentication)",
        /* groupId */groupId,
        /* sortO */i++,
        /* useFun */"",
        /* setFun */"",
        ...
        /* value */"true",
        /* description */"Add the defined Username and Password to requests sent to the Tax Service",
        /* groupId */groupId,
        /* sortO */i++,
        /* useFun */"",
        /* setFun */"choice('True', 'False')",
        ...
        /* value */"-1",
        /* description */"Field on the order product that stores the 3 '|' separated tax codes - used with the Custom option for the 3 tax codes below",
        /* groupId */groupId,
        /* sortO */i++,
        /* useFun */"",
        ...
        /* value */"",
        /* description */"Seller County (eg Oxfordshire)",
        /* groupId */groupId,
        /* sortO */i++,
        /* useFun */"",
        /* setFun */"",
        ...
        /* value */"",
        /* description */"Seller State for US Sellers (eg NY, CA)",
        /* groupId */groupId,
        /* sortO */i++,
        /* useFun */"",
        /* setFun */"",
        ...
        /* value */"",
        /* description */"2-Character Seller Country (eg. GB, US, CA)",
        /* groupId */groupId,
        /* sortO */i++,
        /* useFun */"",
        /* setFun */"",
        ...
        /* value */"",
        /* description */"Ship From County (eg Oxfordshire)",
        /* groupId */groupId,
        /* sortO */i++,
        /* useFun */"",
        /* setFun */"",
        ...
        /* value */"",
        /* description */"Ship From State for US Sellers (eg NY, CA)",
        /* groupId */groupId,
        /* sortO */i++,
        /* useFun */"",
        /* setFun */"",
        ...
        /* value */"http://10.128.1.237:8080/sabrix/services/taxcalculationservice/2011-09-01/taxcalculationservice",
        ...
        configs[i] = new KKConfiguration(
        /* title */"Zone Service Endpoint URL",
        /* key */"MODULE_ORDER_TOTAL_THOMSON_ZONE_URL",
        /* value */"http://10.128.1.237:8080/sabrix/services/zonelookupservice/2011-09-01/zonelookupservice",
        /* description */"Thomson Reuters Zone Service Endpoint URL eg. http://10.128.1.237:8080/sabrix/services/zonelookupservice/2011-09-01/zonelookupservice",
        /* groupId */groupId,
        /* sortO */i++,
        /* useFun */"",
        /* setFun */"",
