...
REM -----------------------------------------------------------------------
REM This kkant.bat version is identical to ant.bat except this first line 
REM to unset the ANT_HOME to avoid using any existing ANT on the system

set ANT_HOME=

REM End of changes for kkant.bat
REM -----------------------------------------------------------------------
